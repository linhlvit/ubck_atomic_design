...
Đọc atomic_attributes.csv, kiểm tra 5 tiêu chí chất lượng, in báo cáo.
Không sửa file nào.
Cách dùng: python Atomic/lld/scripts/post_check_atomic.py
"""
import csv
import sys
import io
...
ATTRS_FILE = SCRIPT_DIR.parent / "atomic_attributes.csv"
