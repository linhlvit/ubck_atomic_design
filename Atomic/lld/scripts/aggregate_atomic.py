...
aggregate_atomic.py
===================
Tổng hợp atomic_entities.csv và atomic_attributes.csv từ các LLD attr files.

Nguồn dữ liệu:
  - atomic_entities.csv    : source of truth cho entity-level attributes
...
Cách dùng:
  ...
  python aggregate_atomic.py --skip-attributes # bỏ qua rebuild atomic_attributes.csv
"""
