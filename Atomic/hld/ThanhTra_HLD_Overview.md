...
**Phạm vi thiết kế Atomic:** 46 bảng nghiệp vụ (bỏ 8 SYS_, 2 SYS_VAN_BAN_PHAP_QUY)

---

## 1. Tổng quan Atomic Entities theo Tier
...
**Tổng: 32 Atomic entities** (30 thiết kế mới + 2 reuse: Securities Company, Fund Management Company)
...
| SYS_VAN_BAN_PHAP_QUY | Regulatory ref. — out of Atomic scope | Out-of-scope |
| PCRT_BAO_CAO | Báo cáo PCRT định kỳ độc lập | **Atomic entity `AML Periodic Report`** (T1 Fact Append) |
