...
| Involved Party | [Involved Party] Organization | Organization | BANKMONI | Lưu danh sách đối tượng gửi báo cáo là Ngân hàng lưu ký giám sát | Custodian Bank | Cùng cấu trúc với FUNDCOMPANY. BCV: [Involved Party] Organization. **Dùng chung Atomic entity với FMS.BANKMONI** — FIMS là secondary source. |
...
|---|---|---|---|---|
| NATIONAL | Danh sách quốc tịch/quốc gia | [Location] Geographic Area | **Atomic entity** — FK inbound từ nhiều bảng thành viên. Đặt tên: Geographic Area. | — (entity riêng, không phải scheme) |
