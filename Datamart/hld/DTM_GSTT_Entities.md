...
- E-03: Nhóm 3 — bổ sung `Public Company Dimension` vào erDiagram và bảng tóm tắt
...
| Security Trading Snapshot Dimension | Mã CK, Sàn, Loại CK, Chỉ số | 1 row / mã CK (SCD2) | Slicer Mã CK / Sàn / Loại / Chỉ số |
| Public Company Dimension | Ngành kinh tế cấp 1 (10 ngành IDS) | 1 row / mã CP (SCD2) | Slicer Ngành |
...
| Corporate Bond Trading Snapshot Dimension | Tổ chức phát hành TPDN | 1 row / mã TP (SCD2) | Slicer Mã TP / Tên nhà phát hành |
| Corporate Bond Trading Snapshot Industry Dimension | Ngành TPDN cấp 1 (10 ngành IDS) | 1 row / mã TP (SCD2) | Slicer Ngành TPDN |
...
| Security Trading Snapshot Dimension | Slicer Mã CK | 1 row / mã CK (SCD2) | Slicer Mã CK |
| Public Company Dimension | Slicer Ngành | 1 row / mã CP (SCD2) | Slicer Ngành |
...
| Security Trading Snapshot Dimension | Slicer Mã CK / Sàn / Chỉ số | 1 row / mã CK (SCD2) | Slicer |
| Public Company Dimension | Slicer Ngành | 1 row / mã CP (SCD2) | Slicer |
...
| Security Trading Snapshot Dimension | Slicer Mã CK | 1 row / mã CK (SCD2) | Slicer |
...
| Security Trading Snapshot Dimension | Filter Floor_Code / Index_Codes | 1 row / mã CK (SCD2) | Slicer Sàn / Chỉ số |
| Public Company Dimension | Filter Ngành | 1 row / mã CP (SCD2) | Slicer Ngành |
| Calendar Date Dimension | Slicer Ngày | 1 row / ngày | Slicer |
...
| Security Trading Snapshot Dimension | Filter Floor_Code / Index_Codes | 1 row / mã CK (SCD2) | Slicer |
| Calendar Date Dimension | Slicer Ngày | 1 row / ngày | Slicer |
...
| Security Trading Snapshot Dimension | Filter Sàn / Chỉ số | 1 row / mã CK (SCD2) | Slicer |
| Public Company Dimension | Filter Ngành | 1 row / mã CP (SCD2) | Slicer |
| Calendar Date Dimension | Slicer Ngày | 1 row / ngày | Slicer |
...
| Security Trading Snapshot Dimension | Group by Industry Level1 (view Ngành) | 1 row / mã CK (SCD2) | Slicer |
| Public Company Dimension | Aggregate theo ngành | 1 row / mã CP (SCD2) | Group by |
| Calendar Date Dimension | Slicer Ngày | 1 row / ngày | Slicer |
...
| Security Trading Snapshot Dimension | Filter Sàn | 1 row / mã CK (SCD2) | Slicer |
...
| Security Trading Snapshot Dimension | Slicer Mã CK / Sàn | 1 row / mã CK (SCD2) | Slicer |
| Public Company Dimension | Filter Ngành | 1 row / mã CP (SCD2) | Slicer |
| Calendar Date Dimension | Slicer Ngày | 1 row / ngày | Slicer |
...
| Security Trading Snapshot Dimension | Slicer Sàn | 1 row / mã CK (SCD2) | Slicer |
| Calendar Date Dimension | Slicer Ngày / Kỳ | 1 row / ngày | Slicer |
