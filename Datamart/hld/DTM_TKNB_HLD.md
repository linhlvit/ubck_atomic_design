...
- **Mục 1 (Chỉ số) hoàn toàn THIẾU trong BA hiện tại**; **mục 4-5 (KL/GT CK niêm yết-ĐKGD hiện hành)** — đã đối chiếu với biểu mẫu Excel chuẩn `HNX04 Bao cao tong hop ve quy mo TTCK.xlsx` (user cung cấp 2026-08-10) và bổ sung PENDING để giữ đúng vị trí layout.
...
**Kết luận: 77 KPI READY** (23 KPI gốc: mục 2.1/2.2/2.3/2.6/2.8, mục 3.1/3.2/3.3/3.6/3.8, mục 17.1/17.2, 18.1/18.2, dòng Chiều Sàn/Ngày GD/Kỳ báo cáo/Loại CK; + 54 KPI mới mục 6-11 theo mapping BA 2026-09-10), **105 KPI PENDING** (mục 1, 4-5, 12-16, 19-26 toàn bộ biểu mẫu; các sub-item TPCQĐP/TPCPBL/Tín phiếu KB của mục 2,3 theo biểu mẫu BM24; mục 19 PENDING theo dây chuyền do phụ thuộc mẫu số mục 16 PENDING dù tử số mục 18 READY).
