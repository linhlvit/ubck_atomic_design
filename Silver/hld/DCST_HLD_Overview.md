# DCST — HLD Overview: Toàn cảnh thiết kế Silver Layer
...
|---|---|---|---|
| DANH_MUC + NHOM_DANH_MUC | Danh mục tham chiếu dùng chung trong DCST | Classification Value | Load theo NHOM_DANH_MUC.MA = Scheme Code. Không tạo Silver entity. |
...
| 8 | 3 | Số liệu VARCHAR trong TCT_BAO_CAO_CHI_TIET — cần tính toán ở Silver không? | Nếu cần → xác nhận đơn vị tiền tệ và chuyển kiểu. |
...
| Reference Data | DANH_MUC | Danh mục tham chiếu | Chỉ có Code + Name → Classification Value, không tạo Silver entity. |
| Reference Data | NHOM_DANH_MUC | Nhóm danh mục tham chiếu | Chỉ có Code + Name → Classification Value scheme, không tạo Silver entity. |
