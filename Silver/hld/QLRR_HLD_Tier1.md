...
| # | Câu hỏi | Kết quả |
|---|---|---|
| T1-01 | `risk_report_type.template_content` có lưu trên Silver không? | **Không lưu** — config kỹ thuật. |
