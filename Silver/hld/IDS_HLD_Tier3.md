...
| T3-02 | `company_data` — bảng trung gian có đưa lên Silver không? | **Không** — user xác nhận bảng trung gian, drop khỏi scope. Cascade: report_approval, report_extensions, data, data_values cũng drop. |
