...
| Hạng mục | Nội dung |
|---|---|
| Silver Entity | Fund Management Company Organization Unit |
...
| Hạng mục | Nội dung |
|---|---|
| Silver Entity | Fund Management Company Key Person |
...
| Hạng mục | Nội dung |
|---|---|
| Silver Entity | Fund Distribution Agent Organization Unit |
| BCV Concept | [Involved Party] Organization Unit |
| Model Table Type | Fundamental (SCD4A) |
...
| Hạng mục | Nội dung |
|---|---|
| Silver Entity | Discretionary Investment Account |
...
| Hạng mục | Nội dung |
|---|---|
| Silver Entity | Rating Criterion |
