# NHNCK — HLD Overview: Toàn cảnh thiết kế Silver Layer
...
|---|---|---|---|---|---|---|---|
| 1 | Involved Party | [Involved Party] Organization | Organization | Units | Danh mục đơn vị thuộc UBCKNN | Regulatory Authority Organization Unit | Organization — cấu trúc cây self-referencing. Cùng Silver entity với Departments. |
| 1 | Involved Party | [Involved Party] Organization | Organization | Departments | Danh mục phòng ban thuộc UBCKNN | Regulatory Authority Organization Unit | Organization — cùng Silver entity với Units, tách attr file theo nguồn. |
...
graph TD
    ...
    %% Tier 1
    ORGUNIT["**Regulatory Authority Organization Unit**"]:::silver
    SECORG["**Securities Organization Reference**"]:::silver
    DECISION["**Securities Practitioner License Decision Document**"]:::silver
    OFFICER["**Regulatory Authority Officer**"]:::silver
    ...
    %% Tier 2
    PRAC["**Securities Practitioner**"]:::silver
    TRAINCLASS["**Professional Training Class**"]:::silver
    CERTGRP["**License Certificate Group Document**"]:::silver
    EXAM["**Qualification Examination Assessment**"]:::silver

    %% Tier 3
    CERTDOC["**License Certificate Document**"]:::silver
    CERTMEM["**License Certificate Group Member**"]:::silver
    ...
    ENROLL["**Training Class Enrollment**"]:::silver
    EXAMRES["**Examination Assessment Result**"]:::silver
    EXAMFEE["**Examination Assessment Fee**"]:::silver

    %% Tier 4
    APPTRAIN["**License Application\nEducation Certificate Document**"]:::silver
    APPDOC["**License Application\nDocument Attachment**"]:::silver
    APPLOG["**License Application\nProcessing Activity Log**"]:::pattern
    APPFEE["**License Application Fee**"]:::silver
    VERIFY["**License Application\nVerification Status**"]:::silver
...
|---|---|---|---|
| CertificateRecordGroupMembers | Junction giữa CertificateRecords và CertificateRecordGroups — có thêm ApplicationId | Securities Practitioner License Certificate Group Member | Rich junction (có attribute ApplicationId ngoài 2 FK chính) → tạo Silver entity riêng với surrogate key. Không denormalize. |
