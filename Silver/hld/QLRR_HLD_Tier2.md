...
| Documentation | [Documentation] Regulatory Report | Documentation | risk_report_placeholder_config | Cấu hình "đục lỗ" — mapping placeholder trong template báo cáo | *(Ngoài scope Silver)* | — | Đây là cấu hình kỹ thuật (data_source_table, formula_expression) — không có giá trị nghiệp vụ độc lập. Chốt không lưu trên Silver. |
