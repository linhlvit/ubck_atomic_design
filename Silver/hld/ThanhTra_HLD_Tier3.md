...
2. Đối tượng thanh tra có thể là cá nhân/tổ chức đã có FK trong Silver (qua `Inspection Decision Subject`) hoặc chưa có
...
| Bảng nguồn | Lý do | Silver Entity (dự kiến) |
|---|---|---|
