...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | investor_account |  |  |
...
| 27 | Authorized Person Name | authorized_psn_nm | STRING | X |  |  |  | Người nhận ủy quyền (denormalized từ account_authorization). | GSGD | investor_account | authorized_person_name | Lưu ý: tách sang entity Investor Trading Account Authorization ở Tier 2. Trường này là snapshot denormalized trên account. |
| 28 | Authorization Date | ahr_dt | DATE | X |  |  |  | Ngày nhận ủy quyền (denormalized từ account_authorization). | GSGD | investor_account | authorization_date | Lưu ý: tách sang entity Investor Trading Account Authorization ở Tier 2. Trường này là snapshot denormalized trên account. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | account_group |  |  |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | securities_group |  |  |
...
| 8 | Securities Codes | scr_codes | Array<Text> | X |  |  |  | Danh sách mã chứng khoán trong nhóm. Denormalized từ bảng junction securities_group_member. | GSGD | securities_group | securities_code_id | Pure junction securities_group_member → denormalize thành ARRAY. securities_code ngoài scope GSGD. HLD decision: GSGD_HLD_Tier2.md 6f-2. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | case_file |  |  |
...
| 5 | Securities Code | scr_code | STRING | X |  |  |  | Mã chứng khoán liên quan. Denormalized — bảng securities_code ngoài scope GSGD. | GSGD | case_file | securities_code | Pending dependency: cần xác nhận bảng securities_code thuộc hệ thống nào (VSD/HoSE/HNX). |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | analysis_attribute_define |  |  |
...
| 9 | Min Value | min_val | STRING | X |  |  |  | Giá trị tối thiểu (nếu là NUMBER/DATE). | GSGD | analysis_attribute_define | min_value | Lưu dạng Text — parse theo data_type khi sử dụng. |
| 10 | Max Value | max_val | STRING | X |  |  |  | Giá trị tối đa (nếu là NUMBER/DATE). | GSGD | analysis_attribute_define | max_value | Lưu dạng Text — parse theo data_type khi sử dụng. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | abnormal_report |  |  |
...
| 10 | Submitter Id | submitter_id | STRING | X |  |  |  | Mã người/tổ chức nộp báo cáo. Denormalized — không có FK tường minh đến entity Silver. | GSGD | abnormal_report | submitter_id | Pending: cần mapping tường minh đến Securities Company hoặc entity khác. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | compliance_report_template |  |  |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | account_financial_service |  |  |
| 4 | Investor Trading Account Id | ivsr_tdg_ac_id | BIGINT |  |  | F |  | FK đến tài khoản giao dịch chứng khoán. | GSGD | account_financial_service | account_id | FK target: Investor Trading Account.Investor Trading Account Id. |
| 5 | Investor Trading Account Code | ivsr_tdg_ac_code | STRING |  |  |  |  | Mã tài khoản giao dịch. Denormalized. | GSGD | account_financial_service | account_id | Lookup pair: Investor Trading Account.Investor Trading Account Code. Pair with Investor Trading Account Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | account_authorization |  |  |
| 4 | Investor Trading Account Id | ivsr_tdg_ac_id | BIGINT |  |  | F |  | FK đến tài khoản giao dịch chứng khoán. | GSGD | account_authorization | account_id | FK target: Investor Trading Account.Investor Trading Account Id. |
| 5 | Investor Trading Account Code | ivsr_tdg_ac_code | STRING |  |  |  |  | Mã tài khoản giao dịch. Denormalized. | GSGD | account_authorization | account_id | Lookup pair: Investor Trading Account.Investor Trading Account Code. Pair with Investor Trading Account Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | account_group_member |  |  |
| 4 | Account Investor Group Id | ac_ivsr_grp_id | BIGINT |  |  | F |  | FK đến nhóm tài khoản. | GSGD | account_group_member | group_id | FK target: Account Investor Group.Account Investor Group Id. |
| 5 | Account Investor Group Code | ac_ivsr_grp_code | STRING |  |  |  |  | Mã nhóm tài khoản. Denormalized. | GSGD | account_group_member | group_id | Lookup pair: Account Investor Group.Account Investor Group Code. Pair with Account Investor Group Id. |
| 6 | Investor Trading Account Id | ivsr_tdg_ac_id | BIGINT |  |  | F |  | FK đến tài khoản giao dịch chứng khoán. | GSGD | account_group_member | account_id | FK target: Investor Trading Account.Investor Trading Account Id. |
| 7 | Investor Trading Account Code | ivsr_tdg_ac_code | STRING |  |  |  |  | Mã tài khoản giao dịch. Denormalized. | GSGD | account_group_member | account_id | Lookup pair: Investor Trading Account.Investor Trading Account Code. Pair with Investor Trading Account Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | account_relationship |  |  |
| 4 | First Investor Trading Account Id | frst_ivsr_tdg_ac_id | BIGINT |  |  | F |  | FK đến tài khoản giao dịch thứ nhất. | GSGD | account_relationship | account_id_1 | FK target: Investor Trading Account.Investor Trading Account Id. |
| 5 | First Investor Trading Account Code | frst_ivsr_tdg_ac_code | STRING |  |  |  |  | Mã tài khoản giao dịch thứ nhất. Denormalized. | GSGD | account_relationship | account_id_1 | Lookup pair: Investor Trading Account.Investor Trading Account Code. Pair with First Investor Trading Account Id. |
| 6 | Second Investor Trading Account Id | scd_ivsr_tdg_ac_id | BIGINT |  |  | F |  | FK đến tài khoản giao dịch thứ hai. | GSGD | account_relationship | account_id_2 | FK target: Investor Trading Account.Investor Trading Account Id. |
| 7 | Second Investor Trading Account Code | scd_ivsr_tdg_ac_code | STRING |  |  |  |  | Mã tài khoản giao dịch thứ hai. Denormalized. | GSGD | account_relationship | account_id_2 | Lookup pair: Investor Trading Account.Investor Trading Account Code. Pair with Second Investor Trading Account Id. |
| 8 | Account Investor Group Id | ac_ivsr_grp_id | BIGINT | X |  | F |  | FK đến nhóm tài khoản. | GSGD | account_relationship | account_group_id | FK target: Account Investor Group.Account Investor Group Id. |
| 9 | Account Investor Group Code | ac_ivsr_grp_code | STRING | X |  |  |  | Mã nhóm tài khoản. Denormalized. | GSGD | account_relationship | account_group_id | Lookup pair: Account Investor Group.Account Investor Group Code. Pair with Account Investor Group Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | company_event |  |  |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | case_attach_file |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | case_attach_file | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | case_attach_file | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
...
| 8 | File Size | file_sz | STRING | X |  |  |  | Kích thước file (bytes). | GSGD | case_attach_file | file_size | Lưu dạng Text — không có data domain chuẩn cho byte count. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | case_file_workflow |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | case_file_workflow | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | case_file_workflow | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | case_approval_step |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | case_approval_step | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | case_approval_step | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | suspicious_account |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | suspicious_account | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | suspicious_account | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
| 6 | Investor Trading Account Id | ivsr_tdg_ac_id | BIGINT |  |  | F |  | FK đến tài khoản giao dịch nghi vấn. | GSGD | suspicious_account | account_id | FK target: Investor Trading Account.Investor Trading Account Id. |
| 7 | Investor Trading Account Code | ivsr_tdg_ac_code | STRING |  |  |  |  | Mã tài khoản nghi vấn. Denormalized. | GSGD | suspicious_account | account_id | Lookup pair: Investor Trading Account.Investor Trading Account Code. Pair with Investor Trading Account Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | suspicious_account_group |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | suspicious_account_group | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | suspicious_account_group | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | analysis_attribute_value |  |  |
| 4 | Market Surveillance Analysis Criterion Id | mkt_surveillance_anl_criterion_id | BIGINT |  |  | F |  | FK đến tiêu chí phân tích. | GSGD | analysis_attribute_value | attribute_id | FK target: Market Surveillance Analysis Criterion.Market Surveillance Analysis Criterion Id. |
| 5 | Market Surveillance Analysis Criterion Code | mkt_surveillance_anl_criterion_code | STRING |  |  |  |  | Mã tiêu chí phân tích. Denormalized. | GSGD | analysis_attribute_value | attribute_id | Lookup pair: Market Surveillance Analysis Criterion.Market Surveillance Analysis Criterion Code. Pair with Market Surveillance Analysis Criterion Id. |
...
| 7 | Value Number | val_nbr | STRING | X |  |  |  | Giá trị số (nếu data_type = NUMBER). | GSGD | analysis_attribute_value | value_number | Lưu dạng Text — parse theo data_type khi sử dụng. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | compliance_report_config |  |  |
| 4 | Market Surveillance Compliance Report Template Id | mkt_surveillance_cmpln_rpt_tpl_id | BIGINT |  |  | F |  | FK đến mẫu báo cáo tuân thủ. | GSGD | compliance_report_config | template_id | FK target: Market Surveillance Compliance Report Template.Market Surveillance Compliance Report Template Id. |
| 5 | Market Surveillance Compliance Report Template Code | mkt_surveillance_cmpln_rpt_tpl_code | STRING |  |  |  |  | Mã mẫu báo cáo tuân thủ. Denormalized. | GSGD | compliance_report_config | template_id | Lookup pair: Market Surveillance Compliance Report Template.Market Surveillance Compliance Report Template Code. Pair with Market Surveillance Compliance Report Template Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | compliance_report_master |  |  |
| 4 | Market Surveillance Compliance Report Template Id | mkt_surveillance_cmpln_rpt_tpl_id | BIGINT |  |  | F |  | FK đến mẫu báo cáo tuân thủ. | GSGD | compliance_report_master | template_id | FK target: Market Surveillance Compliance Report Template.Market Surveillance Compliance Report Template Id. |
| 5 | Market Surveillance Compliance Report Template Code | mkt_surveillance_cmpln_rpt_tpl_code | STRING |  |  |  |  | Mã mẫu báo cáo tuân thủ. Denormalized. | GSGD | compliance_report_master | template_id | Lookup pair: Market Surveillance Compliance Report Template.Market Surveillance Compliance Report Template Code. Pair with Market Surveillance Compliance Report Template Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | abnormal_report_file |  |  |
| 4 | Abnormal Trading Report Id | abnormal_tdg_rpt_id | BIGINT |  |  | F |  | FK đến báo cáo giao dịch bất thường. | GSGD | abnormal_report_file | report_id | FK target: Abnormal Trading Report.Abnormal Trading Report Id. |
| 5 | Abnormal Trading Report Code | abnormal_tdg_rpt_code | STRING |  |  |  |  | Mã báo cáo bất thường. Denormalized. | GSGD | abnormal_report_file | report_id | Lookup pair: Abnormal Trading Report.Abnormal Trading Report Code. Pair with Abnormal Trading Report Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | compliance_report_data |  |  |
| 4 | Market Surveillance Compliance Report Instance Id | mkt_surveillance_cmpln_rpt_instn_id | BIGINT |  |  | F |  | FK đến instance báo cáo tuân thủ. | GSGD | compliance_report_data | report_master_id | FK target: Market Surveillance Compliance Report Instance.Market Surveillance Compliance Report Instance Id. |
| 5 | Market Surveillance Compliance Report Instance Code | mkt_surveillance_cmpln_rpt_instn_code | STRING |  |  |  |  | Mã instance báo cáo tuân thủ. Denormalized. | GSGD | compliance_report_data | report_master_id | Lookup pair: Market Surveillance Compliance Report Instance.Market Surveillance Compliance Report Instance Code. Pair with Market Surveillance Compliance Report Instance Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | analysis_execution_log |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | analysis_execution_log | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | analysis_execution_log | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | analysis_suspicious_account_code |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | analysis_suspicious_account_code | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | analysis_suspicious_account_code | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | analysis_suspicious_account |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | analysis_suspicious_account | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | analysis_suspicious_account | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | analysis_account_relationship |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | analysis_account_relationship | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | analysis_account_relationship | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
| 6 | Investor Account Relationship Id | ivsr_ac_rltnp_id | BIGINT | X |  | F |  | FK đến mối quan hệ tài khoản nghi vấn. | GSGD | analysis_account_relationship | relationship_id | FK target: Investor Account Relationship.Investor Account Relationship Id. FK suy luận. |
| 7 | Investor Account Relationship Code | ivsr_ac_rltnp_code | STRING | X |  |  |  | Mã mối quan hệ tài khoản. Denormalized. | GSGD | analysis_account_relationship | relationship_id | Lookup pair: Investor Account Relationship.Investor Account Relationship Code. Pair with Investor Account Relationship Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | analysis_account_group |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | analysis_account_group | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | analysis_account_group | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | analysis_account_group_member |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | analysis_account_group_member | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | analysis_account_group_member | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
| 6 | Account Investor Group Id | ac_ivsr_grp_id | BIGINT | X |  | F |  | FK đến nhóm tài khoản. FK suy luận đã xác nhận. | GSGD | analysis_account_group_member | account_group_id | FK target: Account Investor Group.Account Investor Group Id. FK suy luận — đã xác nhận HLD Tier3 6f-3. |
| 7 | Account Investor Group Code | ac_ivsr_grp_code | STRING | X |  |  |  | Mã nhóm tài khoản. Denormalized. | GSGD | analysis_account_group_member | account_group_id | Lookup pair: Account Investor Group.Account Investor Group Code. Pair with Account Investor Group Id. |
| 8 | Investor Account Relationship Id | ivsr_ac_rltnp_id | BIGINT | X |  | F |  | FK đến mối quan hệ tài khoản. | GSGD | analysis_account_group_member | relationship_id | FK target: Investor Account Relationship.Investor Account Relationship Id. FK suy luận. |
| 9 | Investor Account Relationship Code | ivsr_ac_rltnp_code | STRING | X |  |  |  | Mã mối quan hệ tài khoản. Denormalized. | GSGD | analysis_account_group_member | relationship_id | Lookup pair: Investor Account Relationship.Investor Account Relationship Code. Pair with Investor Account Relationship Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'GSGD' | Mã nguồn dữ liệu. | GSGD | analysis_report |  |  |
| 4 | Market Surveillance Case Id | mkt_surveillance_case_id | BIGINT |  |  | F |  | FK đến vụ việc giám sát. | GSGD | analysis_report | case_file_id | FK target: Market Surveillance Case.Market Surveillance Case Id. |
| 5 | Market Surveillance Case Code | mkt_surveillance_case_code | STRING |  |  |  |  | Mã vụ việc. Denormalized. | GSGD | analysis_report | case_file_id | Lookup pair: Market Surveillance Case.Market Surveillance Case Code. Pair with Market Surveillance Case Id. |
