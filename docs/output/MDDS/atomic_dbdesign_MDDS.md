...
- Diagram theo mảng nghiệp vụ:
  ...
  - **UID02 — Bảng giá chứng khoán và khớp lệnh**: [`MDDS_UID02.dbml`](MDDS_UID02.dbml)
  - **UID03 — Trái phiếu doanh nghiệp**: [`MDDS_UID03.dbml`](MDDS_UID03.dbml)
...
| 3 | scr_tdg_snpst | Snapshot trạng thái giao dịch đa loại chứng khoán (cổ phiếu/CCQ/chứng quyền/phái sinh) tại thời điểm có thay đổi lệnh/khớp lệnh: giá tham chiếu/trần/sàn |
| 4 | corp_bond_tdg_snpst | Snapshot trạng thái giao dịch trái phiếu doanh nghiệp niêm yết HNX tại thời điểm phát sinh thay đổi: giá tham chiếu/trần/sàn/khớp |
| 5 | scr_mtch_log | Log tick-by-tick từng lần khớp lệnh chứng khoán theo thứ tự sequenceMsg. Grain: 1 dòng = 1 lần khớp (symbol × ngày × sequenceMsg). Insert-only. Chứa chiều giao dịch chủ động (lastColor) và tích lũy KL/GT từ đầu ngày. |
| 6 | corp_bond_mtch_log | Log tick-by-tick từng lần khớp lệnh trái phiếu doanh nghiệp theo thứ tự ConfirmNoCorpBond. Grain: 1 dòng = 1 lần khớp (symbol × ngày × confirm_no). Insert-only. |
| 7 | indx_constituent_snpst | Snapshot thành phần rổ chỉ số thị trường: mã chứng khoán thuộc rổ nào (IndexCode × Symbol × ngày giao dịch). Có attribute nghiệp vụ: tỷ trọng (Weighted) và ngày vào rổ (AddDate). |
...
### 2.1.5 Bảng corp_bond_tdg_snpst
...
### 2.1.8 Bảng indx_constituent_snpst
...
### 2.1.9 Stored Procedure/Function
