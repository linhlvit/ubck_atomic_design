...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_THONG_TIN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Country of Registration Id | cty_of_rgst_id | BIGINT | X |  | F |  | FK đến quốc gia đăng ký. | SCMS | CTCK_THONG_TIN | QUOC_GIA_ID | FK target: Geographic Area.Geographic Area Id. Lookup: DM_QUOC_TICH. |
| 5 | Country of Registration Code | cty_of_rgst_code | STRING | X |  |  |  | Mã quốc gia đăng ký. | SCMS | CTCK_THONG_TIN | QUOC_GIA_ID | Lookup pair: Geographic Area.Geographic Area Code. Pair with Country of Registration Id. |
...
| 11 | Director Name | director_nm | STRING | X |  |  |  | Tên Tổng giám đốc (denormalized). | SCMS | CTCK_THONG_TIN |  | Denormalized snapshot — không dùng để join. |
| 12 | Depository Certificate Number | depst_ctf_nbr | STRING | X |  |  |  | Chứng nhận lưu ký. | SCMS | CTCK_THONG_TIN |  |  |
| 13 | Business Type Codes | bsn_tp_codes | Array<Text> | X |  |  |  | Danh sách mã nghiệp vụ kinh doanh. Từ bảng junction SECCOMBUSINES. | SCMS | CTCK_THONG_TIN |  | Pure junction SECCOMBUSINES → denormalize thành ARRAY. Scheme: FIMS_BUSINESS_TYPE. HLD decision: FIMS_HLD_Tier1.md. |
| 14 | Company Type Codes | co_tp_codes | Array<Text> | X |  |  |  | Danh sách mã loại hình doanh nghiệp. Từ bảng junction SECCOMTYPE. | SCMS | CTCK_THONG_TIN |  | Pure junction SECCOMTYPE → denormalize thành ARRAY. Scheme: FIMS_COMPANY_TYPE. HLD decision: FIMS_HLD_Tier1.md. |
| 15 | Description | dsc | STRING | X |  |  |  | Ghi chú. | SCMS | CTCK_THONG_TIN |  |  |
| 16 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | SCMS | CTCK_THONG_TIN |  | Mã người dùng hệ thống — denormalized. |
...
| 19 | Securities Company Business Key | scr_co_bsn_key | STRING | X |  |  |  | ID duy nhất của CTCK dùng liên thông hệ thống (BK nghiệp vụ). | SCMS | CTCK_THONG_TIN | CTCK_THONG_TIN_ID | Trường BK nghiệp vụ — khác với PK kỹ thuật. Dùng liên thông giữa hệ thống. |
| 20 | Securities Company Business Code | scr_co_bsn_code | STRING | X |  |  |  | Mã số CTCK (mã nghiệp vụ ngắn). | SCMS | CTCK_THONG_TIN | MA_SO | Mã nghiệp vụ — khác BK kỹ thuật. |
...
| 24 | Tax Code | tax_code | STRING | X |  |  |  | Mã số thuế. | SCMS | CTCK_THONG_TIN | MA_SO_THUE | Mã số thuế — trường nghiệp vụ riêng. |
...
| 27 | Business Sector Codes | bsn_sctr_codes | Array<Text> | X |  |  |  | Danh sách mã ngành nghề kinh doanh. | SCMS | CTCK_THONG_TIN | NGANH_NGHE_KD_ID | Pure junction LK_CTCK_NGANH_NGHE_KD → denormalize thành ARRAY. Scheme: SCMS_BUSINESS_SECTOR. HLD decision: SCMS_HLD_Tier1.md. |
| 28 | Is Listed Indicator | is_list_ind | STRING | X |  |  |  | Cờ niêm yết: 1-Có niêm yết; 0-Không. | SCMS | CTCK_THONG_TIN | NIEM_YET |  |
| 29 | Stock Exchange Name | stk_exg_nm | STRING | X |  |  |  | Sàn niêm yết. | SCMS | CTCK_THONG_TIN | SAN_NIEM_YET | Text denormalized — tên sàn. |
...
| 37 | Business Activity Category Id | bsn_avy_cgy_id | BIGINT | X |  | F |  | FK đến ngành nghề kinh doanh (DM_NGANH_NGHE_KD). Nullable. | SCMS | CTCK_THONG_TIN | NGANH_NGHE_KINH_DOANH | FK target: DM_NGANH_NGHE_KD entity — chưa được thiết kế lên Silver. |
| 38 | Business Activity Category Code | bsn_avy_cgy_code | STRING | X |  |  |  | Mã ngành nghề kinh doanh. | SCMS | CTCK_THONG_TIN | NGANH_NGHE_KINH_DOANH | Lookup pair: DM_NGANH_NGHE_KD entity — chưa được thiết kế lên Silver. Pair with Business Activity Category Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CT_KIEM_TOAN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Audit Firm Business Code | audt_firm_bsn_code | STRING | X |  |  |  | Mã số công ty kiểm toán (mã nghiệp vụ). | SCMS | CT_KIEM_TOAN | MA_SO | Mã nghiệp vụ — khác BK kỹ thuật. |
...
| 14 | Business Registration Number | bsn_rgst_nbr | STRING | X |  |  |  | Giấy chứng nhận đăng ký kinh doanh. | SCMS | CT_KIEM_TOAN |  | Mã số ĐKKD của công ty kiểm toán — nguồn IDS có thông tin chi tiết hơn SCMS. |
...
| 19 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | SCMS | CT_KIEM_TOAN |  | Denormalized — logins là bảng hệ thống out-of-scope. |
| 20 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | SCMS | CT_KIEM_TOAN |  | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến công ty kiểm toán. | SCMS | CT_KIEM_TOAN | ID | FK target: Audit Firm.Audit Firm Id. Shared entity — không có PK surrogate riêng. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty kiểm toán. | SCMS | CT_KIEM_TOAN | ID | Lookup pair: Audit Firm.Audit Firm Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CT_KIEM_TOAN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_VP_DAI_DIEN_NN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Parent Company Name | prn_co_nm | STRING | X |  |  |  | Tên công ty mẹ (công ty chứng khoán nước ngoài). | SCMS | CTCK_VP_DAI_DIEN_NN | TEN_CONG_TY_ME | Tên pháp nhân nước ngoài — denormalized text. |
...
| 14 | Representative Name | representative_nm | STRING | X |  |  |  | Trưởng văn phòng đại diện. | SCMS | CTCK_VP_DAI_DIEN_NN | TRUONG_DAI_DIEN | Denormalized — tên cá nhân đảm nhận chức vụ. |
| 15 | Nationality Id | nationality_id | BIGINT | X |  | F |  | FK đến quốc tịch trưởng đại diện. | SCMS | CTCK_VP_DAI_DIEN_NN | QUOC_TICH_ID | FK target: Geographic Area.Geographic Area Id. Lookup: DM_QUOC_TICH. |
| 16 | Nationality Code | nationality_code | STRING | X |  |  |  | Mã quốc tịch trưởng đại diện. | SCMS | CTCK_VP_DAI_DIEN_NN | QUOC_TICH_ID | Lookup pair: Geographic Area.Geographic Area Code. Pair with Nationality Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | DM_TINH_THANH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Geographic Area Short Code | geo_shrt_code | STRING | X |  |  |  | Mã viết tắt quốc tịch/quốc gia. | SCMS | DM_TINH_THANH |  | Mã ISO hoặc mã nghiệp vụ do FIMS định nghĩa. |
...
| 8 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | SCMS | DM_TINH_THANH |  | Mã người dùng hệ thống — denormalized. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | DM_QUOC_TICH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Geographic Area Short Code | geo_shrt_code | STRING | X |  |  |  | Mã viết tắt quốc tịch/quốc gia. | SCMS | DM_QUOC_TICH |  | Mã ISO hoặc mã nghiệp vụ do FIMS định nghĩa. |
...
| 8 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | SCMS | DM_QUOC_TICH |  | Mã người dùng hệ thống — denormalized. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | BM_BAO_CAO |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Report Template Business Code | rpt_tpl_bsn_code | STRING | X |  |  |  | Mã báo cáo (mã nghiệp vụ). | SCMS | BM_BAO_CAO | MA_BAO_CAO | Mã nghiệp vụ — khác BK kỹ thuật. |
...
| 17 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | SCMS | BM_BAO_CAO |  | Mã người dùng hệ thống — denormalized. |
...
| 20 | Function Category Id | fcn_cgy_id | BIGINT | X |  | F |  | FK đến danh mục chức năng (QT_CHUC_NANG). Nullable. | SCMS | BM_BAO_CAO | QT_CHUC_NANG_ID | FK target: QT_CHUC_NANG entity — chưa được thiết kế lên Silver. |
| 21 | Function Category Code | fcn_cgy_code | STRING | X |  |  |  | Mã danh mục chức năng. | SCMS | BM_BAO_CAO | QT_CHUC_NANG_ID | Lookup pair: QT_CHUC_NANG entity — chưa được thiết kế lên Silver. Pair with Function Category Id. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_THONG_TIN | ID | FK target: Securities Company.Securities Company Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_THONG_TIN | ID | Lookup pair: Securities Company.Securities Company Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_THONG_TIN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | SCMS | CTCK_THONG_TIN | TINH_THANH_ID | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành phố trụ sở. | SCMS | CTCK_THONG_TIN | TINH_THANH_ID | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | SCMS | CTCK_THONG_TIN | QUAN_HUYEN | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | SCMS | CTCK_THONG_TIN | PHUONG_XA | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | SCMS | CTCK_THONG_TIN |  | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | SCMS | CTCK_THONG_TIN |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | SCMS | CTCK_THONG_TIN |  | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_THONG_TIN | ID | FK target: Securities Company.Securities Company Id. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_THONG_TIN | ID | Lookup pair: Securities Company.Securities Company Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_THONG_TIN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 11 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_THONG_TIN | ID | FK target: Securities Company.Securities Company Id. |
| 12 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_THONG_TIN | ID | Lookup pair: Securities Company.Securities Company Code. Pair with Involved Party Id. |
| 13 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_THONG_TIN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 16 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_THONG_TIN | ID | FK target: Securities Company.Securities Company Id. |
| 17 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_THONG_TIN | ID | Lookup pair: Securities Company.Securities Company Code. Pair with Involved Party Id. |
| 18 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_THONG_TIN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CHI_NHANH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 5 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_CHI_NHANH | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 6 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_CHI_NHANH | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
...
| 11 | Director Name | director_nm | STRING | X |  |  |  | Giám đốc chi nhánh. | SCMS | CTCK_CHI_NHANH | GIAM_DOC | Denormalized — tên cá nhân đảm nhận chức vụ. |
| 12 | Business Sector Name | bsn_sctr_nm | STRING | X |  |  |  | Ngành nghề kinh doanh. | SCMS | CTCK_CHI_NHANH | NGANH_NGHE_KINH_DOANH | Text tự do — không link với bảng ngành nghề. |
...
| 19 | Parent Organization Unit Id | prn_ou_id | BIGINT | X |  | F |  | FK đến chi nhánh quản lý (cấp cha). | SCMS | CTCK_CHI_NHANH |  | FK target: Securities Company Organization Unit.Securities Company Organization Unit Id. Self-join — VPDD trực thuộc chi nhánh. // FK target: Securities Company Organization Unit.Securities Company Organization Unit Id. Self-join — PGD trực thuộc chi nhánh. |
| 20 | Parent Organization Unit Code | prn_ou_code | STRING | X |  |  |  | Mã chi nhánh quản lý. | SCMS | CTCK_CHI_NHANH |  | Lookup pair: Securities Company Organization Unit.Securities Company Organization Unit Code. Pair with Parent Organization Unit Id. |
| 21 | Representative Name | representative_nm | STRING | X |  |  |  | Người đại diện phòng giao dịch. | SCMS | CTCK_CHI_NHANH |  | Denormalized — tên cá nhân đảm nhận chức vụ. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến đơn vị trực thuộc CTCK. | SCMS | CTCK_CHI_NHANH | ID | FK target: Securities Company Organization Unit.Securities Company Organization Unit Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã đơn vị trực thuộc. | SCMS | CTCK_CHI_NHANH | ID | Lookup pair: Securities Company Organization Unit.Securities Company Organization Unit Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CHI_NHANH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | SCMS | CTCK_CHI_NHANH |  | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | SCMS | CTCK_CHI_NHANH |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. // Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện. | SCMS | CTCK_CHI_NHANH | QUAN_HUYEN | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã. | SCMS | CTCK_CHI_NHANH | PHUONG_XA | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | SCMS | CTCK_CHI_NHANH | TINH_THANH_ID | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | SCMS | CTCK_CHI_NHANH | TINH_THANH_ID | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | SCMS | CTCK_CHI_NHANH |  | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến đơn vị trực thuộc CTCK. | SCMS | CTCK_CHI_NHANH | ID | FK target: Securities Company Organization Unit.Securities Company Organization Unit Id. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã đơn vị trực thuộc. | SCMS | CTCK_CHI_NHANH | ID | Lookup pair: Securities Company Organization Unit.Securities Company Organization Unit Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CHI_NHANH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_VP_DAI_DIEN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 5 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_VP_DAI_DIEN | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 6 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_VP_DAI_DIEN | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
...
| 11 | Director Name | director_nm | STRING | X |  |  |  | Giám đốc chi nhánh. | SCMS | CTCK_VP_DAI_DIEN |  | Denormalized — tên cá nhân đảm nhận chức vụ. |
| 12 | Business Sector Name | bsn_sctr_nm | STRING | X |  |  |  | Ngành nghề kinh doanh. | SCMS | CTCK_VP_DAI_DIEN |  | Text tự do — không link với bảng ngành nghề. |
...
| 19 | Parent Organization Unit Id | prn_ou_id | BIGINT | X |  | F |  | FK đến chi nhánh quản lý (cấp cha). | SCMS | CTCK_VP_DAI_DIEN | CTCK_CHI_NHANH_ID | FK target: Securities Company Organization Unit.Securities Company Organization Unit Id. Self-join — VPDD trực thuộc chi nhánh. |
| 20 | Parent Organization Unit Code | prn_ou_code | STRING | X |  |  |  | Mã chi nhánh quản lý. | SCMS | CTCK_VP_DAI_DIEN | CTCK_CHI_NHANH_ID | Lookup pair: Securities Company Organization Unit.Securities Company Organization Unit Code. Pair with Parent Organization Unit Id. |
| 21 | Representative Name | representative_nm | STRING | X |  |  |  | Người đại diện văn phòng. | SCMS | CTCK_VP_DAI_DIEN | NGUOI_DAI_DIEN | Denormalized — tên cá nhân đảm nhận chức vụ. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_PHONG_GIAO_DICH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 5 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_PHONG_GIAO_DICH | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 6 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_PHONG_GIAO_DICH | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
...
| 11 | Director Name | director_nm | STRING | X |  |  |  | Giám đốc chi nhánh. | SCMS | CTCK_PHONG_GIAO_DICH |  | Denormalized — tên cá nhân đảm nhận chức vụ. |
| 12 | Business Sector Name | bsn_sctr_nm | STRING | X |  |  |  | Ngành nghề kinh doanh. | SCMS | CTCK_PHONG_GIAO_DICH |  | Text tự do — không link với bảng ngành nghề. |
...
| 19 | Parent Organization Unit Id | prn_ou_id | BIGINT | X |  | F |  | FK đến chi nhánh quản lý (cấp cha). | SCMS | CTCK_PHONG_GIAO_DICH | CTCK_CHI_NHANH_ID | FK target: Securities Company Organization Unit.Securities Company Organization Unit Id. Self-join — PGD trực thuộc chi nhánh. |
| 20 | Parent Organization Unit Code | prn_ou_code | STRING | X |  |  |  | Mã chi nhánh quản lý. | SCMS | CTCK_PHONG_GIAO_DICH | CTCK_CHI_NHANH_ID | Lookup pair: Securities Company Organization Unit.Securities Company Organization Unit Code. Pair with Parent Organization Unit Id. |
| 21 | Representative Name | representative_nm | STRING | X |  |  |  | Người đại diện phòng giao dịch. | SCMS | CTCK_PHONG_GIAO_DICH | NGUOI_DAI_DIEN | Denormalized — tên cá nhân đảm nhận chức vụ. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_NGUOI_HANH_NGHE_CK |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Full Name | full_nm | STRING | X |  |  |  | Họ và tên người hành nghề. | SCMS | CTCK_NGUOI_HANH_NGHE_CK | HO_TEN |  |
| 5 | Birth Year | brth_yr | STRING | X |  |  |  | Năm sinh | SCMS | CTCK_NGUOI_HANH_NGHE_CK |  | Text vì là năm dạng "1990". Lấy từ Professionals (không có trong ProfessionalHistories). |
...
| 10 | Birth Place | brth_plc | STRING | X |  |  |  | Nơi sinh | SCMS | CTCK_NGUOI_HANH_NGHE_CK |  | Lấy từ bản mới nhất ProfessionalHistories. Professionals không có trường này. |
...
| 13 | Country of Residence Geographic Area Id | cty_of_rsdnc_geo_id | BIGINT | X |  | F |  | FK đến quốc gia cư trú. | SCMS | CTCK_NGUOI_HANH_NGHE_CK |  | FK target: Geographic Area.Geographic Area Id. |
| 14 | Country of Residence Geographic Area Code | cty_of_rsdnc_geo_code | STRING | X |  |  |  | Mã quốc gia cư trú. | SCMS | CTCK_NGUOI_HANH_NGHE_CK |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Country of Residence Geographic Area Id. |
| 15 | Identity Reference Code | identity_refr_code | STRING | X |  |  |  | Mã định danh giấy tờ tùy thân (FK bảng identity riêng) | SCMS | CTCK_NGUOI_HANH_NGHE_CK |  | Bảng identity riêng không có trong scope NHNCK — lưu BK dạng Text. |
...
| 17 | Occupation Name | ocp_nm | STRING | X |  |  |  | Nghề nghiệp | SCMS | CTCK_NGUOI_HANH_NGHE_CK |  | Text tự do. |
| 18 | Workplace Name | workplace_nm | STRING | X |  |  |  | Nơi làm việc | SCMS | CTCK_NGUOI_HANH_NGHE_CK |  | Text tự do. |
...
| 21 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán nơi hành nghề. | SCMS | CTCK_NGUOI_HANH_NGHE_CK | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 22 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_NGUOI_HANH_NGHE_CK | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
| 23 | Employee Code | empe_code | STRING | X |  |  |  | Mã nhân viên nội bộ CTCK. | SCMS | CTCK_NGUOI_HANH_NGHE_CK | MA_NHAN_VIEN | Mã nhân viên do CTCK cấp — bổ sung từ SCMS. Không có trong NHNCK. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến người hành nghề chứng khoán. | SCMS | CTCK_NGUOI_HANH_NGHE_CK | ID | FK target: Practitioner.Practitioner Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã người hành nghề chứng khoán. | SCMS | CTCK_NGUOI_HANH_NGHE_CK | ID | Lookup pair: Practitioner.Practitioner Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_NGUOI_HANH_NGHE_CK |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_NHAN_SU_CAO_CAP |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_NHAN_SU_CAO_CAP | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 5 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_NHAN_SU_CAO_CAP | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
| 6 | Organization Unit Id | ou_id | BIGINT | X |  | F |  | FK đến chi nhánh trực thuộc (nếu có). | SCMS | CTCK_NHAN_SU_CAO_CAP | CTCK_CHI_NHANH_ID | FK target: Securities Company Organization Unit.Securities Company Organization Unit Id. Nullable — nhân sự trụ sở không có chi nhánh. |
| 7 | Organization Unit Code | ou_code | STRING | X |  |  |  | Mã chi nhánh trực thuộc. | SCMS | CTCK_NHAN_SU_CAO_CAP | CTCK_CHI_NHANH_ID | Lookup pair: Securities Company Organization Unit.Securities Company Organization Unit Code. Pair with Organization Unit Id. |
...
| 12 | Nationality Id | nationality_id | BIGINT | X |  | F |  | FK đến quốc tịch nhân sự. | SCMS | CTCK_NHAN_SU_CAO_CAP | DM_QUOC_TICH_ID | FK target: Geographic Area.Geographic Area Id. Lookup: DM_QUOC_TICH. |
| 13 | Nationality Code | nationality_code | STRING | X |  |  |  | Mã quốc tịch nhân sự. | SCMS | CTCK_NHAN_SU_CAO_CAP | DM_QUOC_TICH_ID | Lookup pair: Geographic Area.Geographic Area Code. Pair with Nationality Id. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến nhân sự cao cấp CTCK. | SCMS | CTCK_NHAN_SU_CAO_CAP | ID | FK target: Securities Company Senior Personnel.Securities Company Senior Personnel Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã nhân sự cao cấp. | SCMS | CTCK_NHAN_SU_CAO_CAP | ID | Lookup pair: Securities Company Senior Personnel.Securities Company Senior Personnel Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_NHAN_SU_CAO_CAP |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | SCMS | CTCK_NHAN_SU_CAO_CAP |  | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến nhân sự cao cấp CTCK. | SCMS | CTCK_NHAN_SU_CAO_CAP | ID | FK target: Securities Company Senior Personnel.Securities Company Senior Personnel Id. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã nhân sự cao cấp. | SCMS | CTCK_NHAN_SU_CAO_CAP | ID | Lookup pair: Securities Company Senior Personnel.Securities Company Senior Personnel Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_NHAN_SU_CAO_CAP |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 11 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến nhân sự cao cấp CTCK. | SCMS | CTCK_NHAN_SU_CAO_CAP | ID | FK target: Securities Company Senior Personnel.Securities Company Senior Personnel Id. |
| 12 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã nhân sự cao cấp. | SCMS | CTCK_NHAN_SU_CAO_CAP | ID | Lookup pair: Securities Company Senior Personnel.Securities Company Senior Personnel Code. Pair with Involved Party Id. |
| 13 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_NHAN_SU_CAO_CAP |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 16 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến nhân sự cao cấp CTCK. | SCMS | CTCK_NHAN_SU_CAO_CAP | ID | FK target: Securities Company Senior Personnel.Securities Company Senior Personnel Id. |
| 17 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã nhân sự cao cấp. | SCMS | CTCK_NHAN_SU_CAO_CAP | ID | Lookup pair: Securities Company Senior Personnel.Securities Company Senior Personnel Code. Pair with Involved Party Id. |
| 18 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_NHAN_SU_CAO_CAP |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến nhân sự cao cấp. | SCMS | CTCK_NHAN_SU_CAO_CAP | ID | FK target: Securities Company Senior Personnel.Securities Company Senior Personnel Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã nhân sự cao cấp. | SCMS | CTCK_NHAN_SU_CAO_CAP | ID | Lookup pair: Securities Company Senior Personnel.Securities Company Senior Personnel Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_NHAN_SU_CAO_CAP |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CO_DONG |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_CO_DONG | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 5 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_CO_DONG | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
| 6 | Shareholder Name | shrhlr_nm | STRING | X |  |  |  | Tên cổ đông (cá nhân hoặc tổ chức). | SCMS | CTCK_CO_DONG | TEN_CO_DONG |  |
| 7 | Is Individual Indicator | is_idv_ind | STRING | X |  |  |  | Loại chủ thể: 1-Cá nhân; 0-Tổ chức. | SCMS | CTCK_CO_DONG | IS_CA_NHAN | Phân biệt cá nhân / tổ chức. |
| 8 | Date Of Birth | dob | DATE | X |  |  |  | Ngày sinh (áp dụng cho cá nhân). | SCMS | CTCK_CO_DONG | NGAY_SINH | Nullable với cổ đông tổ chức. |
| 9 | Birth Place | brth_plc | STRING | X |  |  |  | Nơi sinh. | SCMS | CTCK_CO_DONG | NOI_SINH |  |
| 10 | Nationality Id | nationality_id | BIGINT | X |  | F |  | FK đến quốc tịch cổ đông. | SCMS | CTCK_CO_DONG | QUOC_TICH_ID | FK target: Geographic Area.Geographic Area Id. Lookup: DM_QUOC_TICH. |
| 11 | Nationality Code | nationality_code | STRING | X |  |  |  | Mã quốc tịch cổ đông. | SCMS | CTCK_CO_DONG | QUOC_TICH_ID | Lookup pair: Geographic Area.Geographic Area Code. Pair with Nationality Id. |
...
| 13 | Education Level Name | ed_lvl_nm | STRING | X |  |  |  | Trình độ học vấn. | SCMS | CTCK_CO_DONG | TRINH_DO | Text tự do — không có bảng lookup trong scope. |
| 14 | Occupation Name | ocp_nm | STRING | X |  |  |  | Nghề nghiệp. | SCMS | CTCK_CO_DONG | NGHE_NGHIEP |  |
| 15 | Degree Name | dgr_nm | STRING | X |  |  |  | Bằng cấp. | SCMS | CTCK_CO_DONG | BANG_CAP | Text tự do — denormalized. |
...
| 24 | Significant Shareholder Date | sig_shrhlr_dt | DATE | X |  |  |  | Ngày đạt tỷ lệ sở hữu đáng kể. | SCMS | CTCK_CO_DONG | NGAY_DAT_TLSH | Ngày đạt ngưỡng tỷ lệ sở hữu đáng kể theo quy định. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến cổ đông CTCK. | SCMS | CTCK_CO_DONG | ID | FK target: Securities Company Shareholder.Securities Company Shareholder Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã cổ đông. | SCMS | CTCK_CO_DONG | ID | Lookup pair: Securities Company Shareholder.Securities Company Shareholder Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CO_DONG |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | SCMS | CTCK_CO_DONG |  | Text tự do — denormalized. |
| 7 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến cổ đông CTCK. | SCMS | CTCK_CO_DONG | ID | FK target: Securities Company Shareholder.Securities Company Shareholder Id. |
| 8 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã cổ đông. | SCMS | CTCK_CO_DONG | ID | Lookup pair: Securities Company Shareholder.Securities Company Shareholder Code. Pair with Involved Party Id. |
| 9 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CO_DONG |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | SCMS | CTCK_CO_DONG |  | Text tự do — denormalized. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến cổ đông. | SCMS | CTCK_CO_DONG | ID | FK target: Securities Company Shareholder.Securities Company Shareholder Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã cổ đông. | SCMS | CTCK_CO_DONG | ID | Lookup pair: Securities Company Shareholder.Securities Company Shareholder Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CO_DONG |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CT_KIEM_TOAN_VIEN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Audit Firm Id | audt_firm_id | BIGINT |  |  | F |  | FK đến công ty kiểm toán. | SCMS | CT_KIEM_TOAN_VIEN | CT_KIEM_TOAN_ID | FK target: Audit Firm.Audit Firm Id. |
| 5 | Audit Firm Code | audt_firm_code | STRING |  |  |  |  | Mã công ty kiểm toán. | SCMS | CT_KIEM_TOAN_VIEN | CT_KIEM_TOAN_ID | Lookup pair: Audit Firm.Audit Firm Code. Pair with Audit Firm Id. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Audit Firm Practitioner. | SCMS | CT_KIEM_TOAN_VIEN | ID | FK target: Audit Firm Practitioner.Audit Firm Practitioner Id. Shared entity — không có PK surrogate riêng. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã kiểm toán viên. | SCMS | CT_KIEM_TOAN_VIEN | ID | Lookup pair: Audit Firm Practitioner.Audit Firm Practitioner Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CT_KIEM_TOAN_VIEN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 8 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Audit Firm Practitioner. | SCMS | CT_KIEM_TOAN_VIEN | ID | FK target: Audit Firm Practitioner.Audit Firm Practitioner Id. Shared entity — không có PK surrogate riêng. |
| 9 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã kiểm toán viên. | SCMS | CT_KIEM_TOAN_VIEN | ID | Lookup pair: Audit Firm Practitioner.Audit Firm Practitioner Code. Pair with Involved Party Id. |
| 10 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CT_KIEM_TOAN_VIEN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | BM_BAO_CAO_DINH_KY |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Report Template Id | rpt_tpl_id | BIGINT |  |  | F |  | FK đến biểu mẫu báo cáo. | SCMS | BM_BAO_CAO_DINH_KY | BM_BAO_CAO_ID | FK target: Report Template.Report Template Id. |
| 5 | Report Template Code | rpt_tpl_code | STRING |  |  |  |  | Mã biểu mẫu báo cáo. | SCMS | BM_BAO_CAO_DINH_KY | BM_BAO_CAO_ID | Lookup pair: Report Template.Report Template Code. Pair with Report Template Id. |
...
| 8 | Grace Period Days | grc_prd_dys | INT | X |  |  |  | Khoảng thời gian gia hạn T+ (số ngày). | SCMS | BM_BAO_CAO_DINH_KY | T | T+: số ngày gia hạn cho kỳ báo cáo. |
| 9 | Submission Deadline | submission_ddln | STRING | X |  |  |  | Thời gian nộp báo cáo. | SCMS | BM_BAO_CAO_DINH_KY | THOI_GIAN | Text — cần xác nhận format (ngày/giờ hoặc quy tắc T+N). |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | BM_BAO_CAO_DINH_KY_DON_VI |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Report Submission Schedule Id | rpt_submission_shd_id | BIGINT |  |  | F |  | FK đến định kỳ gửi báo cáo. | SCMS | BM_BAO_CAO_DINH_KY_DON_VI | BM_BAO_CAO_DINH_KY_ID | FK target: Report Submission Schedule.Report Submission Schedule Id. |
| 5 | Report Submission Schedule Code | rpt_submission_shd_code | STRING |  |  |  |  | Mã định kỳ gửi báo cáo. | SCMS | BM_BAO_CAO_DINH_KY_DON_VI | BM_BAO_CAO_DINH_KY_ID | Lookup pair: Report Submission Schedule.Report Submission Schedule Code. Pair with Report Submission Schedule Id. |
| 6 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán có nghĩa vụ gửi. | SCMS | BM_BAO_CAO_DINH_KY_DON_VI | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 7 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | BM_BAO_CAO_DINH_KY_DON_VI | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
| 8 | Obligated Companies Reference Code | obligated_companies_refr_code | STRING | X |  | F |  | BK tham chiếu đến bản ghi danh sách thành viên gửi (BM_BAO_CAO_TV). | SCMS | BM_BAO_CAO_DINH_KY_DON_VI | BM_BAO_CAO_TV_ID | FK không resolve được — BM_BAO_CAO_TV là junction đã denormalize vào Report Template. Lưu BK nguồn dạng Text để traceability. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | BC_THANH_VIEN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Fund Management Company Id | fnd_mgt_co_id | BIGINT | X |  | F |  | FK đến công ty QLQ nộp báo cáo (nullable). | SCMS | BC_THANH_VIEN |  | FK target: Fund Management Company.Fund Management Company Id. |
| 5 | Fund Management Company Code | fnd_mgt_co_code | STRING | X |  |  |  | Mã công ty QLQ. | SCMS | BC_THANH_VIEN |  | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Fund Management Company Id. |
| 6 | Investment Fund Id | ivsm_fnd_id | BIGINT | X |  | F |  | FK đến quỹ đầu tư nộp báo cáo (nullable). | SCMS | BC_THANH_VIEN |  | FK target: Investment Fund.Investment Fund Id. |
| 7 | Investment Fund Code | ivsm_fnd_code | STRING | X |  |  |  | Mã quỹ đầu tư. | SCMS | BC_THANH_VIEN |  | Lookup pair: Investment Fund.Investment Fund Code. Pair with Investment Fund Id. |
| 8 | Custodian Bank Id | cstd_bnk_id | BIGINT | X |  | F |  | FK đến ngân hàng LKGS nộp báo cáo (nullable). | SCMS | BC_THANH_VIEN |  | FK target: Custodian Bank.Custodian Bank Id. |
| 9 | Custodian Bank Code | cstd_bnk_code | STRING | X |  |  |  | Mã ngân hàng LKGS. | SCMS | BC_THANH_VIEN |  | Lookup pair: Custodian Bank.Custodian Bank Code. Pair with Custodian Bank Id. |
| 10 | Foreign Fund Management Organization Unit Id | frgn_fnd_mgt_ou_id | BIGINT | X |  | F |  | FK đến VPĐD/CN QLQ NN nộp báo cáo (nullable). | SCMS | BC_THANH_VIEN |  | FK target: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Id. |
| 11 | Foreign Fund Management Organization Unit Code | frgn_fnd_mgt_ou_code | STRING | X |  |  |  | Mã VPĐD/CN QLQ NN. | SCMS | BC_THANH_VIEN |  | Lookup pair: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Code. Pair with Foreign Fund Management Organization Unit Id. |
| 12 | Report Template Id | rpt_tpl_id | BIGINT |  |  | F |  | FK đến biểu mẫu báo cáo. | SCMS | BC_THANH_VIEN | BM_BAO_CAO_ID | FK target: Report Template.Report Template Id. |
| 13 | Report Template Code | rpt_tpl_code | STRING |  |  |  |  | Mã biểu mẫu báo cáo. | SCMS | BC_THANH_VIEN | BM_BAO_CAO_ID | Lookup pair: Report Template.Report Template Code. Pair with Report Template Id. |
| 14 | Reporting Period Id | rpt_prd_id | BIGINT |  |  | F |  | FK đến kỳ báo cáo. | SCMS | BC_THANH_VIEN |  | FK target: Reporting Period.Reporting Period Id. |
| 15 | Reporting Period Code | rpt_prd_code | STRING |  |  |  |  | Mã kỳ báo cáo. | SCMS | BC_THANH_VIEN |  | Lookup pair: Reporting Period.Reporting Period Code. Pair with Reporting Period Id. |
...
| 27 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | SCMS | BC_THANH_VIEN |  | Mã người dùng hệ thống — denormalized. |
...
| 30 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán gửi báo cáo. | SCMS | BC_THANH_VIEN | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 31 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | BC_THANH_VIEN | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
| 32 | Report Submission Schedule Id | rpt_submission_shd_id | BIGINT | X |  | F |  | FK đến định kỳ gửi báo cáo. | SCMS | BC_THANH_VIEN | BM_BAO_CAO_DINH_KY_ID | FK target: Report Submission Schedule.Report Submission Schedule Id. |
| 33 | Report Submission Schedule Code | rpt_submission_shd_code | STRING | X |  |  |  | Mã định kỳ gửi báo cáo. | SCMS | BC_THANH_VIEN | BM_BAO_CAO_DINH_KY_ID | Lookup pair: Report Submission Schedule.Report Submission Schedule Code. Pair with Report Submission Schedule Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | BC_VI_PHAM |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán vi phạm. | SCMS | BC_VI_PHAM | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 5 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | BC_VI_PHAM | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
...
| 8 | Violation Type Codes | vln_tp_codes | Array<Text> | X |  |  |  | Danh sách mã loại vi phạm. | SCMS | BC_VI_PHAM | DM_LOAI_VI_PHAM_ID | Pure junction BC_VI_PHAM_LOAI_VP → denormalize thành ARRAY. Scheme: SCMS_VIOLATION_TYPE. HLD decision: SCMS_HLD_Tier4.md. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_XU_LY_HANH_CHINH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán bị xử lý. | SCMS | CTCK_XU_LY_HANH_CHINH | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 5 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_XU_LY_HANH_CHINH | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CBTT_BAO_CAO |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán công bố. | SCMS | CBTT_BAO_CAO | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 5 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CBTT_BAO_CAO | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
...
| 8 | Reporting Period Code | rpt_prd_code | STRING | X |  |  |  | Kỳ báo cáo. | SCMS | CBTT_BAO_CAO | KY_BAO_CAO | Text tự do — kỳ báo cáo (VD: Q1/2024). |
...
| 13 | Disclosing Person Name | disclosing_psn_nm | STRING | X |  |  |  | Người công bố thông tin. | SCMS | CBTT_BAO_CAO | NGUOI_CBTT | Denormalized — tên cá nhân thực hiện công bố. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CBTT_CHAO_BAN_CHUNG_KHOAN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán chào bán. | SCMS | CBTT_CHAO_BAN_CHUNG_KHOAN | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 5 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CBTT_CHAO_BAN_CHUNG_KHOAN | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
...
| 12 | Target Investor Name | trgt_ivsr_nm | STRING | X |  |  |  | Đối tượng chào bán. | SCMS | CBTT_CHAO_BAN_CHUNG_KHOAN | DOI_TUONG_CHAO_BAN | Text tự do — mô tả đối tượng nhà đầu tư mục tiêu. |
...
| 16 | Disclosing Person Name | disclosing_psn_nm | STRING | X |  |  |  | Người công bố thông tin. | SCMS | CBTT_CHAO_BAN_CHUNG_KHOAN | NGUOI_CBTT | Denormalized — tên cá nhân thực hiện công bố. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CBTT_CO_DONG |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán công bố. | SCMS | CBTT_CO_DONG | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 5 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CBTT_CO_DONG | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | BC_BAO_CAO_GT |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Report Template Id | rpt_tpl_id | BIGINT | X |  | F |  | FK đến biểu mẫu báo cáo. | SCMS | BC_BAO_CAO_GT | BM_BAO_CAO_ID | FK target: Report Template.Report Template Id. |
| 5 | Report Template Code | rpt_tpl_code | STRING | X |  |  |  | Mã biểu mẫu báo cáo. | SCMS | BC_BAO_CAO_GT | BM_BAO_CAO_ID | Lookup pair: Report Template.Report Template Code. Pair with Report Template Id. |
| 6 | Securities Company Id | scr_co_id | BIGINT | X |  | F |  | FK đến công ty chứng khoán nộp báo cáo. | SCMS | BC_BAO_CAO_GT | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 7 | Securities Company Code | scr_co_code | STRING | X |  |  |  | Mã công ty chứng khoán. | SCMS | BC_BAO_CAO_GT | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
| 8 | Report Template Sheet Id | rpt_tpl_shet_id | BIGINT | X |  | F |  | FK đến sheet báo cáo. | SCMS | BC_BAO_CAO_GT | BM_SHEET_ID | FK target: Report Template Sheet.Report Template Sheet Id. |
| 9 | Report Template Sheet Code | rpt_tpl_shet_code | STRING | X |  |  |  | Mã sheet báo cáo. | SCMS | BC_BAO_CAO_GT | BM_SHEET_ID | Lookup pair: Report Template Sheet.Report Template Sheet Code. Pair with Report Template Sheet Id. |
| 10 | Report Template Row Id | rpt_tpl_row_id | BIGINT | X |  | F |  | FK đến hàng báo cáo. | SCMS | BC_BAO_CAO_GT | BM_BAO_CAO_HANG_ID | FK target: Report Template Row.Report Template Row Id. |
| 11 | Report Template Row Code | rpt_tpl_row_code | STRING | X |  |  |  | Mã hàng báo cáo. | SCMS | BC_BAO_CAO_GT | BM_BAO_CAO_HANG_ID | Lookup pair: Report Template Row.Report Template Row Code. Pair with Report Template Row Id. |
| 12 | Report Template Column Id | rpt_tpl_clmn_id | BIGINT | X |  | F |  | FK đến cột báo cáo. | SCMS | BC_BAO_CAO_GT | BM_BAO_CAO_COT_ID | FK target: Report Template Column.Report Template Column Id. |
| 13 | Report Template Column Code | rpt_tpl_clmn_code | STRING | X |  |  |  | Mã cột báo cáo. | SCMS | BC_BAO_CAO_GT | BM_BAO_CAO_COT_ID | Lookup pair: Report Template Column.Report Template Column Code. Pair with Report Template Column Id. |
| 14 | Member Periodic Report Id | mbr_prd_rpt_id | BIGINT |  |  | F |  | FK đến lần nộp báo cáo. | SCMS | BC_BAO_CAO_GT | BC_THANH_VIEN_ID | FK target: Member Periodic Report.Member Periodic Report Id. |
| 15 | Member Periodic Report Code | mbr_prd_rpt_code | STRING |  |  |  |  | Mã lần nộp báo cáo. | SCMS | BC_BAO_CAO_GT | BC_THANH_VIEN_ID | Lookup pair: Member Periodic Report.Member Periodic Report Code. Pair with Member Periodic Report Id. |
| 16 | Report Template Indicator Id | rpt_tpl_ind_id | BIGINT | X |  | F |  | FK đến chỉ tiêu trong biểu mẫu. | SCMS | BC_BAO_CAO_GT | BM_BAO_CAO_CT_ID | FK target: Report Template Indicator.Report Template Indicator Id. Nullable — một số giá trị không map với chỉ tiêu cụ thể. |
| 17 | Report Template Indicator Code | rpt_tpl_ind_code | STRING | X |  |  |  | Mã chỉ tiêu trong biểu mẫu. | SCMS | BC_BAO_CAO_GT | BM_BAO_CAO_CT_ID | Lookup pair: Report Template Indicator.Report Template Indicator Code. Pair with Report Template Indicator Id. |
| 18 | Report Indicator Id | rpt_ind_id | BIGINT | X |  | F |  | FK đến chỉ tiêu danh mục. | SCMS | BC_BAO_CAO_GT | DM_CHI_TIEU_ID | FK target: Report Indicator.Report Indicator Id. Lookup: DM_CHI_TIEU. |
| 19 | Report Indicator Code | rpt_ind_code | STRING | X |  |  |  | Mã chỉ tiêu danh mục. | SCMS | BC_BAO_CAO_GT | DM_CHI_TIEU_ID | Lookup pair: Report Indicator.Report Indicator Code. Pair with Report Indicator Id. |
| 20 | Sheet Name | shet_nm | STRING | X |  |  |  | Tên sheet báo cáo (denormalized). | SCMS | BC_BAO_CAO_GT | TEN_SHEET | Denormalized từ BM_SHEET — lưu lại tại thời điểm nhập liệu. |
| 21 | Row Name | row_nm | STRING | X |  |  |  | Tên hàng báo cáo (denormalized). | SCMS | BC_BAO_CAO_GT | TEN_HANG | Denormalized từ BM_BAO_CAO_HANG — lưu lại tại thời điểm nhập liệu. |
| 22 | Column Name | clmn_nm | STRING | X |  |  |  | Tên cột báo cáo (denormalized). | SCMS | BC_BAO_CAO_GT | TEN_COT | Denormalized từ BM_BAO_CAO_COT — lưu lại tại thời điểm nhập liệu. |
| 23 | Row Sequence | row_seq | INT | X |  | F |  | Số thứ tự dòng dữ liệu (cho chỉ tiêu lặp). | SCMS | BC_BAO_CAO_GT | ROW_ID | ROW_ID = số thứ tự dòng trong tập lặp — không phải FK đến bảng hàng. |
| 24 | Catalog Name | ctlg_nm | STRING | X |  |  |  | Tên danh mục tương ứng (nếu chỉ tiêu kiểu danh mục). | SCMS | BC_BAO_CAO_GT | TEN_DANH_MUC |  |
| 25 | Catalog Id Reference | ctlg_id_refr | STRING | X |  | F |  | Khóa danh mục tương ứng. | SCMS | BC_BAO_CAO_GT | ID_DANH_MUC | Lưu dạng Text — danh mục FK đến nhiều bảng khác nhau tùy chỉ tiêu. |
| 26 | Catalog Display Value | ctlg_dspl_val | STRING | X |  |  |  | Giá trị hiển thị của danh mục. | SCMS | BC_BAO_CAO_GT | TEXT_DANH_MUC |  |
| 27 | Value | val | STRING | X |  |  |  | Giá trị chỉ tiêu. | SCMS | BC_BAO_CAO_GT | GIA_TRI | Lưu dạng Text — kiểu thực tế phụ thuộc KIEU_DU_LIEU của chỉ tiêu (số/văn bản/ngày/danh mục/công thức). |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CD_CHUYEN_NHUONG |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_CD_CHUYEN_NHUONG | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 5 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_CD_CHUYEN_NHUONG | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
| 6 | From Shareholder Id | fm_shrhlr_id | BIGINT |  |  | F |  | FK đến cổ đông chuyển nhượng. | SCMS | CTCK_CD_CHUYEN_NHUONG | CTCK_CD_CHUYEN | FK target: Securities Company Shareholder.Securities Company Shareholder Id. |
| 7 | From Shareholder Code | fm_shrhlr_code | STRING |  |  |  |  | Mã cổ đông chuyển nhượng. | SCMS | CTCK_CD_CHUYEN_NHUONG | CTCK_CD_CHUYEN | Lookup pair: Securities Company Shareholder.Securities Company Shareholder Code. Pair with From Shareholder Id. |
| 8 | To Shareholder Id | to_shrhlr_id | BIGINT |  |  | F |  | FK đến cổ đông nhận chuyển nhượng. | SCMS | CTCK_CD_CHUYEN_NHUONG | CTCK_CD_NHAN | FK target: Securities Company Shareholder.Securities Company Shareholder Id. |
| 9 | To Shareholder Code | to_shrhlr_code | STRING |  |  |  |  | Mã cổ đông nhận chuyển nhượng. | SCMS | CTCK_CD_CHUYEN_NHUONG | CTCK_CD_NHAN | Lookup pair: Securities Company Shareholder.Securities Company Shareholder Code. Pair with To Shareholder Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CD_DAI_DIEN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Securities Company Shareholder Id | scr_co_shrhlr_id | BIGINT |  |  | F |  | FK đến cổ đông được đại diện. | SCMS | CTCK_CD_DAI_DIEN | CTCK_CO_DONG_ID | FK target: Securities Company Shareholder.Securities Company Shareholder Id. |
| 5 | Securities Company Shareholder Code | scr_co_shrhlr_code | STRING |  |  |  |  | Mã cổ đông. | SCMS | CTCK_CD_DAI_DIEN | CTCK_CO_DONG_ID | Lookup pair: Securities Company Shareholder.Securities Company Shareholder Code. Pair with Securities Company Shareholder Id. |
| 6 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_CD_DAI_DIEN | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 7 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_CD_DAI_DIEN | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
| 8 | Representative Name | representative_nm | STRING | X |  |  |  | Họ và tên người đại diện. | SCMS | CTCK_CD_DAI_DIEN | NGUOI_DAI_DIEN | Denormalized — tên cá nhân đại diện. |
| 9 | Position Name | pos_nm | STRING | X |  |  |  | Chức vụ người đại diện. | SCMS | CTCK_CD_DAI_DIEN | CHUC_VU | Text tự do. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến người đại diện cổ đông. | SCMS | CTCK_CD_DAI_DIEN | ID | FK target: Securities Company Shareholder Representative.Securities Company Shareholder Representative Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã người đại diện cổ đông. | SCMS | CTCK_CD_DAI_DIEN | ID | Lookup pair: Securities Company Shareholder Representative.Securities Company Shareholder Representative Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CD_DAI_DIEN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CD_MOI_QUAN_HE |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Securities Company Shareholder Id | scr_co_shrhlr_id | BIGINT |  |  | F |  | FK đến cổ đông có người liên quan. | SCMS | CTCK_CD_MOI_QUAN_HE | CTCK_CO_DONG_ID | FK target: Securities Company Shareholder.Securities Company Shareholder Id. |
| 5 | Securities Company Shareholder Code | scr_co_shrhlr_code | STRING |  |  |  |  | Mã cổ đông. | SCMS | CTCK_CD_MOI_QUAN_HE | CTCK_CO_DONG_ID | Lookup pair: Securities Company Shareholder.Securities Company Shareholder Code. Pair with Securities Company Shareholder Id. |
| 6 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán. | SCMS | CTCK_CD_MOI_QUAN_HE | CTCK_THONG_TIN_ID | FK target: Securities Company.Securities Company Id. |
| 7 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | SCMS | CTCK_CD_MOI_QUAN_HE | CTCK_THONG_TIN_ID | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
...
| 12 | Related Securities Company Name | rel_scr_co_nm | STRING | X |  | F |  | Tên CTCK có liên quan (nếu người liên quan cũng là cổ đông CTCK khác). | SCMS | CTCK_CD_MOI_QUAN_HE | TEN_CTCK_CO_CP | Denormalized — tên công ty liên quan. Không có FK đến CTCK_THONG_TIN. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến người có quan hệ với cổ đông. | SCMS | CTCK_CD_MOI_QUAN_HE | ID | FK target: Securities Company Shareholder Related Party.Securities Company Shareholder Related Party Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã người có quan hệ với cổ đông. | SCMS | CTCK_CD_MOI_QUAN_HE | ID | Lookup pair: Securities Company Shareholder Related Party.Securities Company Shareholder Related Party Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_CD_MOI_QUAN_HE |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Audit Firm. | SCMS | CT_KIEM_TOAN | ID | FK target: Audit Firm.Audit Firm Id. Shared entity — không có PK surrogate riêng. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty kiểm toán. | SCMS | CT_KIEM_TOAN | ID | Lookup pair: Audit Firm.Audit Firm Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CT_KIEM_TOAN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | SCMS | CT_KIEM_TOAN |  | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | SCMS | CT_KIEM_TOAN |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. // Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | SCMS | CT_KIEM_TOAN |  | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | SCMS | CT_KIEM_TOAN |  | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | SCMS | CT_KIEM_TOAN |  | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | SCMS | CT_KIEM_TOAN |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | SCMS | CT_KIEM_TOAN |  | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Audit Firm. | SCMS | CT_KIEM_TOAN | ID | FK target: Audit Firm.Audit Firm Id. Shared entity — không có PK surrogate riêng. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty kiểm toán. | SCMS | CT_KIEM_TOAN | ID | Lookup pair: Audit Firm.Audit Firm Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CT_KIEM_TOAN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 11 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Audit Firm. | SCMS | CT_KIEM_TOAN | ID | FK target: Audit Firm.Audit Firm Id. Shared entity — không có PK surrogate riêng. |
| 12 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty kiểm toán. | SCMS | CT_KIEM_TOAN | ID | Lookup pair: Audit Firm.Audit Firm Code. Pair with Involved Party Id. |
| 13 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CT_KIEM_TOAN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 16 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Audit Firm. | SCMS | CT_KIEM_TOAN | ID | FK target: Audit Firm.Audit Firm Id. Shared entity — không có PK surrogate riêng. |
| 17 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty kiểm toán. | SCMS | CT_KIEM_TOAN | ID | Lookup pair: Audit Firm.Audit Firm Code. Pair with Involved Party Id. |
| 18 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CT_KIEM_TOAN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến phòng giao dịch. | SCMS | CTCK_PHONG_GIAO_DICH | ID | FK target: Securities Company Organization Unit.Securities Company Organization Unit Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã phòng giao dịch. | SCMS | CTCK_PHONG_GIAO_DICH | ID | Lookup pair: Securities Company Organization Unit.Securities Company Organization Unit Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_PHONG_GIAO_DICH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố. | SCMS | CTCK_PHONG_GIAO_DICH | TINH_THANH_ID | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành phố. | SCMS | CTCK_PHONG_GIAO_DICH | TINH_THANH_ID | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện. | SCMS | CTCK_PHONG_GIAO_DICH | QUAN_HUYEN | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã. | SCMS | CTCK_PHONG_GIAO_DICH | PHUONG_XA | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | SCMS | CTCK_PHONG_GIAO_DICH |  | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | SCMS | CTCK_PHONG_GIAO_DICH |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ phòng giao dịch. | SCMS | CTCK_PHONG_GIAO_DICH | DIA_CHI | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến phòng giao dịch. | SCMS | CTCK_PHONG_GIAO_DICH | ID | FK target: Securities Company Organization Unit.Securities Company Organization Unit Id. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã phòng giao dịch. | SCMS | CTCK_PHONG_GIAO_DICH | ID | Lookup pair: Securities Company Organization Unit.Securities Company Organization Unit Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_PHONG_GIAO_DICH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến văn phòng đại diện. | SCMS | CTCK_VP_DAI_DIEN | ID | FK target: Securities Company Organization Unit.Securities Company Organization Unit Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã văn phòng đại diện. | SCMS | CTCK_VP_DAI_DIEN | ID | Lookup pair: Securities Company Organization Unit.Securities Company Organization Unit Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_VP_DAI_DIEN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố. | SCMS | CTCK_VP_DAI_DIEN | TINH_THANH_ID | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành phố. | SCMS | CTCK_VP_DAI_DIEN | TINH_THANH_ID | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện. | SCMS | CTCK_VP_DAI_DIEN | QUAN_HUYEN | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã. | SCMS | CTCK_VP_DAI_DIEN | PHUONG_XA | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | SCMS | CTCK_VP_DAI_DIEN |  | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | SCMS | CTCK_VP_DAI_DIEN |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | SCMS | CTCK_VP_DAI_DIEN | DIA_CHI | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến văn phòng đại diện. | SCMS | CTCK_VP_DAI_DIEN | ID | FK target: Securities Company Organization Unit.Securities Company Organization Unit Id. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã văn phòng đại diện. | SCMS | CTCK_VP_DAI_DIEN | ID | Lookup pair: Securities Company Organization Unit.Securities Company Organization Unit Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'SCMS' | Mã nguồn dữ liệu. | SCMS | CTCK_VP_DAI_DIEN |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
