...
### 2.{IDX}.4 Bảng hrsk_taxpayer_ases_snpst
...
### 2.{IDX}.10 Bảng tax_dbt_nfrc_ordr
...
### 2.{IDX}.11 Bảng tax_vln_pny_dcsn
...
### 2.{IDX}.12 Bảng tax_inv_nfrc_ordr
...
### 2.{IDX}.13 Bảng tax_inv_nfrc_ordr_itm
