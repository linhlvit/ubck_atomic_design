...
|---|---|---|---|
| 1 | Inspection Officer | insp_ofcr | Cán bộ thanh tra viên thuộc UBCKNN. Ghi nhận thông tin cá nhân và trạng thái công tác. |
...
| 7 | Inspection Subject Other Party | insp_sbj_othr_p | Đối tượng thanh tra khác (cá nhân hoặc tổ chức) không thuộc danh mục CK/QLQ/ĐC. Phân biệt qua party_type_code. |
| 8 | Inspection Annual Plan | insp_anul_pln | Kế hoạch thanh tra kiểm tra cấp năm được phê duyệt. Khởi đầu quy trình thanh tra trong năm. |
| 9 | Surveillance Enforcement Case | surveil_nfrc_case | Hồ sơ xử lý vi phạm từ kết quả giám sát thị trường. Ghi nhận đối tượng và trạng thái xử lý. |
...
| 11 | AML Enforcement Case | aml_nfrc_case | Hồ sơ xử lý vi phạm phòng chống rửa tiền. Ghi nhận đối tượng vi phạm và trạng thái xử lý. |
...
| 14 | Inspection Annual Plan Subject | insp_anul_pln_sbj | Đối tượng thanh tra được đưa vào kế hoạch năm. Grain: 1 đối tượng × 1 kế hoạch. |
| 15 | Inspection Annual Plan Document Attachment | insp_anul_pln_doc_attch | Văn bản đính kèm kế hoạch thanh tra năm. FK → Inspection Annual Plan. |
| 16 | Inspection Decision | insp_dcsn | Quyết định thanh tra/kiểm tra cụ thể. FK → Inspection Annual Plan (nullable — thanh tra đột xuất không có kế hoạch). |
| 17 | Complaint Processing Case | cpln_pcs_case | Hồ sơ giải quyết đơn thư khiếu nại/tố cáo. FK → Complaint Petition. |
| 18 | Surveillance Case Document Attachment | surveil_case_doc_attch | Văn bản đính kèm hồ sơ giám sát. FK → Surveillance Enforcement Case. |
| 19 | Surveillance Enforcement Decision | surveil_nfrc_dcsn | Văn bản xử lý vi phạm từ giám sát. FK → Surveillance Enforcement Case. |
| 20 | AML Case Document Attachment | aml_case_doc_attch | Văn bản đính kèm hồ sơ PCRT. FK → AML Enforcement Case. |
| 21 | AML Enforcement Decision | aml_nfrc_dcsn | Văn bản xử lý vi phạm rửa tiền. FK → AML Enforcement Case. |
| 22 | Inspection Decision Subject | insp_dcsn_sbj | Đối tượng cụ thể được thanh tra theo một quyết định. FK → Inspection Decision. |
| 23 | Inspection Decision Team Member | insp_dcsn_team_mbr | Thành viên đoàn thanh tra chỉ định theo quyết định. FK → Inspection Decision + FK → Inspection Officer. |
| 24 | Inspection Decision Document Attachment | insp_dcsn_doc_attch | Văn bản đính kèm quyết định thanh tra. FK → Inspection Decision. |
| 25 | Inspection Case | insp_case | Hồ sơ thanh tra cụ thể — tập hợp tài liệu và kết quả 1 cuộc thanh tra. FK → Inspection Decision. Thông tin đối tượng denormalized (snapshot tại thời điểm thanh tra). |
| 26 | Complaint Processing Case Document Attachment | cpln_pcs_case_doc_attch | Văn bản đính kèm hồ sơ giải quyết đơn thư. FK → Complaint Processing Case. |
| 27 | Complaint Processing Conclusion | cpln_pcs_conclusion | Kết luận giải quyết đơn thư. FK → Complaint Processing Case. |
| 28 | Complaint Enforcement Decision | cpln_nfrc_dcsn | Văn bản xử lý / quyết định xử phạt từ hồ sơ đơn thư. FK → Complaint Processing Case. |
| 29 | Surveillance Enforcement Decision File Attachment | surveil_nfrc_dcsn_file_attch | File đính kèm văn bản xử lý giám sát. FK → Surveillance Enforcement Decision. |
| 30 | Surveillance Penalty Announcement | surveil_pny_ancm | Công bố quyết định xử phạt từ giám sát. FK → Surveillance Enforcement Decision. |
| 31 | Inspection Case Officer Assignment | insp_case_ofcr_asgnm | Phân công cán bộ phụ trách hồ sơ thanh tra. FK → Inspection Case + FK → Inspection Officer. |
| 32 | Inspection Case Document Attachment | insp_case_doc_attch | Văn bản đính kèm hồ sơ thanh tra (biên bản làm việc v.v.). FK → Inspection Case. |
| 33 | Inspection Case Conclusion | insp_case_conclusion | Kết luận thanh tra kèm thông tin xử lý vi phạm. FK → Inspection Case. |
...
| 35 | Inspection Penalty Announcement | insp_pny_ancm | Công bố quyết định xử phạt từ kết luận thanh tra. FK → Inspection Case Conclusion. |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Officer Id | insp_ofcr_id | BIGINT |  | X | P |  | Khóa đại diện cho cán bộ thanh tra. | ThanhTra.DM_CAN_BO |  |  |
| 2 | Inspection Officer Code | insp_ofcr_code | STRING |  |  |  |  | Mã cán bộ thanh tra. Map từ PK bảng nguồn ThanhTra.DM_CAN_BO.ID. | ThanhTra.DM_CAN_BO | ID | BK của entity. BCV Term: Individual Identifier. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CAN_BO' | Mã hệ thống nguồn. | ThanhTra.DM_CAN_BO |  |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Officer Id | insp_ofcr_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Inspection Officer. | ThanhTra.DM_CAN_BO | ID |  |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã cán bộ thanh tra. | ThanhTra.DM_CAN_BO | ID |  |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CAN_BO' | Mã hệ thống nguồn. | ThanhTra.DM_CAN_BO |  |  |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Inspection Officer. | ThanhTra.DM_CAN_BO | ID |  |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã cán bộ thanh tra. | ThanhTra.DM_CAN_BO | ID |  |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CAN_BO' | Mã hệ thống nguồn. | ThanhTra.DM_CAN_BO |  |  |
...
|---|---|---|---|---|
| Involved Party Id | ip_id | Inspection Officer | Inspection Officer Id | insp_ofcr_id |
...
| 6 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | ThanhTra.DM_CAN_BO |  |  |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CONG_TY_DC' | Mã hệ thống nguồn. | ThanhTra.DM_CONG_TY_DC |  |  |
| 4 | Public Company Name | pblc_co_nm | STRING |  |  |  |  | Tên tiếng Việt công ty đại chúng. | ThanhTra.DM_CONG_TY_DC | TEN_TIENG_VIET |  |
| 5 | Public Company English Name | pblc_co_en_nm | STRING | X |  |  |  | Tên tiếng Anh công ty đại chúng. | ThanhTra.DM_CONG_TY_DC | TEN_TIENG_ANH |  |
...
| 12 | Business Registration Number | bsn_rgst_nbr | STRING | X |  |  |  | Mã số doanh nghiệp / số ĐKKD. | ThanhTra.DM_CONG_TY_DC |  |  |
...
| 15 | Latest Registration Province Code | latest_rgst_prov_code | STRING | X |  |  |  | Tỉnh/thành nơi cấp gần nhất (mã tỉnh từ provinces). | ThanhTra.DM_CONG_TY_DC |  |  |
| 16 | Industry Category Id | idy_cgy_id | BIGINT | X |  | F |  | Id ngành nghề (categories). | ThanhTra.DM_CONG_TY_DC |  |  |
| 17 | Industry Category Code | idy_cgy_code | STRING | X |  |  |  | Mã ngành nghề (categories). | ThanhTra.DM_CONG_TY_DC |  | Scheme: IDS_INDUSTRY_CATEGORY. Pair with Industry Category Id. Theo HLD T1-04: categories là Classification Value không phải Atomic entity. |
...
| 22 | Company Login | co_login | STRING | X |  |  |  | User của công ty niêm yết (login_name). | ThanhTra.DM_CONG_TY_DC |  |  |
...
| 26 | Equity Listing Exchange Name | eqty_listing_exg_nm | STRING | X |  |  |  | Sàn niêm yết cổ phiếu (text từ company_detail). | ThanhTra.DM_CONG_TY_DC |  |  |
| 27 | Bond Listing Exchange Name | bond_listing_exg_nm | STRING | X |  |  |  | Sàn niêm yết trái phiếu (text từ company_detail). | ThanhTra.DM_CONG_TY_DC |  |  |
...
| 30 | Equity Ticker | eqty_ticker | STRING | X |  |  |  | Mã chứng khoán cổ phiếu. | ThanhTra.DM_CONG_TY_DC |  |  |
...
| 59 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | ThanhTra.DM_CONG_TY_DC |  |  |
| 60 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | ThanhTra.DM_CONG_TY_DC |  |  |
| 61 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | ThanhTra.DM_CONG_TY_DC |  |  |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Public Company. | ThanhTra.DM_CONG_TY_DC | ID |  |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty đại chúng. | ThanhTra.DM_CONG_TY_DC | ID |  |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CONG_TY_DC' | Mã hệ thống nguồn. | ThanhTra.DM_CONG_TY_DC |  |  |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Public Company. | ThanhTra.DM_CONG_TY_DC | ID |  |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty đại chúng. | ThanhTra.DM_CONG_TY_DC | ID |  |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CONG_TY_DC' | Mã hệ thống nguồn. | ThanhTra.DM_CONG_TY_DC |  |  |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | ThanhTra.DM_CONG_TY_DC |  |  |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | ThanhTra.DM_CONG_TY_DC |  |  |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | ThanhTra.DM_CONG_TY_DC |  |  |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | ThanhTra.DM_CONG_TY_DC |  |  |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | ThanhTra.DM_CONG_TY_DC |  |  |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | ThanhTra.DM_CONG_TY_DC |  |  |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | ThanhTra.DM_CONG_TY_DC |  |  |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CONG_TY_CK' | Mã hệ thống nguồn. | ThanhTra.DM_CONG_TY_CK |  |  |
| 4 | Country of Registration Id | cty_of_rgst_id | BIGINT | X |  | F |  | FK đến quốc gia đăng ký của công ty chứng khoán. | ThanhTra.DM_CONG_TY_CK |  |  |
| 5 | Country of Registration Code | cty_of_rgst_code | STRING | X |  |  |  | Mã quốc gia đăng ký. | ThanhTra.DM_CONG_TY_CK |  |  |
| 6 | Full Name | full_nm | STRING |  |  |  |  | Tên công ty chứng khoán. | ThanhTra.DM_CONG_TY_CK |  |  |
| 7 | English Name | en_nm | STRING | X |  |  |  | Tên tiếng Anh. | ThanhTra.DM_CONG_TY_CK |  |  |
...
| 11 | Director Name | director_nm | STRING | X |  |  |  | Tên Tổng giám đốc (denormalized). | ThanhTra.DM_CONG_TY_CK |  |  |
| 12 | Depository Certificate Number | depst_ctf_nbr | STRING | X |  |  |  | Chứng nhận lưu ký. | ThanhTra.DM_CONG_TY_CK |  |  |
| 13 | Business Type Codes | bsn_tp_codes | Array<Text> | X |  |  |  | Danh sách mã nghiệp vụ kinh doanh. Từ bảng junction SECCOMBUSINES. | ThanhTra.DM_CONG_TY_CK |  |  |
| 14 | Company Type Codes | co_tp_codes | Array<Text> | X |  |  |  | Danh sách mã loại hình doanh nghiệp. Từ bảng junction SECCOMTYPE. | ThanhTra.DM_CONG_TY_CK |  |  |
| 15 | Description | dsc | STRING | X |  |  |  | Ghi chú. | ThanhTra.DM_CONG_TY_CK |  |  |
| 16 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | ThanhTra.DM_CONG_TY_CK |  |  |
...
| 19 | Securities Company Business Key | scr_co_bsn_key | STRING | X |  |  |  | ID duy nhất của CTCK dùng liên thông hệ thống (BK nghiệp vụ). | ThanhTra.DM_CONG_TY_CK |  |  |
| 20 | Securities Company Business Code | scr_co_bsn_code | STRING | X |  |  |  | Mã số CTCK (mã nghiệp vụ ngắn). | ThanhTra.DM_CONG_TY_CK |  |  |
| 21 | Securities Company Name | scr_co_nm | STRING |  |  |  |  | Tên tiếng Việt công ty chứng khoán. | ThanhTra.DM_CONG_TY_CK | TEN_TIENG_VIET |  |
| 22 | Securities Company English Name | scr_co_en_nm | STRING | X |  |  |  | Tên tiếng Anh công ty chứng khoán. | ThanhTra.DM_CONG_TY_CK | TEN_TIENG_ANH |  |
...
| 24 | Tax Code | tax_code | STRING | X |  |  |  | Mã số thuế. | ThanhTra.DM_CONG_TY_CK |  |  |
...
| 27 | Business Sector Codes | bsn_sctr_codes | Array<Text> | X |  |  |  | Danh sách mã ngành nghề kinh doanh. | ThanhTra.DM_CONG_TY_CK |  |  |
| 28 | Is Listed Indicator | is_list_ind | STRING | X |  |  |  | Cờ niêm yết: 1-Có niêm yết; 0-Không. | ThanhTra.DM_CONG_TY_CK |  |  |
| 29 | Stock Exchange Name | stk_exg_nm | STRING | X |  |  |  | Sàn niêm yết. | ThanhTra.DM_CONG_TY_CK |  |  |
...
| 37 | Business Activity Category Id | bsn_avy_cgy_id | BIGINT | X |  | F |  | FK đến ngành nghề kinh doanh (DM_NGANH_NGHE_KD). Nullable. | ThanhTra.DM_CONG_TY_CK |  |  |
| 38 | Business Activity Category Code | bsn_avy_cgy_code | STRING | X |  |  |  | Mã ngành nghề kinh doanh. | ThanhTra.DM_CONG_TY_CK |  |  |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Securities Company. | ThanhTra.DM_CONG_TY_CK | ID |  |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty chứng khoán. | ThanhTra.DM_CONG_TY_CK | ID |  |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CONG_TY_CK' | Mã hệ thống nguồn. | ThanhTra.DM_CONG_TY_CK |  |  |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Securities Company. | ThanhTra.DM_CONG_TY_CK | ID |  |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty chứng khoán. | ThanhTra.DM_CONG_TY_CK | ID |  |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CONG_TY_CK' | Mã hệ thống nguồn. | ThanhTra.DM_CONG_TY_CK |  |  |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | ThanhTra.DM_CONG_TY_CK |  |  |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | ThanhTra.DM_CONG_TY_CK |  |  |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | ThanhTra.DM_CONG_TY_CK |  |  |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | ThanhTra.DM_CONG_TY_CK |  |  |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | ThanhTra.DM_CONG_TY_CK |  |  |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | ThanhTra.DM_CONG_TY_CK |  |  |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | ThanhTra.DM_CONG_TY_CK |  |  |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CONG_TY_QLQ' | Mã hệ thống nguồn. | ThanhTra.DM_CONG_TY_QLQ |  |  |
...
| 6 | Fund Management Company English Name | fnd_mgt_co_en_nm | STRING | X |  |  |  | Tên tiếng Anh công ty quản lý quỹ. | ThanhTra.DM_CONG_TY_QLQ | TEN_TIENG_ANH |  |
...
| 10 | License Decision Number | license_dcsn_nbr | STRING | X |  |  |  | Số quyết định/giấy phép thành lập. | ThanhTra.DM_CONG_TY_QLQ |  |  |
| 11 | License Decision Date | license_dcsn_dt | DATE | X |  |  |  | Ngày cấp phép. | ThanhTra.DM_CONG_TY_QLQ |  |  |
...
| 14 | Business Type Codes | bsn_tp_codes | Array<Text> | X |  |  |  | Danh sách mã nghiệp vụ kinh doanh. Từ bảng junction FUNDCOMBUSINES. | ThanhTra.DM_CONG_TY_QLQ |  |  |
| 15 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | ThanhTra.DM_CONG_TY_QLQ |  |  |
...
| 18 | Country of Registration Id | cty_of_rgst_id | BIGINT | X |  | F |  | FK đến quốc gia đăng ký của công ty QLQ. | ThanhTra.DM_CONG_TY_QLQ |  |  |
| 19 | Country of Registration Code | cty_of_rgst_code | STRING | X |  |  |  | Mã quốc gia đăng ký. | ThanhTra.DM_CONG_TY_QLQ |  |  |
...
| 21 | Director Name | director_nm | STRING | X |  |  |  | Tên Tổng giám đốc (denormalized). | ThanhTra.DM_CONG_TY_QLQ |  |  |
| 22 | Depository Certificate Number | depst_ctf_nbr | STRING | X |  |  |  | Chứng nhận lưu ký — thông tin bổ sung của FIMS không có trong FMS.SECURITIES. | ThanhTra.DM_CONG_TY_QLQ |  |  |
| 23 | Company Type Codes | co_tp_codes | Array<Text> | X |  |  |  | Danh sách mã loại hình doanh nghiệp. Từ bảng junction FUNDCOMTYPE. | ThanhTra.DM_CONG_TY_QLQ |  |  |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Fund Management Company. | ThanhTra.DM_CONG_TY_QLQ | ID |  |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty quản lý quỹ. | ThanhTra.DM_CONG_TY_QLQ | ID |  |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CONG_TY_QLQ' | Mã hệ thống nguồn. | ThanhTra.DM_CONG_TY_QLQ |  |  |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Fund Management Company. | ThanhTra.DM_CONG_TY_QLQ | ID |  |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty quản lý quỹ. | ThanhTra.DM_CONG_TY_QLQ | ID |  |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_CONG_TY_QLQ' | Mã hệ thống nguồn. | ThanhTra.DM_CONG_TY_QLQ |  |  |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | ThanhTra.DM_CONG_TY_QLQ |  |  |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | ThanhTra.DM_CONG_TY_QLQ |  |  |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | ThanhTra.DM_CONG_TY_QLQ |  |  |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | ThanhTra.DM_CONG_TY_QLQ |  |  |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | ThanhTra.DM_CONG_TY_QLQ |  |  |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | ThanhTra.DM_CONG_TY_QLQ |  |  |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | ThanhTra.DM_CONG_TY_QLQ |  |  |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Subject Other Party Id | insp_sbj_othr_p_id | BIGINT |  | X | P |  | Khóa đại diện cho đối tượng thanh tra khác. | ThanhTra.DM_DOI_TUONG_KHAC |  |  |
| 2 | Inspection Subject Other Party Code | insp_sbj_othr_p_code | STRING |  |  |  |  | Mã đối tượng. Map từ PK ThanhTra.DM_DOI_TUONG_KHAC.ID. | ThanhTra.DM_DOI_TUONG_KHAC | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_DOI_TUONG_KHAC' | Mã hệ thống nguồn. | ThanhTra.DM_DOI_TUONG_KHAC |  |  |
...
| 7 | Representative Name | rprs_nm | STRING | X |  |  |  | Người đại diện (cho tổ chức). | ThanhTra.DM_DOI_TUONG_KHAC | NGUOI_DAI_DIEN |  |
...
| 9 | Country of Registration Id | cty_of_rgst_id | BIGINT | X |  | F |  | FK đến Geographic Area — quốc gia đăng ký. | ThanhTra.DM_DOI_TUONG_KHAC | QUOC_GIA_ID |  |
| 10 | Country of Registration Code | cty_of_rgst_code | STRING | X |  |  |  | Mã quốc gia đăng ký. | ThanhTra.DM_DOI_TUONG_KHAC | QUOC_GIA_ID |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Subject Other Party Id | insp_sbj_othr_p_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Inspection Subject Other Party. | ThanhTra.DM_DOI_TUONG_KHAC | ID |  |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã đối tượng thanh tra. | ThanhTra.DM_DOI_TUONG_KHAC | ID |  |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_DOI_TUONG_KHAC' | Mã hệ thống nguồn. | ThanhTra.DM_DOI_TUONG_KHAC |  |  |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Inspection Subject Other Party. | ThanhTra.DM_DOI_TUONG_KHAC | ID |  |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã đối tượng thanh tra. | ThanhTra.DM_DOI_TUONG_KHAC | ID |  |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_DOI_TUONG_KHAC' | Mã hệ thống nguồn. | ThanhTra.DM_DOI_TUONG_KHAC |  |  |
...
| 11 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Inspection Subject Other Party. | ThanhTra.DM_DOI_TUONG_KHAC | ID |  |
| 12 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã đối tượng thanh tra. | ThanhTra.DM_DOI_TUONG_KHAC | ID |  |
| 13 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DM_DOI_TUONG_KHAC' | Mã hệ thống nguồn. | ThanhTra.DM_DOI_TUONG_KHAC |  |  |
...
| Tên trường | Tên cột | Bảng tham chiếu | Trường tham chiếu | Cột tham chiếu |
|---|---|---|---|---|
| Involved Party Id | ip_id | Inspection Subject Other Party | Inspection Subject Other Party Id | insp_sbj_othr_p_id |
...
| 6 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | ThanhTra.DM_DOI_TUONG_KHAC |  |  |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Annual Plan Id | insp_anul_pln_id | BIGINT |  | X | P |  | Khóa đại diện cho kế hoạch thanh tra hàng năm. | ThanhTra.TT_KE_HOACH |  |  |
| 2 | Inspection Annual Plan Code | insp_anul_pln_code | STRING |  |  |  |  | Mã kế hoạch. Map từ PK ThanhTra.TT_KE_HOACH.ID. | ThanhTra.TT_KE_HOACH | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_KE_HOACH' | Mã hệ thống nguồn. | ThanhTra.TT_KE_HOACH |  |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Annual Plan Id | insp_anul_pln_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Surveillance Enforcement Case Id | surveil_nfrc_case_id | BIGINT |  | X | P |  | Khóa đại diện cho hồ sơ xử lý vi phạm từ giám sát. | ThanhTra.GS_HO_SO |  |  |
| 2 | Surveillance Enforcement Case Code | surveil_nfrc_case_code | STRING |  |  |  |  | Mã hồ sơ. Map từ PK ThanhTra.GS_HO_SO.ID. | ThanhTra.GS_HO_SO | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.GS_HO_SO' | Mã hệ thống nguồn. | ThanhTra.GS_HO_SO |  |  |
...
| 15 | Responsible Officer Id | rspl_ofcr_id | BIGINT | X |  | F |  | FK đến Inspection Officer — lãnh đạo phụ trách. | ThanhTra.GS_HO_SO | LANH_DAO_PHU_TRACH |  |
| 16 | Responsible Officer Code | rspl_ofcr_code | STRING | X |  |  |  | Mã cán bộ lãnh đạo phụ trách. | ThanhTra.GS_HO_SO | LANH_DAO_PHU_TRACH |  |
| 17 | Processing Officer Id | pcs_ofcr_id | BIGINT | X |  | F |  | FK đến Inspection Officer — chuyên viên xử lý. | ThanhTra.GS_HO_SO | CHUYEN_VIEN_XU_LY |  |
| 18 | Processing Officer Code | pcs_ofcr_code | STRING | X |  |  |  | Mã cán bộ chuyên viên xử lý. | ThanhTra.GS_HO_SO | CHUYEN_VIEN_XU_LY |  |
...
| Tên trường | Tên cột |
|---|---|
| Surveillance Enforcement Case Id | surveil_nfrc_case_id |
...
| Tên trường | Tên cột | Bảng tham chiếu | Trường tham chiếu | Cột tham chiếu |
|---|---|---|---|---|
| Responsible Officer Id | rspl_ofcr_id | Inspection Officer | Inspection Officer Id | insp_ofcr_id |
| Processing Officer Id | pcs_ofcr_id | Inspection Officer | Inspection Officer Id | insp_ofcr_id |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DT_DON_THU' | Mã hệ thống nguồn. | ThanhTra.DT_DON_THU |  |  |
...
| 18 | Submission Date | subm_dt | DATE |  |  |  |  | Ngày tiếp nhận đơn. | ThanhTra.DT_DON_THU | NGAY_TIEP_NHAN |  |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | AML Enforcement Case Id | aml_nfrc_case_id | BIGINT |  | X | P |  | Khóa đại diện cho hồ sơ phòng chống rửa tiền. | ThanhTra.PCRT_HO_SO |  |  |
| 2 | AML Enforcement Case Code | aml_nfrc_case_code | STRING |  |  |  |  | Mã hồ sơ. Map từ PK ThanhTra.PCRT_HO_SO.ID. | ThanhTra.PCRT_HO_SO | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.PCRT_HO_SO' | Mã hệ thống nguồn. | ThanhTra.PCRT_HO_SO |  |  |
...
| 13 | Responsible Officer Id | rspl_ofcr_id | BIGINT | X |  | F |  | FK đến Inspection Officer — lãnh đạo phụ trách. | ThanhTra.PCRT_HO_SO | LANH_DAO_PHU_TRACH |  |
| 14 | Responsible Officer Code | rspl_ofcr_code | STRING | X |  |  |  | Mã cán bộ lãnh đạo phụ trách. | ThanhTra.PCRT_HO_SO | LANH_DAO_PHU_TRACH |  |
| 15 | Processing Officer Id | pcs_ofcr_id | BIGINT | X |  | F |  | FK đến Inspection Officer — chuyên viên xử lý. | ThanhTra.PCRT_HO_SO | CHUYEN_VIEN_XU_LY |  |
| 16 | Processing Officer Code | pcs_ofcr_code | STRING | X |  |  |  | Mã cán bộ chuyên viên xử lý. | ThanhTra.PCRT_HO_SO | CHUYEN_VIEN_XU_LY |  |
...
| Tên trường | Tên cột |
|---|---|
| AML Enforcement Case Id | aml_nfrc_case_id |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.PCTN_BAO_CAO' | Mã hệ thống nguồn. | ThanhTra.PCTN_BAO_CAO |  |  |
...
| 3 | Source Record Id | src_rcrd_id | STRING |  |  |  |  | Khóa chính nội bộ từ bảng nguồn ThanhTra.PCRT_BAO_CAO.ID. | ThanhTra.PCRT_BAO_CAO | ID |  |
| 4 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.PCRT_BAO_CAO' | Mã hệ thống nguồn. | ThanhTra.PCRT_BAO_CAO |  |  |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Annual Plan Subject Id | insp_anul_pln_sbj_id | BIGINT |  | X | P |  | Khóa đại diện cho đối tượng trong kế hoạch thanh tra. | ThanhTra.TT_KE_HOACH_DOI_TUONG |  |  |
| 2 | Inspection Annual Plan Subject Code | insp_anul_pln_sbj_code | STRING |  |  |  |  | Mã đối tượng kế hoạch. Map từ PK ThanhTra.TT_KE_HOACH_DOI_TUONG.ID. | ThanhTra.TT_KE_HOACH_DOI_TUONG | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_KE_HOACH_DOI_TUONG' | Mã hệ thống nguồn. | ThanhTra.TT_KE_HOACH_DOI_TUONG |  |  |
| 4 | Inspection Annual Plan Id | insp_anul_pln_id | BIGINT |  |  | F |  | FK đến Inspection Annual Plan. | ThanhTra.TT_KE_HOACH_DOI_TUONG | KE_HOACH_ID |  |
| 5 | Inspection Annual Plan Code | insp_anul_pln_code | STRING |  |  |  |  | Mã kế hoạch. | ThanhTra.TT_KE_HOACH_DOI_TUONG | KE_HOACH_ID |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Annual Plan Subject Id | insp_anul_pln_sbj_id |
...
| Tên trường | Tên cột | Bảng tham chiếu | Trường tham chiếu | Cột tham chiếu |
|---|---|---|---|---|
| Inspection Annual Plan Id | insp_anul_pln_id | Inspection Annual Plan | Inspection Annual Plan Id | insp_anul_pln_id |
...
- **Tên vật lý:** insp_anul_pln_doc_attch
- **Đường dẫn trên kho dữ liệu:**
- **Các trường partition:**
- **Thời gian lưu trữ:** 5 năm
- **Định dạng lưu trữ:** Iceberg
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Annual Plan Document Attachment Id | insp_anul_pln_doc_attch_id | BIGINT |  | X | P |  | Khóa đại diện cho văn bản kèm kế hoạch thanh tra. | ThanhTra.TT_KE_HOACH_VAN_BAN |  |  |
| 2 | Inspection Annual Plan Document Attachment Code | insp_anul_pln_doc_attch_code | STRING |  |  |  |  | Mã văn bản. Map từ PK ThanhTra.TT_KE_HOACH_VAN_BAN.ID. | ThanhTra.TT_KE_HOACH_VAN_BAN | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_KE_HOACH_VAN_BAN' | Mã hệ thống nguồn. | ThanhTra.TT_KE_HOACH_VAN_BAN |  |  |
| 4 | Inspection Annual Plan Id | insp_anul_pln_id | BIGINT |  |  | F |  | FK đến Inspection Annual Plan. | ThanhTra.TT_KE_HOACH_VAN_BAN | KE_HOACH_ID |  |
| 5 | Inspection Annual Plan Code | insp_anul_pln_code | STRING |  |  |  |  | Mã kế hoạch. | ThanhTra.TT_KE_HOACH_VAN_BAN | KE_HOACH_ID |  |
...
| 11 | Attachment File Name | attch_file_nm | STRING | X |  |  |  | Tên file đính kèm. | ThanhTra.TT_KE_HOACH_VAN_BAN | FILE_NAME |  |
| 12 | Attachment File URL | attch_file_url | STRING | X |  |  |  | Đường dẫn file lưu trữ. | ThanhTra.TT_KE_HOACH_VAN_BAN | FILE_PATH |  |
| 13 | Attachment File Size | attch_file_sz | INT | X |  |  |  | Kích thước file (bytes). | ThanhTra.TT_KE_HOACH_VAN_BAN | FILE_SIZE |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Annual Plan Document Attachment Id | insp_anul_pln_doc_attch_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Decision Id | insp_dcsn_id | BIGINT |  | X | P |  | Khóa đại diện cho quyết định thanh tra. | ThanhTra.TT_QUYET_DINH |  |  |
| 2 | Inspection Decision Code | insp_dcsn_code | STRING |  |  |  |  | Mã quyết định. Map từ PK ThanhTra.TT_QUYET_DINH.ID. | ThanhTra.TT_QUYET_DINH | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_QUYET_DINH' | Mã hệ thống nguồn. | ThanhTra.TT_QUYET_DINH |  |  |
| 4 | Inspection Annual Plan Id | insp_anul_pln_id | BIGINT | X |  | F |  | FK đến Inspection Annual Plan (nullable — quyết định đột xuất không có kế hoạch). | ThanhTra.TT_QUYET_DINH | KE_HOACH_ID |  |
| 5 | Inspection Annual Plan Code | insp_anul_pln_code | STRING | X |  |  |  | Mã kế hoạch. | ThanhTra.TT_QUYET_DINH | KE_HOACH_ID |  |
| 6 | Inspection Type Code | insp_tp_code | STRING |  |  |  |  | Loại hình: THANH_TRA / KIEM_TRA. | ThanhTra.TT_QUYET_DINH | LOAI_HINH | Scheme: TT_PLAN_TYPE. |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Decision Id | insp_dcsn_id |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DT_HO_SO' | Mã hệ thống nguồn. | ThanhTra.DT_HO_SO |  |  |
| 4 | Complaint Petition Id | cpln_petition_id | BIGINT |  |  | F |  | FK đến Complaint Petition — đơn thư gốc. | ThanhTra.DT_HO_SO | DON_THU_ID |  |
| 5 | Complaint Petition Code | cpln_petition_code | STRING |  |  |  |  | Mã đơn thư gốc. | ThanhTra.DT_HO_SO | DON_THU_ID |  |
...
- **Tên vật lý:** surveil_case_doc_attch
- **Đường dẫn trên kho dữ liệu:**
- **Các trường partition:**
- **Thời gian lưu trữ:** 5 năm
- **Định dạng lưu trữ:** Iceberg
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Surveillance Case Document Attachment Id | surveil_case_doc_attch_id | BIGINT |  | X | P |  | Khóa đại diện cho văn bản đính kèm hồ sơ giám sát. | ThanhTra.GS_HO_SO_VAN_BAN |  |  |
| 2 | Surveillance Case Document Attachment Code | surveil_case_doc_attch_code | STRING |  |  |  |  | Mã văn bản. Map từ PK ThanhTra.GS_HO_SO_VAN_BAN.ID. | ThanhTra.GS_HO_SO_VAN_BAN | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.GS_HO_SO_VAN_BAN' | Mã hệ thống nguồn. | ThanhTra.GS_HO_SO_VAN_BAN |  |  |
| 4 | Surveillance Enforcement Case Id | surveil_nfrc_case_id | BIGINT |  |  | F |  | FK đến Surveillance Enforcement Case. | ThanhTra.GS_HO_SO_VAN_BAN | HO_SO_ID |  |
| 5 | Surveillance Enforcement Case Code | surveil_nfrc_case_code | STRING |  |  |  |  | Mã hồ sơ giám sát. | ThanhTra.GS_HO_SO_VAN_BAN | HO_SO_ID |  |
...
| 11 | Attachment File Name | attch_file_nm | STRING | X |  |  |  | Tên file đính kèm. | ThanhTra.GS_HO_SO_VAN_BAN | FILE_NAME |  |
| 12 | Attachment File URL | attch_file_url | STRING | X |  |  |  | Đường dẫn file. | ThanhTra.GS_HO_SO_VAN_BAN | FILE_PATH |  |
| 13 | Attachment File Size | attch_file_sz | INT | X |  |  |  | Kích thước file (bytes). | ThanhTra.GS_HO_SO_VAN_BAN | FILE_SIZE |  |
...
| Tên trường | Tên cột |
|---|---|
| Surveillance Case Document Attachment Id | surveil_case_doc_attch_id |
...
| Tên trường | Tên cột | Bảng tham chiếu | Trường tham chiếu | Cột tham chiếu |
|---|---|---|---|---|
| Surveillance Enforcement Case Id | surveil_nfrc_case_id | Surveillance Enforcement Case | Surveillance Enforcement Case Id | surveil_nfrc_case_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Surveillance Enforcement Decision Id | surveil_nfrc_dcsn_id | BIGINT |  | X | P |  | Khóa đại diện cho quyết định xử phạt từ giám sát. | ThanhTra.GS_VAN_BAN_XU_LY |  |  |
| 2 | Surveillance Enforcement Decision Code | surveil_nfrc_dcsn_code | STRING |  |  |  |  | Mã quyết định. Map từ PK ThanhTra.GS_VAN_BAN_XU_LY.ID. | ThanhTra.GS_VAN_BAN_XU_LY | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.GS_VAN_BAN_XU_LY' | Mã hệ thống nguồn. | ThanhTra.GS_VAN_BAN_XU_LY |  |  |
| 4 | Surveillance Enforcement Case Id | surveil_nfrc_case_id | BIGINT |  |  | F |  | FK đến Surveillance Enforcement Case. | ThanhTra.GS_VAN_BAN_XU_LY | HO_SO_ID |  |
| 5 | Surveillance Enforcement Case Code | surveil_nfrc_case_code | STRING |  |  |  |  | Mã hồ sơ giám sát. | ThanhTra.GS_VAN_BAN_XU_LY | HO_SO_ID |  |
...
| Tên trường | Tên cột |
|---|---|
| Surveillance Enforcement Decision Id | surveil_nfrc_dcsn_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | AML Case Document Attachment Id | aml_case_doc_attch_id | BIGINT |  | X | P |  | Khóa đại diện cho văn bản đính kèm hồ sơ PCRT. | ThanhTra.PCRT_HO_SO_VAN_BAN |  |  |
| 2 | AML Case Document Attachment Code | aml_case_doc_attch_code | STRING |  |  |  |  | Mã văn bản. Map từ PK ThanhTra.PCRT_HO_SO_VAN_BAN.ID. | ThanhTra.PCRT_HO_SO_VAN_BAN | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.PCRT_HO_SO_VAN_BAN' | Mã hệ thống nguồn. | ThanhTra.PCRT_HO_SO_VAN_BAN |  |  |
| 4 | AML Enforcement Case Id | aml_nfrc_case_id | BIGINT |  |  | F |  | FK đến AML Enforcement Case. | ThanhTra.PCRT_HO_SO_VAN_BAN | HO_SO_ID |  |
| 5 | AML Enforcement Case Code | aml_nfrc_case_code | STRING |  |  |  |  | Mã hồ sơ PCRT. | ThanhTra.PCRT_HO_SO_VAN_BAN | HO_SO_ID |  |
...
| 10 | Attachment File Name | attch_file_nm | STRING | X |  |  |  | Tên file đính kèm. | ThanhTra.PCRT_HO_SO_VAN_BAN | FILE_NAME |  |
| 11 | Attachment File URL | attch_file_url | STRING | X |  |  |  | Đường dẫn file. | ThanhTra.PCRT_HO_SO_VAN_BAN | FILE_PATH |  |
| 12 | Attachment File Size | attch_file_sz | INT | X |  |  |  | Kích thước file (bytes). | ThanhTra.PCRT_HO_SO_VAN_BAN | FILE_SIZE |  |
...
| Tên trường | Tên cột |
|---|---|
| AML Case Document Attachment Id | aml_case_doc_attch_id |
...
| Tên trường | Tên cột | Bảng tham chiếu | Trường tham chiếu | Cột tham chiếu |
|---|---|---|---|---|
| AML Enforcement Case Id | aml_nfrc_case_id | AML Enforcement Case | AML Enforcement Case Id | aml_nfrc_case_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | AML Enforcement Decision Id | aml_nfrc_dcsn_id | BIGINT |  | X | P |  | Khóa đại diện cho quyết định xử phạt PCRT. | ThanhTra.PCRT_VAN_BAN_XU_LY |  |  |
| 2 | AML Enforcement Decision Code | aml_nfrc_dcsn_code | STRING |  |  |  |  | Mã quyết định. Map từ PK ThanhTra.PCRT_VAN_BAN_XU_LY.ID. | ThanhTra.PCRT_VAN_BAN_XU_LY | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.PCRT_VAN_BAN_XU_LY' | Mã hệ thống nguồn. | ThanhTra.PCRT_VAN_BAN_XU_LY |  |  |
| 4 | AML Enforcement Case Id | aml_nfrc_case_id | BIGINT |  |  | F |  | FK đến AML Enforcement Case. | ThanhTra.PCRT_VAN_BAN_XU_LY | HO_SO_ID |  |
| 5 | AML Enforcement Case Code | aml_nfrc_case_code | STRING |  |  |  |  | Mã hồ sơ PCRT. | ThanhTra.PCRT_VAN_BAN_XU_LY | HO_SO_ID |  |
...
| Tên trường | Tên cột |
|---|---|
| AML Enforcement Decision Id | aml_nfrc_dcsn_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Decision Subject Id | insp_dcsn_sbj_id | BIGINT |  | X | P |  | Khóa đại diện cho đối tượng trong quyết định thanh tra. | ThanhTra.TT_QUYET_DINH_DOI_TUONG |  |  |
| 2 | Inspection Decision Subject Code | insp_dcsn_sbj_code | STRING |  |  |  |  | Mã đối tượng quyết định. Map từ PK ThanhTra.TT_QUYET_DINH_DOI_TUONG.ID. | ThanhTra.TT_QUYET_DINH_DOI_TUONG | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_QUYET_DINH_DOI_TUONG' | Mã hệ thống nguồn. | ThanhTra.TT_QUYET_DINH_DOI_TUONG |  |  |
| 4 | Inspection Decision Id | insp_dcsn_id | BIGINT |  |  | F |  | FK đến Inspection Decision. | ThanhTra.TT_QUYET_DINH_DOI_TUONG | QUYET_DINH_ID |  |
| 5 | Inspection Decision Code | insp_dcsn_code | STRING |  |  |  |  | Mã quyết định. | ThanhTra.TT_QUYET_DINH_DOI_TUONG | QUYET_DINH_ID |  |
...
| 9 | Subject Reference Id | sbj_refr_id | STRING | X |  | F |  | Tham chiếu đến bảng DM_ tương ứng (polymorphic — giá trị có thể trỏ đến DM_CONG_TY_CK/QLQ/DC/DM_DOI_TUONG_KHAC). | ThanhTra.TT_QUYET_DINH_DOI_TUONG | DOI_TUONG_REF_ID |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Decision Subject Id | insp_dcsn_sbj_id |
...
| Tên trường | Tên cột | Bảng tham chiếu | Trường tham chiếu | Cột tham chiếu |
|---|---|---|---|---|
| Inspection Decision Id | insp_dcsn_id | Inspection Decision | Inspection Decision Id | insp_dcsn_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Decision Team Member Id | insp_dcsn_team_mbr_id | BIGINT |  | X | P |  | Khóa đại diện cho thành viên đoàn thanh tra trong quyết định. | ThanhTra.TT_QUYET_DINH_THANH_PHAN |  |  |
| 2 | Inspection Decision Team Member Code | insp_dcsn_team_mbr_code | STRING |  |  |  |  | Mã thành viên. Map từ PK ThanhTra.TT_QUYET_DINH_THANH_PHAN.ID. | ThanhTra.TT_QUYET_DINH_THANH_PHAN | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_QUYET_DINH_THANH_PHAN' | Mã hệ thống nguồn. | ThanhTra.TT_QUYET_DINH_THANH_PHAN |  |  |
| 4 | Inspection Decision Id | insp_dcsn_id | BIGINT |  |  | F |  | FK đến Inspection Decision. | ThanhTra.TT_QUYET_DINH_THANH_PHAN | QUYET_DINH_ID |  |
| 5 | Inspection Decision Code | insp_dcsn_code | STRING |  |  |  |  | Mã quyết định. | ThanhTra.TT_QUYET_DINH_THANH_PHAN | QUYET_DINH_ID |  |
| 6 | Inspection Officer Id | insp_ofcr_id | BIGINT |  |  | F |  | FK đến Inspection Officer — cán bộ trong đoàn. | ThanhTra.TT_QUYET_DINH_THANH_PHAN | CAN_BO_ID |  |
| 7 | Inspection Officer Code | insp_ofcr_code | STRING |  |  |  |  | Mã cán bộ. | ThanhTra.TT_QUYET_DINH_THANH_PHAN | CAN_BO_ID |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Decision Team Member Id | insp_dcsn_team_mbr_id |
...
|---|---|---|---|---|
| Inspection Decision Id | insp_dcsn_id | Inspection Decision | Inspection Decision Id | insp_dcsn_id |
| Inspection Officer Id | insp_ofcr_id | Inspection Officer | Inspection Officer Id | insp_ofcr_id |
...
- **Tên vật lý:** insp_dcsn_doc_attch
- **Đường dẫn trên kho dữ liệu:**
- **Các trường partition:**
- **Thời gian lưu trữ:** 5 năm
- **Định dạng lưu trữ:** Iceberg
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Decision Document Attachment Id | insp_dcsn_doc_attch_id | BIGINT |  | X | P |  | Khóa đại diện cho văn bản kèm quyết định thanh tra. | ThanhTra.TT_QUYET_DINH_VAN_BAN |  |  |
| 2 | Inspection Decision Document Attachment Code | insp_dcsn_doc_attch_code | STRING |  |  |  |  | Mã văn bản. Map từ PK ThanhTra.TT_QUYET_DINH_VAN_BAN.ID. | ThanhTra.TT_QUYET_DINH_VAN_BAN | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_QUYET_DINH_VAN_BAN' | Mã hệ thống nguồn. | ThanhTra.TT_QUYET_DINH_VAN_BAN |  |  |
| 4 | Inspection Decision Id | insp_dcsn_id | BIGINT |  |  | F |  | FK đến Inspection Decision. | ThanhTra.TT_QUYET_DINH_VAN_BAN | QUYET_DINH_ID |  |
| 5 | Inspection Decision Code | insp_dcsn_code | STRING |  |  |  |  | Mã quyết định. | ThanhTra.TT_QUYET_DINH_VAN_BAN | QUYET_DINH_ID |  |
...
| 11 | Attachment File Name | attch_file_nm | STRING | X |  |  |  | Tên file đính kèm. | ThanhTra.TT_QUYET_DINH_VAN_BAN | FILE_NAME |  |
| 12 | Attachment File URL | attch_file_url | STRING | X |  |  |  | Đường dẫn file. | ThanhTra.TT_QUYET_DINH_VAN_BAN | FILE_PATH |  |
| 13 | Attachment File Size | attch_file_sz | INT | X |  |  |  | Kích thước file (bytes). | ThanhTra.TT_QUYET_DINH_VAN_BAN | FILE_SIZE |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Decision Document Attachment Id | insp_dcsn_doc_attch_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Case Id | insp_case_id | BIGINT |  | X | P |  | Khóa đại diện cho hồ sơ thanh tra. | ThanhTra.TT_HO_SO |  |  |
| 2 | Inspection Case Code | insp_case_code | STRING |  |  |  |  | Mã hồ sơ. Map từ PK ThanhTra.TT_HO_SO.ID. | ThanhTra.TT_HO_SO | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_HO_SO' | Mã hệ thống nguồn. | ThanhTra.TT_HO_SO |  |  |
| 4 | Inspection Decision Id | insp_dcsn_id | BIGINT |  |  | F |  | FK đến Inspection Decision. | ThanhTra.TT_HO_SO | QUYET_DINH_ID |  |
| 5 | Inspection Decision Code | insp_dcsn_code | STRING |  |  |  |  | Mã quyết định. | ThanhTra.TT_HO_SO | QUYET_DINH_ID |  |
| 6 | Inspection Type Code | insp_tp_code | STRING |  |  |  |  | Loại hình: THANH_TRA / KIEM_TRA. | ThanhTra.TT_HO_SO | LOAI_HINH | Scheme: TT_PLAN_TYPE. |
...
| 18 | Subject Nationality | sbj_nat | STRING | X |  |  |  | Quốc tịch đối tượng (snapshot — text tự do). | ThanhTra.TT_HO_SO | QUOC_TICH |  |
...
| 27 | Subject Representative Name | sbj_rprs_nm | STRING | X |  |  |  | Người đại diện tổ chức (snapshot). | ThanhTra.TT_HO_SO | NGUOI_DAI_DIEN |  |
...
| 33 | Responsible Officer Id | rspl_ofcr_id | BIGINT | X |  | F |  | FK đến Inspection Officer — lãnh đạo phụ trách. | ThanhTra.TT_HO_SO | LANH_DAO_PHU_TRACH |  |
| 34 | Responsible Officer Code | rspl_ofcr_code | STRING | X |  |  |  | Mã cán bộ lãnh đạo phụ trách. | ThanhTra.TT_HO_SO | LANH_DAO_PHU_TRACH |  |
| 35 | Processing Officer Id | pcs_ofcr_id | BIGINT | X |  | F |  | FK đến Inspection Officer — chuyên viên xử lý. | ThanhTra.TT_HO_SO | CHUYEN_VIEN_XU_LY |  |
| 36 | Processing Officer Code | pcs_ofcr_code | STRING | X |  |  |  | Mã cán bộ chuyên viên xử lý. | ThanhTra.TT_HO_SO | CHUYEN_VIEN_XU_LY |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Case Id | insp_case_id |
...
- **Tên vật lý:** cpln_pcs_case_doc_attch
- **Đường dẫn trên kho dữ liệu:**
- **Các trường partition:**
- **Thời gian lưu trữ:** 5 năm
- **Định dạng lưu trữ:** Iceberg
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Complaint Processing Case Document Attachment Id | cpln_pcs_case_doc_attch_id | BIGINT |  | X | P |  | Khóa đại diện cho văn bản đính kèm hồ sơ đơn thư. | ThanhTra.DT_HO_SO_VAN_BAN |  |  |
| 2 | Complaint Processing Case Document Attachment Code | cpln_pcs_case_doc_attch_code | STRING |  |  |  |  | Mã văn bản. Map từ PK ThanhTra.DT_HO_SO_VAN_BAN.ID. | ThanhTra.DT_HO_SO_VAN_BAN | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DT_HO_SO_VAN_BAN' | Mã hệ thống nguồn. | ThanhTra.DT_HO_SO_VAN_BAN |  |  |
| 4 | Complaint Processing Case Id | cpln_pcs_case_id | BIGINT |  |  | F |  | FK đến Complaint Processing Case. | ThanhTra.DT_HO_SO_VAN_BAN | HO_SO_ID |  |
| 5 | Complaint Processing Case Code | cpln_pcs_case_code | STRING |  |  |  |  | Mã hồ sơ đơn thư. | ThanhTra.DT_HO_SO_VAN_BAN | HO_SO_ID |  |
...
| 11 | Attachment File Name | attch_file_nm | STRING | X |  |  |  | Tên file đính kèm. | ThanhTra.DT_HO_SO_VAN_BAN | FILE_NAME |  |
| 12 | Attachment File URL | attch_file_url | STRING | X |  |  |  | Đường dẫn file. | ThanhTra.DT_HO_SO_VAN_BAN | FILE_PATH |  |
| 13 | Attachment File Size | attch_file_sz | INT | X |  |  |  | Kích thước file (bytes). | ThanhTra.DT_HO_SO_VAN_BAN | FILE_SIZE |  |
...
| Tên trường | Tên cột |
|---|---|
| Complaint Processing Case Document Attachment Id | cpln_pcs_case_doc_attch_id |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DT_KET_LUAN' | Mã hệ thống nguồn. | ThanhTra.DT_KET_LUAN |  |  |
| 4 | Complaint Processing Case Id | cpln_pcs_case_id | BIGINT |  |  | F |  | FK đến Complaint Processing Case. | ThanhTra.DT_KET_LUAN | HO_SO_ID |  |
| 5 | Complaint Processing Case Code | cpln_pcs_case_code | STRING |  |  |  |  | Mã hồ sơ đơn thư. | ThanhTra.DT_KET_LUAN | HO_SO_ID |  |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Complaint Enforcement Decision Id | cpln_nfrc_dcsn_id | BIGINT |  | X | P |  | Khóa đại diện cho quyết định xử phạt từ hồ sơ đơn thư. | ThanhTra.DT_VAN_BAN_XU_LY |  |  |
| 2 | Complaint Enforcement Decision Code | cpln_nfrc_dcsn_code | STRING |  |  |  |  | Mã quyết định xử phạt. Map từ PK ThanhTra.DT_VAN_BAN_XU_LY.ID. | ThanhTra.DT_VAN_BAN_XU_LY | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DT_VAN_BAN_XU_LY' | Mã hệ thống nguồn. | ThanhTra.DT_VAN_BAN_XU_LY |  |  |
| 4 | Complaint Processing Case Id | cpln_pcs_case_id | BIGINT |  |  | F |  | FK đến Complaint Processing Case (OQ-5: DT_VAN_BAN_XU_LY FK → DT_HO_SO). | ThanhTra.DT_VAN_BAN_XU_LY | HO_SO_ID |  |
| 5 | Complaint Processing Case Code | cpln_pcs_case_code | STRING |  |  |  |  | Mã hồ sơ đơn thư. | ThanhTra.DT_VAN_BAN_XU_LY | HO_SO_ID |  |
...
| Tên trường | Tên cột |
|---|---|
| Complaint Enforcement Decision Id | cpln_nfrc_dcsn_id |
...
- **Tên vật lý:** surveil_nfrc_dcsn_file_attch
- **Đường dẫn trên kho dữ liệu:**
- **Các trường partition:**
- **Thời gian lưu trữ:** 5 năm
- **Định dạng lưu trữ:** Iceberg
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Surveillance Enforcement Decision File Attachment Id | surveil_nfrc_dcsn_file_attch_id | BIGINT |  | X | P |  | Khóa đại diện cho file đính kèm quyết định xử phạt giám sát. | ThanhTra.GS_VAN_BAN_XU_LY_FILE |  |  |
| 2 | Surveillance Enforcement Decision File Attachment Code | surveil_nfrc_dcsn_file_attch_code | STRING |  |  |  |  | Mã file. Map từ PK ThanhTra.GS_VAN_BAN_XU_LY_FILE.ID. | ThanhTra.GS_VAN_BAN_XU_LY_FILE | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.GS_VAN_BAN_XU_LY_FILE' | Mã hệ thống nguồn. | ThanhTra.GS_VAN_BAN_XU_LY_FILE |  |  |
| 4 | Surveillance Enforcement Decision Id | surveil_nfrc_dcsn_id | BIGINT |  |  | F |  | FK đến Surveillance Enforcement Decision. | ThanhTra.GS_VAN_BAN_XU_LY_FILE | VAN_BAN_XU_LY_ID |  |
| 5 | Surveillance Enforcement Decision Code | surveil_nfrc_dcsn_code | STRING |  |  |  |  | Mã quyết định xử phạt. | ThanhTra.GS_VAN_BAN_XU_LY_FILE | VAN_BAN_XU_LY_ID |  |
...
| 10 | Attachment File Name | attch_file_nm | STRING | X |  |  |  | Tên file đính kèm. | ThanhTra.GS_VAN_BAN_XU_LY_FILE | FILE_NAME |  |
| 11 | Attachment File URL | attch_file_url | STRING | X |  |  |  | Đường dẫn file. | ThanhTra.GS_VAN_BAN_XU_LY_FILE | FILE_PATH |  |
...
| Tên trường | Tên cột |
|---|---|
| Surveillance Enforcement Decision File Attachment Id | surveil_nfrc_dcsn_file_attch_id |
...
| Tên trường | Tên cột | Bảng tham chiếu | Trường tham chiếu | Cột tham chiếu |
|---|---|---|---|---|
| Surveillance Enforcement Decision Id | surveil_nfrc_dcsn_id | Surveillance Enforcement Decision | Surveillance Enforcement Decision Id | surveil_nfrc_dcsn_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Surveillance Penalty Announcement Id | surveil_pny_ancm_id | BIGINT |  | X | P |  | Khóa đại diện cho thông báo công bố xử phạt từ giám sát. | ThanhTra.GS_CONG_BO_XU_PHAT |  |  |
| 2 | Surveillance Penalty Announcement Code | surveil_pny_ancm_code | STRING |  |  |  |  | Mã công bố. Map từ PK ThanhTra.GS_CONG_BO_XU_PHAT.ID. | ThanhTra.GS_CONG_BO_XU_PHAT | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.GS_CONG_BO_XU_PHAT' | Mã hệ thống nguồn. | ThanhTra.GS_CONG_BO_XU_PHAT |  |  |
| 4 | Surveillance Enforcement Case Id | surveil_nfrc_case_id | BIGINT | X |  | F |  | FK đến Surveillance Enforcement Case (via HO_SO_ID — redundant navigation FK). | ThanhTra.GS_CONG_BO_XU_PHAT | HO_SO_ID |  |
| 5 | Surveillance Enforcement Case Code | surveil_nfrc_case_code | STRING | X |  |  |  | Mã hồ sơ giám sát. | ThanhTra.GS_CONG_BO_XU_PHAT | HO_SO_ID |  |
| 6 | Surveillance Enforcement Decision Id | surveil_nfrc_dcsn_id | BIGINT |  |  | F |  | FK đến Surveillance Enforcement Decision (via QUYET_DINH_XU_PHAT_ID). | ThanhTra.GS_CONG_BO_XU_PHAT | QUYET_DINH_XU_PHAT_ID |  |
| 7 | Surveillance Enforcement Decision Code | surveil_nfrc_dcsn_code | STRING |  |  |  |  | Mã quyết định xử phạt. | ThanhTra.GS_CONG_BO_XU_PHAT | QUYET_DINH_XU_PHAT_ID |  |
...
| Tên trường | Tên cột |
|---|---|
| Surveillance Penalty Announcement Id | surveil_pny_ancm_id |
...
- **Tên vật lý:** insp_case_ofcr_asgnm
- **Đường dẫn trên kho dữ liệu:**
- **Các trường partition:**
- **Thời gian lưu trữ:** 5 năm
- **Định dạng lưu trữ:** Iceberg
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Case Officer Assignment Id | insp_case_ofcr_asgnm_id | BIGINT |  | X | P |  | Khóa đại diện cho phân công cán bộ xử lý hồ sơ thanh tra. | ThanhTra.TT_HO_SO_CAN_BO |  |  |
| 2 | Inspection Case Officer Assignment Code | insp_case_ofcr_asgnm_code | STRING |  |  |  |  | Mã phân công. Map từ PK ThanhTra.TT_HO_SO_CAN_BO.ID. | ThanhTra.TT_HO_SO_CAN_BO | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_HO_SO_CAN_BO' | Mã hệ thống nguồn. | ThanhTra.TT_HO_SO_CAN_BO |  |  |
| 4 | Inspection Case Id | insp_case_id | BIGINT |  |  | F |  | FK đến Inspection Case. | ThanhTra.TT_HO_SO_CAN_BO | HO_SO_ID |  |
| 5 | Inspection Case Code | insp_case_code | STRING |  |  |  |  | Mã hồ sơ thanh tra. | ThanhTra.TT_HO_SO_CAN_BO | HO_SO_ID |  |
| 6 | Inspection Officer Id | insp_ofcr_id | BIGINT |  |  | F |  | FK đến Inspection Officer — cán bộ được phân công. | ThanhTra.TT_HO_SO_CAN_BO | CAN_BO_ID |  |
| 7 | Inspection Officer Code | insp_ofcr_code | STRING |  |  |  |  | Mã cán bộ. | ThanhTra.TT_HO_SO_CAN_BO | CAN_BO_ID |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Case Officer Assignment Id | insp_case_ofcr_asgnm_id |
...
| Tên trường | Tên cột | Bảng tham chiếu | Trường tham chiếu | Cột tham chiếu |
|---|---|---|---|---|
| Inspection Case Id | insp_case_id | Inspection Case | Inspection Case Id | insp_case_id |
| Inspection Officer Id | insp_ofcr_id | Inspection Officer | Inspection Officer Id | insp_ofcr_id |
...
- **Tên vật lý:** insp_case_doc_attch
- **Đường dẫn trên kho dữ liệu:**
- **Các trường partition:**
- **Thời gian lưu trữ:** 5 năm
- **Định dạng lưu trữ:** Iceberg
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Case Document Attachment Id | insp_case_doc_attch_id | BIGINT |  | X | P |  | Khóa đại diện cho văn bản đính kèm hồ sơ thanh tra. | ThanhTra.TT_HO_SO_VAN_BAN |  |  |
| 2 | Inspection Case Document Attachment Code | insp_case_doc_attch_code | STRING |  |  |  |  | Mã văn bản. Map từ PK ThanhTra.TT_HO_SO_VAN_BAN.ID. | ThanhTra.TT_HO_SO_VAN_BAN | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_HO_SO_VAN_BAN' | Mã hệ thống nguồn. | ThanhTra.TT_HO_SO_VAN_BAN |  |  |
| 4 | Inspection Case Id | insp_case_id | BIGINT |  |  | F |  | FK đến Inspection Case. | ThanhTra.TT_HO_SO_VAN_BAN | HO_SO_ID |  |
| 5 | Inspection Case Code | insp_case_code | STRING |  |  |  |  | Mã hồ sơ thanh tra. | ThanhTra.TT_HO_SO_VAN_BAN | HO_SO_ID |  |
...
| 12 | Attachment File Name | attch_file_nm | STRING | X |  |  |  | Tên file đính kèm. | ThanhTra.TT_HO_SO_VAN_BAN | FILE_NAME |  |
| 13 | Attachment File URL | attch_file_url | STRING | X |  |  |  | Đường dẫn file. | ThanhTra.TT_HO_SO_VAN_BAN | FILE_PATH |  |
| 14 | Attachment File Size | attch_file_sz | INT | X |  |  |  | Kích thước file (bytes). | ThanhTra.TT_HO_SO_VAN_BAN | FILE_SIZE |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Case Document Attachment Id | insp_case_doc_attch_id |
...
- **Tên vật lý:** insp_case_conclusion
- **Đường dẫn trên kho dữ liệu:**
- **Các trường partition:**
- **Thời gian lưu trữ:** 5 năm
- **Định dạng lưu trữ:** Iceberg
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Case Conclusion Id | insp_case_conclusion_id | BIGINT |  | X | P |  | Khóa đại diện cho kết luận thanh tra. | ThanhTra.TT_KET_LUAN |  |  |
| 2 | Inspection Case Conclusion Code | insp_case_conclusion_code | STRING |  |  |  |  | Mã kết luận. Map từ PK ThanhTra.TT_KET_LUAN.ID. | ThanhTra.TT_KET_LUAN | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_KET_LUAN' | Mã hệ thống nguồn. | ThanhTra.TT_KET_LUAN |  |  |
| 4 | Inspection Case Id | insp_case_id | BIGINT |  |  | F |  | FK đến Inspection Case. | ThanhTra.TT_KET_LUAN | HO_SO_ID |  |
| 5 | Inspection Case Code | insp_case_code | STRING |  |  |  |  | Mã hồ sơ thanh tra. | ThanhTra.TT_KET_LUAN | HO_SO_ID |  |
...
| 18 | Attachment File Name | attch_file_nm | STRING | X |  |  |  | Tên file đính kèm kết luận. | ThanhTra.TT_KET_LUAN | FILE_NAME |  |
| 19 | Attachment File URL | attch_file_url | STRING | X |  |  |  | Đường dẫn file kết luận. | ThanhTra.TT_KET_LUAN | FILE_PATH |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Case Conclusion Id | insp_case_conclusion_id |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.DT_CONG_BO_XU_PHAT' | Mã hệ thống nguồn. | ThanhTra.DT_CONG_BO_XU_PHAT |  |  |
| 4 | Complaint Processing Case Id | cpln_pcs_case_id | BIGINT | X |  | F |  | FK đến Complaint Processing Case (via HO_SO_ID — redundant navigation FK). | ThanhTra.DT_CONG_BO_XU_PHAT | HO_SO_ID |  |
| 5 | Complaint Processing Case Code | cpln_pcs_case_code | STRING | X |  |  |  | Mã hồ sơ đơn thư. | ThanhTra.DT_CONG_BO_XU_PHAT | HO_SO_ID |  |
| 6 | Complaint Enforcement Decision Id | cpln_nfrc_dcsn_id | BIGINT |  |  | F |  | FK đến Complaint Enforcement Decision. | ThanhTra.DT_CONG_BO_XU_PHAT | QUYET_DINH_XU_PHAT_ID |  |
| 7 | Complaint Enforcement Decision Code | cpln_nfrc_dcsn_code | STRING |  |  |  |  | Mã quyết định xử phạt đơn thư. | ThanhTra.DT_CONG_BO_XU_PHAT | QUYET_DINH_XU_PHAT_ID |  |
...
|---|---|---|---|---|
| Complaint Processing Case Id | cpln_pcs_case_id | Complaint Processing Case | Complaint Processing Case Id | cpln_pcs_case_id |
| Complaint Enforcement Decision Id | cpln_nfrc_dcsn_id | Complaint Enforcement Decision | Complaint Enforcement Decision Id | cpln_nfrc_dcsn_id |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Inspection Penalty Announcement Id | insp_pny_ancm_id | BIGINT |  | X | P |  | Khóa đại diện cho công bố xử phạt từ kết luận thanh tra. | ThanhTra.TT_CONG_BO_XU_PHAT |  |  |
| 2 | Inspection Penalty Announcement Code | insp_pny_ancm_code | STRING |  |  |  |  | Mã công bố. Map từ PK ThanhTra.TT_CONG_BO_XU_PHAT.ID. | ThanhTra.TT_CONG_BO_XU_PHAT | ID | BK của entity. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'ThanhTra.TT_CONG_BO_XU_PHAT' | Mã hệ thống nguồn. | ThanhTra.TT_CONG_BO_XU_PHAT |  |  |
| 4 | Inspection Case Id | insp_case_id | BIGINT | X |  | F |  | FK đến Inspection Case (via HO_SO_ID — redundant navigation FK). | ThanhTra.TT_CONG_BO_XU_PHAT | HO_SO_ID |  |
| 5 | Inspection Case Code | insp_case_code | STRING | X |  |  |  | Mã hồ sơ thanh tra. | ThanhTra.TT_CONG_BO_XU_PHAT | HO_SO_ID |  |
| 6 | Inspection Case Conclusion Id | insp_case_conclusion_id | BIGINT |  |  | F |  | FK đến Inspection Case Conclusion. | ThanhTra.TT_CONG_BO_XU_PHAT | QUYET_DINH_XU_PHAT_ID |  |
| 7 | Inspection Case Conclusion Code | insp_case_conclusion_code | STRING |  |  |  |  | Mã kết luận thanh tra. | ThanhTra.TT_CONG_BO_XU_PHAT | QUYET_DINH_XU_PHAT_ID |  |
...
| Tên trường | Tên cột |
|---|---|
| Inspection Penalty Announcement Id | insp_pny_ancm_id |
...
|---|---|---|---|---|
| Inspection Case Id | insp_case_id | Inspection Case | Inspection Case Id | insp_case_id |
| Inspection Case Conclusion Id | insp_case_conclusion_id | Inspection Case Conclusion | Inspection Case Conclusion Id | insp_case_conclusion_id |
