...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | SECURITIES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 10 | License Decision Number | license_dcsn_nbr | STRING | X |  |  |  | Số quyết định/giấy phép thành lập. | FMS | SECURITIES | Decision | Denormalized — map vào IP Alt Identification. |
| 11 | License Decision Date | license_dcsn_dt | DATE | X |  |  |  | Ngày cấp phép. | FMS | SECURITIES | DecisionDate | Denormalized — map vào IP Alt Identification. |
...
| 14 | Business Type Codes | bsn_tp_codes | Array<Text> | X |  |  |  | Danh sách mã ngành nghề kinh doanh. | FMS | SECURITIES | BuId | Pure junction SECBUSINES → denormalize thành ARRAY. HLD decision: FMS_HLD_Tier2.md. |
| 15 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | SECURITIES | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| 18 | Country of Registration Id | cty_of_rgst_id | BIGINT | X |  | F |  | FK đến quốc gia đăng ký của công ty QLQ. | FMS | SECURITIES |  | FK target: Geographic Area.Geographic Area Id. ID quốc gia lấy từ bảng NATIONAL. |
| 19 | Country of Registration Code | cty_of_rgst_code | STRING | X |  |  |  | Mã quốc gia đăng ký. | FMS | SECURITIES |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Country of Registration Id. |
...
| 21 | Director Name | director_nm | STRING | X |  |  |  | Tên Tổng giám đốc (denormalized). | FMS | SECURITIES |  | Denormalized snapshot — không dùng để join. |
| 22 | Depository Certificate Number | depst_ctf_nbr | STRING | X |  |  |  | Chứng nhận lưu ký — thông tin bổ sung của FIMS không có trong FMS.SECURITIES. | FMS | SECURITIES |  | Denormalized — FIMS-specific field. |
| 23 | Company Type Codes | co_tp_codes | Array<Text> | X |  |  |  | Danh sách mã loại hình doanh nghiệp. Từ bảng junction FUNDCOMTYPE. | FMS | SECURITIES |  | Pure junction FUNDCOMTYPE → denormalize thành ARRAY. Scheme: FIMS_COMPANY_TYPE. HLD decision: FIMS_HLD_Tier1.md. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Fund Management Company. | FMS | SECURITIES | Id | FK target: Fund Management Company.Fund Management Company Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty QLQ. | FMS | SECURITIES | Id | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | SECURITIES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | FMS | SECURITIES |  | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | FMS | SECURITIES |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. // Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | FMS | SECURITIES |  | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | FMS | SECURITIES |  | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | SECURITIES |  | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | SECURITIES |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | FMS | SECURITIES |  | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Fund Management Company. | FMS | SECURITIES | Id | FK target: Fund Management Company.Fund Management Company Id. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty QLQ. | FMS | SECURITIES | Id | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | SECURITIES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 11 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Fund Management Company. | FMS | SECURITIES | Id | FK target: Fund Management Company.Fund Management Company Id. |
| 12 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty QLQ. | FMS | SECURITIES | Id | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Involved Party Id. |
| 13 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | SECURITIES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 16 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Fund Management Company. | FMS | SECURITIES | Id | FK target: Fund Management Company.Fund Management Company Id. |
| 17 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty QLQ. | FMS | SECURITIES | Id | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Involved Party Id. |
| 18 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | SECURITIES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | FORBRCH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 8 | Change License Number | chg_license_nbr | STRING | X |  |  |  | Số giấy phép điều chỉnh gần nhất. | FMS | FORBRCH | ChangeLicense | Denormalized — map vào IP Alt Identification. |
| 9 | Change License Date | chg_license_dt | DATE | X |  |  |  | Ngày cấp giấy phép điều chỉnh. | FMS | FORBRCH | ChangeLicenseDate | Denormalized — map vào IP Alt Identification. |
| 10 | Change Note | chg_note | STRING | X |  |  |  | Nội dung thay đổi theo giấy phép điều chỉnh. | FMS | FORBRCH | ChangeNote |  |
| 11 | Business Type Codes | bsn_tp_codes | Array<Text> | X |  |  |  | Danh sách mã ngành nghề kinh doanh. | FMS | FORBRCH | BuId | Pure junction FGBUSINESS → denormalize thành ARRAY. HLD decision: FMS_HLD_Tier2.md. |
| 12 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | FORBRCH | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Foreign Fund Management Organization Unit. | FMS | FORBRCH | Id | FK target: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã VPĐD/CN QLQ NN. | FMS | FORBRCH | Id | Lookup pair: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | FORBRCH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | FMS | FORBRCH |  | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | FMS | FORBRCH |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. // Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | FMS | FORBRCH |  | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | FMS | FORBRCH |  | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | FORBRCH |  | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | FORBRCH |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | FMS | FORBRCH |  | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Foreign Fund Management Organization Unit. | FMS | FORBRCH | Id | FK target: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Id. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã VPĐD/CN QLQ NN. | FMS | FORBRCH | Id | Lookup pair: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | FORBRCH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | BANKMONI |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 7 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | BANKMONI | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| 10 | Country of Registration Id | cty_of_rgst_id | BIGINT | X |  | F |  | FK đến quốc gia đăng ký của ngân hàng LKGS. | FMS | BANKMONI |  | FK target: Geographic Area.Geographic Area Id. ID quốc gia lấy từ bảng NATIONAL. |
| 11 | Country of Registration Code | cty_of_rgst_code | STRING | X |  |  |  | Mã quốc gia đăng ký. | FMS | BANKMONI |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Country of Registration Id. |
...
| 15 | Director Name | director_nm | STRING | X |  |  |  | Tên Tổng giám đốc (denormalized). | FMS | BANKMONI |  | Denormalized snapshot — không dùng để join. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Custodian Bank. | FMS | BANKMONI | Id | FK target: Custodian Bank.Custodian Bank Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã ngân hàng LKGS. | FMS | BANKMONI | Id | Lookup pair: Custodian Bank.Custodian Bank Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | BANKMONI |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | FMS | BANKMONI |  | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | FMS | BANKMONI |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. // Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | FMS | BANKMONI |  | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | FMS | BANKMONI |  | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | BANKMONI |  | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | BANKMONI |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | FMS | BANKMONI |  | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Custodian Bank. | FMS | BANKMONI | Id | FK target: Custodian Bank.Custodian Bank Id. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã ngân hàng LKGS. | FMS | BANKMONI | Id | Lookup pair: Custodian Bank.Custodian Bank Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | BANKMONI |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | AGENCIES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 8 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | AGENCIES | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Fund Distribution Agent. | FMS | AGENCIES | Id | FK target: Fund Distribution Agent.Fund Distribution Agent Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã đại lý phân phối quỹ. | FMS | AGENCIES | Id | Lookup pair: Fund Distribution Agent.Fund Distribution Agent Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | AGENCIES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | FMS | AGENCIES |  | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | FMS | AGENCIES |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. // Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | FMS | AGENCIES |  | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | FMS | AGENCIES |  | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | AGENCIES |  | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | AGENCIES |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | FMS | AGENCIES |  | Text tự do — denormalized. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | INVES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 9 | Fund Management Company Id | fnd_mgt_co_id | BIGINT | X |  | F |  | FK đến công ty QLQ đang nhận ủy thác. | FMS | INVES | SecId | FK target: Fund Management Company.Fund Management Company Id. |
| 10 | Fund Management Company Code | fnd_mgt_co_code | STRING | X |  |  |  | Mã công ty QLQ đang nhận ủy thác. | FMS | INVES | SecId | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Fund Management Company Id. |
| 11 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | INVES | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Discretionary Investment Investor. | FMS | INVES | Id | FK target: Discretionary Investment Investor.Discretionary Investment Investor Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã nhà đầu tư ủy thác. | FMS | INVES | Id | Lookup pair: Discretionary Investment Investor.Discretionary Investment Investor Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | INVES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | RPTPERIOD |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 7 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | RPTPERIOD | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| 10 | Self-set Period Id | self-set_prd_id | BIGINT | X |  | F |  | FK đến kỳ báo cáo do cán bộ UB tự thiết lập (SELFSETPD). Nullable. | FMS | RPTPERIOD |  | FK target: SELFSETPD entity — chưa được thiết kế lên Silver. |
| 11 | Self-set Period Code | self-set_prd_code | STRING | X |  |  |  | Mã kỳ báo cáo tự thiết lập. | FMS | RPTPERIOD |  | Lookup pair: SELFSETPD entity — chưa được thiết kế lên Silver. Pair with Self-set Period Id. |
| 12 | Report Template Id | rpt_tpl_id | BIGINT |  |  | F |  | FK đến biểu mẫu báo cáo áp dụng cho kỳ này. | FMS | RPTPERIOD |  | FK target: Report Template.Report Template Id. |
| 13 | Report Template Code | rpt_tpl_code | STRING |  |  |  |  | Mã biểu mẫu báo cáo. | FMS | RPTPERIOD |  | Lookup pair: Report Template.Report Template Code. Pair with Report Template Id. |
| 14 | Submission Deadline Date | submission_ddln_dt | DATE | X |  |  |  | Thời hạn gửi báo cáo muộn nhất (áp dụng cho kỳ ngày/tuần). | FMS | RPTPERIOD |  | Thời gian gửi báo cáo muộn nhất. |
| 15 | Submission Deadline Week | submission_ddln_wk | INT | X |  |  |  | Thời hạn gửi báo cáo muộn nhất (tuần). | FMS | RPTPERIOD |  | Thời gian gửi muộn nhất — đơn vị tuần. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | RATINGPD |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | FUNDS |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 7 | Fund Management Company Id | fnd_mgt_co_id | BIGINT |  |  | F |  | FK đến công ty QLQ quản lý quỹ. | FMS | FUNDS | SecId | FK target: Fund Management Company.Fund Management Company Id. |
| 8 | Fund Management Company Code | fnd_mgt_co_code | STRING |  |  |  |  | Mã công ty QLQ quản lý quỹ. | FMS | FUNDS | SecId | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Fund Management Company Id. |
...
| 12 | License Decision Date | license_dcsn_dt | DATE | X |  |  |  | Ngày cấp phép thành lập quỹ. | FMS | FUNDS | DecisionDate | Denormalized — map vào IP Alt Identification. |
...
| 15 | Distribution Agent Ids | dstr_agnt_ids | Array<Struct> | X |  |  |  | Danh sách đại lý phân phối quỹ (SK + mã nghiệp vụ). | FMS | FUNDS | AgnId | Pure junction AGENFUNDS → denormalize thành ARRAY. Struct: {agent_id: Surrogate Key; agent_code: Text}. HLD decision: FMS_HLD_Tier3.md. |
| 16 | Custodian Bank Ids | cstd_bnk_ids | Array<Struct> | X |  |  |  | Danh sách ngân hàng lưu ký giám sát (SK + mã nghiệp vụ). | FMS | FUNDS | BmnId | Pure junction FNDSBMN → denormalize thành ARRAY. Struct: {bank_id: Surrogate Key; bank_code: Text}. HLD decision: FMS_HLD_Tier3.md. |
| 17 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | FUNDS | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Investment Fund. | FMS | FUNDS | Id | FK target: Investment Fund.Investment Fund Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã quỹ đầu tư. | FMS | FUNDS | Id | Lookup pair: Investment Fund.Investment Fund Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | FUNDS |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | TLProfiles |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Fund Management Company Id | fnd_mgt_co_id | BIGINT |  |  | F |  | FK đến công ty QLQ. | FMS | TLProfiles | SecId | FK target: Fund Management Company.Fund Management Company Id. |
| 5 | Fund Management Company Code | fnd_mgt_co_code | STRING |  |  |  |  | Mã công ty QLQ. | FMS | TLProfiles | SecId | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Fund Management Company Id. |
...
| 12 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | TLProfiles | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Fund Management Company Key Person. | FMS | TLProfiles | Id | FK target: Fund Management Company Key Person.Fund Management Company Key Person Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã nhân sự công ty QLQ. | FMS | TLProfiles | Id | Lookup pair: Fund Management Company Key Person.Fund Management Company Key Person Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | TLProfiles |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 7 | Issuing Authority Name | issuing_ahr_nm | STRING | X |  |  |  | Nơi cấp CCCD/Hộ chiếu. | FMS | TLProfiles |  | Chú ý: tên cột nguồn bị đảo — IdNo chứa nơi cấp, IdAdd chứa số CCCD. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | BRANCHES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Fund Management Company Id | fnd_mgt_co_id | BIGINT |  |  | F |  | FK đến công ty QLQ trong nước. | FMS | BRANCHES | SecId | FK target: Fund Management Company.Fund Management Company Id. |
| 5 | Fund Management Company Code | fnd_mgt_co_code | STRING |  |  |  |  | Mã công ty QLQ trong nước. | FMS | BRANCHES | SecId | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Fund Management Company Id. |
...
| 8 | Parent Organization Unit Id | prn_ou_id | BIGINT | X |  | F |  | FK tự thân — CN/VPĐD cha. | FMS | BRANCHES | BrIdowner | FK target: Fund Management Company Organization Unit.Fund Management Company Organization Unit Id. BrIdowner là Id nguồn — ETL cần resolve sang surrogate. |
| 9 | Parent Organization Unit Code | prn_ou_code | STRING | X |  |  |  | Mã CN/VPĐD cha. | FMS | BRANCHES | BrIdowner | Lookup pair: Fund Management Company Organization Unit.Fund Management Company Organization Unit Code. Pair with Parent Organization Unit Id. |
| 10 | Legal Representative Id | lgl_representative_id | BIGINT | X |  | F |  | FK đến người đại diện pháp luật của CN/VPĐD. | FMS | BRANCHES | TLId | FK target: Fund Management Company Key Person.Fund Management Company Key Person Id. |
| 11 | Legal Representative Code | lgl_representative_code | STRING | X |  |  |  | Mã người đại diện pháp luật. | FMS | BRANCHES | TLId | Lookup pair: Fund Management Company Key Person.Fund Management Company Key Person Code. Pair with Legal Representative Id. |
| 12 | Legal Representative Name | lgl_representative_nm | STRING | X |  |  |  | Tên người đại diện pháp luật (denormalized). | FMS | BRANCHES | TLName | Denormalized snapshot — không dùng để join. |
| 13 | License Decision Number | license_dcsn_nbr | STRING | X |  |  |  | Số quyết định thành lập CN/VPĐD. | FMS | BRANCHES | Decision | Denormalized — map vào IP Alt Identification. |
| 14 | License Decision Date | license_dcsn_dt | DATE | X |  |  |  | Ngày cấp quyết định thành lập CN/VPĐD. | FMS | BRANCHES | DecisionDate | Denormalized — map vào IP Alt Identification. |
...
| 21 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | BRANCHES | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| 24 | Country of Registration Id | cty_of_rgst_id | BIGINT | X |  | F |  | FK đến quốc gia đăng ký của công ty mẹ. | FMS | BRANCHES |  | FK target: Geographic Area.Geographic Area Id. Quốc gia công ty mẹ lấy từ bảng NATIONAL. |
| 25 | Country of Registration Code | cty_of_rgst_code | STRING | X |  |  |  | Mã quốc gia đăng ký. | FMS | BRANCHES |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Country of Registration Id. |
...
| 32 | Parent Company Name | prn_co_nm | STRING | X |  |  |  | Tên công ty mẹ (denormalized — nguồn ETL resolve FK). | FMS | BRANCHES |  | Denormalized. Giữ lại để trace ETL resolve. |
| 33 | Parent Company Registration Number | prn_co_rgst_nbr | STRING | X |  |  |  | Số ĐKKD công ty mẹ (denormalized). | FMS | BRANCHES |  | Denormalized. |
| 34 | Parent Company Address | prn_co_adr | STRING | X |  |  |  | Địa chỉ công ty mẹ (denormalized). | FMS | BRANCHES |  | Denormalized. |
...
| 36 | Business Type Codes | bsn_tp_codes | Array<Text> | X |  |  |  | Danh sách mã nghiệp vụ kinh doanh. Từ bảng junction BRANCHSBUSINES. | FMS | BRANCHES |  | Pure junction BRANCHSBUSINES → denormalize thành ARRAY. Scheme: FIMS_BUSINESS_TYPE. HLD decision: FIMS_HLD_Tier1.md. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Fund Management Company Organization Unit. | FMS | BRANCHES | Id | FK target: Fund Management Company Organization Unit.Fund Management Company Organization Unit Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã CN/VPĐD công ty QLQ. | FMS | BRANCHES | Id | Lookup pair: Fund Management Company Organization Unit.Fund Management Company Organization Unit Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | BRANCHES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | FMS | BRANCHES |  | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | FMS | BRANCHES |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. // Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | FMS | BRANCHES |  | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | FMS | BRANCHES |  | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | BRANCHES |  | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | BRANCHES |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | FMS | BRANCHES |  | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Fund Management Company Organization Unit. | FMS | BRANCHES | Id | FK target: Fund Management Company Organization Unit.Fund Management Company Organization Unit Id. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã CN/VPĐD công ty QLQ. | FMS | BRANCHES | Id | Lookup pair: Fund Management Company Organization Unit.Fund Management Company Organization Unit Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | BRANCHES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | AGENCIESBRA |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Fund Distribution Agent Id | fnd_dstr_agnt_id | BIGINT |  |  | F |  | FK đến đại lý phân phối quỹ. | FMS | AGENCIESBRA | AgnId | FK target: Fund Distribution Agent.Fund Distribution Agent Id. |
| 5 | Fund Distribution Agent Code | fnd_dstr_agnt_code | STRING |  |  |  |  | Mã đại lý phân phối quỹ. | FMS | AGENCIESBRA | AgnId | Lookup pair: Fund Distribution Agent.Fund Distribution Agent Code. Pair with Fund Distribution Agent Id. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Fund Distribution Agent Organization Unit. | FMS | AGENCIESBRA | Id | FK target: Fund Distribution Agent Organization Unit.Fund Distribution Agent Organization Unit Id. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã CN/PGD đại lý phân phối quỹ. | FMS | AGENCIESBRA | Id | Lookup pair: Fund Distribution Agent Organization Unit.Fund Distribution Agent Organization Unit Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | AGENCIESBRA |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | FMS | AGENCIESBRA |  | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | FMS | AGENCIESBRA |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. // Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | FMS | AGENCIESBRA |  | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | FMS | AGENCIESBRA |  | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | AGENCIESBRA |  | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | FMS | AGENCIESBRA |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | FMS | AGENCIESBRA |  | Text tự do — denormalized. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | INVESACC |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Discretionary Investment Investor Id | dscr_ivsm_ivsr_id | BIGINT |  |  | F |  | FK đến nhà đầu tư ủy thác. | FMS | INVESACC | InvesId | FK target: Discretionary Investment Investor.Discretionary Investment Investor Id. |
| 5 | Discretionary Investment Investor Code | dscr_ivsm_ivsr_code | STRING |  |  |  |  | Mã nhà đầu tư ủy thác. | FMS | INVESACC | InvesId | Lookup pair: Discretionary Investment Investor.Discretionary Investment Investor Code. Pair with Discretionary Investment Investor Id. |
| 6 | Account Number | ac_nbr | STRING | X |  |  |  | Số tài khoản ủy thác. | FMS | INVESACC | Account |  |
| 7 | Account Place | ac_plc | STRING | X |  | F |  | Nơi lưu ký tài khoản. | FMS | INVESACC | AccPlace | Cần xác nhận: có phải FK đến Custodian Bank không? Tạm giữ dạng Text. |
...
| 14 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | INVESACC | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | RANK |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Fund Management Company Id | fnd_mgt_co_id | BIGINT |  |  | F |  | FK đến công ty QLQ được xếp hạng. | FMS | RANK | SecId | FK target: Fund Management Company.Fund Management Company Id. |
| 5 | Fund Management Company Code | fnd_mgt_co_code | STRING |  |  |  |  | Mã công ty QLQ được xếp hạng. | FMS | RANK | SecId | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Fund Management Company Id. |
| 6 | Member Rating Period Id | mbr_rtg_prd_id | BIGINT |  |  | F |  | FK đến kỳ đánh giá xếp loại. | FMS | RANK | RatingPdId | FK target: Member Rating Period.Member Rating Period Id. |
| 7 | Member Rating Period Code | mbr_rtg_prd_code | STRING |  |  |  |  | Mã kỳ đánh giá xếp loại. | FMS | RANK | RatingPdId | Lookup pair: Member Rating Period.Member Rating Period Code. Pair with Member Rating Period Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | RNKFACTOR |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Rating Criterion Name | rtg_criterion_nm | STRING |  |  |  |  | Tên nhân tố chấm điểm. | FMS | RNKFACTOR | Name |  |
| 5 | Parent Rating Criterion Id | prn_rtg_criterion_id | BIGINT | X |  | F |  | FK tự thân — nhân tố cha. | FMS | RNKFACTOR | ParentId | FK target: Rating Criterion.Rating Criterion Id. Null = nhân tố gốc. |
| 6 | Parent Rating Criterion Code | prn_rtg_criterion_code | STRING | X |  |  |  | Mã nhân tố cha. | FMS | RNKFACTOR | ParentId | Lookup pair: Rating Criterion.Rating Criterion Code. Pair with Parent Rating Criterion Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | MBFUND |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Investment Fund Id | ivsm_fnd_id | BIGINT |  |  | F |  | FK đến quỹ đầu tư. | FMS | MBFUND | FndId | FK target: Investment Fund.Investment Fund Id. |
| 5 | Investment Fund Code | ivsm_fnd_code | STRING |  |  |  |  | Mã quỹ đầu tư. | FMS | MBFUND | FndId | Lookup pair: Investment Fund.Investment Fund Code. Pair with Investment Fund Id. |
| 6 | Discretionary Investment Investor Id | dscr_ivsm_ivsr_id | BIGINT |  |  | F |  | FK đến nhà đầu tư. | FMS | MBFUND | InvesId | FK target: Discretionary Investment Investor.Discretionary Investment Investor Id. |
| 7 | Discretionary Investment Investor Code | dscr_ivsm_ivsr_code | STRING |  |  |  |  | Mã nhà đầu tư. | FMS | MBFUND | InvesId | Lookup pair: Discretionary Investment Investor.Discretionary Investment Investor Code. Pair with Discretionary Investment Investor Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | REPRESENT |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Investment Fund Id | ivsm_fnd_id | BIGINT |  |  | F |  | FK đến quỹ đầu tư. | FMS | REPRESENT | FndId | FK target: Investment Fund.Investment Fund Id. |
| 5 | Investment Fund Code | ivsm_fnd_code | STRING |  |  |  |  | Mã quỹ đầu tư. | FMS | REPRESENT | FndId | Lookup pair: Investment Fund.Investment Fund Code. Pair with Investment Fund Id. |
| 6 | Fund Management Company Key Person Id | fnd_mgt_co_key_psn_id | BIGINT |  |  | F |  | FK đến nhân sự giữ vai trò thành viên ban đại diện. | FMS | REPRESENT | TLId | FK target: Fund Management Company Key Person.Fund Management Company Key Person Id. |
| 7 | Fund Management Company Key Person Code | fnd_mgt_co_key_psn_code | STRING |  |  |  |  | Mã nhân sự. | FMS | REPRESENT | TLId | Lookup pair: Fund Management Company Key Person.Fund Management Company Key Person Code. Pair with Fund Management Company Key Person Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | STFFGBRCH |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Foreign Fund Management Organization Unit Id | frgn_fnd_mgt_ou_id | BIGINT |  |  | F |  | FK đến VPĐD/CN QLQ nước ngoài. | FMS | STFFGBRCH | FgBrId | FK target: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Id. |
| 5 | Foreign Fund Management Organization Unit Code | frgn_fnd_mgt_ou_code | STRING |  |  |  |  | Mã VPĐD/CN QLQ nước ngoài. | FMS | STFFGBRCH | FgBrId | Lookup pair: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Code. Pair with Foreign Fund Management Organization Unit Id. |
| 6 | Fund Management Company Key Person Id | fnd_mgt_co_key_psn_id | BIGINT |  |  | F |  | FK đến nhân sự giữ vai trò tại VPĐD/CN QLQ NN. | FMS | STFFGBRCH | TLId | FK target: Fund Management Company Key Person.Fund Management Company Key Person Id. |
| 7 | Fund Management Company Key Person Code | fnd_mgt_co_key_psn_code | STRING |  |  |  |  | Mã nhân sự. | FMS | STFFGBRCH | TLId | Lookup pair: Fund Management Company Key Person.Fund Management Company Key Person Code. Pair with Fund Management Company Key Person Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | RPTMEMBER |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Fund Management Company Id | fnd_mgt_co_id | BIGINT | X |  | F |  | FK đến công ty QLQ nộp báo cáo (nullable). | FMS | RPTMEMBER | SecId | FK target: Fund Management Company.Fund Management Company Id. |
| 5 | Fund Management Company Code | fnd_mgt_co_code | STRING | X |  |  |  | Mã công ty QLQ. | FMS | RPTMEMBER | SecId | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Fund Management Company Id. |
| 6 | Investment Fund Id | ivsm_fnd_id | BIGINT | X |  | F |  | FK đến quỹ đầu tư nộp báo cáo (nullable). | FMS | RPTMEMBER | FndId | FK target: Investment Fund.Investment Fund Id. |
| 7 | Investment Fund Code | ivsm_fnd_code | STRING | X |  |  |  | Mã quỹ đầu tư. | FMS | RPTMEMBER | FndId | Lookup pair: Investment Fund.Investment Fund Code. Pair with Investment Fund Id. |
| 8 | Custodian Bank Id | cstd_bnk_id | BIGINT | X |  | F |  | FK đến ngân hàng LKGS nộp báo cáo (nullable). | FMS | RPTMEMBER | BkMId | FK target: Custodian Bank.Custodian Bank Id. |
| 9 | Custodian Bank Code | cstd_bnk_code | STRING | X |  |  |  | Mã ngân hàng LKGS. | FMS | RPTMEMBER | BkMId | Lookup pair: Custodian Bank.Custodian Bank Code. Pair with Custodian Bank Id. |
| 10 | Foreign Fund Management Organization Unit Id | frgn_fnd_mgt_ou_id | BIGINT | X |  | F |  | FK đến VPĐD/CN QLQ NN nộp báo cáo (nullable). | FMS | RPTMEMBER | FrBrId | FK target: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Id. |
| 11 | Foreign Fund Management Organization Unit Code | frgn_fnd_mgt_ou_code | STRING | X |  |  |  | Mã VPĐD/CN QLQ NN. | FMS | RPTMEMBER | FrBrId | Lookup pair: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Code. Pair with Foreign Fund Management Organization Unit Id. |
| 12 | Report Template Id | rpt_tpl_id | BIGINT | X |  | F |  | FK đến biểu mẫu báo cáo. | FMS | RPTMEMBER | RptId | FK target: Report Template.Report Template Id. |
| 13 | Report Template Code | rpt_tpl_code | STRING | X |  |  |  | Mã biểu mẫu báo cáo. | FMS | RPTMEMBER | RptId | Lookup pair: Report Template.Report Template Code. Pair with Report Template Id. |
| 14 | Reporting Period Id | rpt_prd_id | BIGINT |  |  | F |  | FK đến kỳ báo cáo. | FMS | RPTMEMBER | PrdId | FK target: Reporting Period.Reporting Period Id. |
| 15 | Reporting Period Code | rpt_prd_code | STRING |  |  |  |  | Mã kỳ báo cáo. | FMS | RPTMEMBER | PrdId | Lookup pair: Reporting Period.Reporting Period Code. Pair with Reporting Period Id. |
...
| 27 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | RPTMEMBER | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| 30 | Securities Company Id | scr_co_id | BIGINT |  |  | F |  | FK đến công ty chứng khoán gửi báo cáo. | FMS | RPTMEMBER |  | FK target: Securities Company.Securities Company Id. |
| 31 | Securities Company Code | scr_co_code | STRING |  |  |  |  | Mã công ty chứng khoán. | FMS | RPTMEMBER |  | Lookup pair: Securities Company.Securities Company Code. Pair with Securities Company Id. |
| 32 | Report Submission Schedule Id | rpt_submission_shd_id | BIGINT | X |  | F |  | FK đến định kỳ gửi báo cáo. | FMS | RPTMEMBER |  | FK target: Report Submission Schedule.Report Submission Schedule Id. |
| 33 | Report Submission Schedule Code | rpt_submission_shd_code | STRING | X |  |  |  | Mã định kỳ gửi báo cáo. | FMS | RPTMEMBER |  | Lookup pair: Report Submission Schedule.Report Submission Schedule Code. Pair with Report Submission Schedule Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | TRSFERINDER |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Fund Management Company Id | fnd_mgt_co_id | BIGINT |  |  | F |  | FK đến công ty QLQ có cổ phần được chuyển nhượng. | FMS | TRSFERINDER | SecId | FK target: Fund Management Company.Fund Management Company Id. |
| 5 | Fund Management Company Code | fnd_mgt_co_code | STRING |  |  |  |  | Mã công ty QLQ. | FMS | TRSFERINDER | SecId | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Fund Management Company Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | VIOLT |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Fund Management Company Id | fnd_mgt_co_id | BIGINT | X |  | F |  | FK đến công ty QLQ vi phạm (nullable). | FMS | VIOLT | SecId | FK target: Fund Management Company.Fund Management Company Id. |
| 5 | Fund Management Company Code | fnd_mgt_co_code | STRING | X |  |  |  | Mã công ty QLQ. | FMS | VIOLT | SecId | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Fund Management Company Id. |
| 6 | Investment Fund Id | ivsm_fnd_id | BIGINT | X |  | F |  | FK đến quỹ đầu tư liên quan vi phạm (nullable). | FMS | VIOLT | FndId | FK target: Investment Fund.Investment Fund Id. |
| 7 | Investment Fund Code | ivsm_fnd_code | STRING | X |  |  |  | Mã quỹ đầu tư. | FMS | VIOLT | FndId | Lookup pair: Investment Fund.Investment Fund Code. Pair with Investment Fund Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | TRANSFERMBF |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Investment Fund Id | ivsm_fnd_id | BIGINT |  |  | F |  | FK đến quỹ đầu tư có phần vốn chuyển nhượng. | FMS | TRANSFERMBF | FndId | FK target: Investment Fund.Investment Fund Id. |
| 5 | Investment Fund Code | ivsm_fnd_code | STRING |  |  |  |  | Mã quỹ đầu tư. | FMS | TRANSFERMBF | FndId | Lookup pair: Investment Fund.Investment Fund Code. Pair with Investment Fund Id. |
| 6 | Investment Fund Investor Membership Id | ivsm_fnd_ivsr_mbr_id | BIGINT |  |  | F |  | FK đến quan hệ góp vốn của NĐT trong quỹ. | FMS | TRANSFERMBF | MBFId | FK target: Investment Fund Investor Membership.Investment Fund Investor Membership Id. |
| 7 | Investment Fund Investor Membership Code | ivsm_fnd_ivsr_mbr_code | STRING |  |  |  |  | Mã quan hệ góp vốn. | FMS | TRANSFERMBF | MBFId | Lookup pair: Investment Fund Investor Membership.Investment Fund Investor Membership Code. Pair with Investment Fund Investor Membership Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | MBCHANGE |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Investment Fund Investor Membership Id | ivsm_fnd_ivsr_mbr_id | BIGINT |  |  | F |  | FK đến quan hệ góp vốn của NĐT trong quỹ. | FMS | MBCHANGE | MBFId | FK target: Investment Fund Investor Membership.Investment Fund Investor Membership Id. |
| 5 | Investment Fund Investor Membership Code | ivsm_fnd_ivsr_mbr_code | STRING |  |  |  |  | Mã quan hệ góp vốn. | FMS | MBCHANGE | MBFId | Lookup pair: Investment Fund Investor Membership.Investment Fund Investor Membership Code. Pair with Investment Fund Investor Membership Id. |
...
| 10 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | MBCHANGE | CreatedBy | Mã người dùng hệ thống — denormalized. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | RPTMBHS |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Member Periodic Report Id | mbr_prd_rpt_id | BIGINT |  |  | F |  | FK đến báo cáo định kỳ thành viên. | FMS | RPTMBHS | RptMbId | FK target: Member Periodic Report.Member Periodic Report Id. |
| 5 | Member Periodic Report Code | mbr_prd_rpt_code | STRING |  |  |  |  | Mã báo cáo định kỳ. | FMS | RPTMBHS | RptMbId | Lookup pair: Member Periodic Report.Member Periodic Report Code. Pair with Member Periodic Report Id. |
...
| 7 | Changed By Officer Id | changed_by_ofcr_id | BIGINT | X |  | F |  | FK đến nhân sự thực hiện thay đổi trạng thái. | FMS | RPTMBHS | ChgById | FK target: Fund Management Company Key Person.Fund Management Company Key Person Id. |
| 8 | Changed By Officer Code | changed_by_ofcr_code | STRING | X |  |  |  | Mã nhân sự thực hiện thay đổi. | FMS | RPTMBHS | ChgById | Lookup pair: Fund Management Company Key Person.Fund Management Company Key Person Code. Pair with Changed By Officer Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'FMS' | Mã nguồn dữ liệu. | FMS | RPTVALUES |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Member Periodic Report Id | mbr_prd_rpt_id | BIGINT |  |  | F |  | FK đến báo cáo định kỳ thành viên. | FMS | RPTVALUES | MebId | FK target: Member Periodic Report.Member Periodic Report Id. |
| 5 | Member Periodic Report Code | mbr_prd_rpt_code | STRING |  |  |  |  | Mã báo cáo định kỳ. | FMS | RPTVALUES | MebId | Lookup pair: Member Periodic Report.Member Periodic Report Code. Pair with Member Periodic Report Id. |
| 6 | Fund Management Company Id | fnd_mgt_co_id | BIGINT | X |  | F |  | FK đến công ty QLQ nộp báo cáo (nullable). | FMS | RPTVALUES | SecId | FK target: Fund Management Company.Fund Management Company Id. |
| 7 | Fund Management Company Code | fnd_mgt_co_code | STRING | X |  |  |  | Mã công ty QLQ. | FMS | RPTVALUES | SecId | Lookup pair: Fund Management Company.Fund Management Company Code. Pair with Fund Management Company Id. |
| 8 | Investment Fund Id | ivsm_fnd_id | BIGINT | X |  | F |  | FK đến quỹ đầu tư nộp báo cáo (nullable). | FMS | RPTVALUES | FndId | FK target: Investment Fund.Investment Fund Id. |
| 9 | Investment Fund Code | ivsm_fnd_code | STRING | X |  |  |  | Mã quỹ đầu tư. | FMS | RPTVALUES | FndId | Lookup pair: Investment Fund.Investment Fund Code. Pair with Investment Fund Id. |
| 10 | Custodian Bank Id | cstd_bnk_id | BIGINT | X |  | F |  | FK đến ngân hàng LKGS nộp báo cáo (nullable). | FMS | RPTVALUES | BkMId | FK target: Custodian Bank.Custodian Bank Id. |
| 11 | Custodian Bank Code | cstd_bnk_code | STRING | X |  |  |  | Mã ngân hàng LKGS. | FMS | RPTVALUES | BkMId | Lookup pair: Custodian Bank.Custodian Bank Code. Pair with Custodian Bank Id. |
| 12 | Foreign Fund Management Organization Unit Id | frgn_fnd_mgt_ou_id | BIGINT | X |  | F |  | FK đến VPĐD/CN QLQ NN nộp báo cáo (nullable). | FMS | RPTVALUES | FrBrId | FK target: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Id. |
| 13 | Foreign Fund Management Organization Unit Code | frgn_fnd_mgt_ou_code | STRING | X |  |  |  | Mã VPĐD/CN QLQ NN. | FMS | RPTVALUES | FrBrId | Lookup pair: Foreign Fund Management Organization Unit.Foreign Fund Management Organization Unit Code. Pair with Foreign Fund Management Organization Unit Id. |
| 14 | Reporting Period Id | rpt_prd_id | BIGINT | X |  | F |  | FK đến kỳ báo cáo. | FMS | RPTVALUES | PrdId | FK target: Reporting Period.Reporting Period Id. |
| 15 | Reporting Period Code | rpt_prd_code | STRING | X |  |  |  | Mã kỳ báo cáo. | FMS | RPTVALUES | PrdId | Lookup pair: Reporting Period.Reporting Period Code. Pair with Reporting Period Id. |
| 16 | Report Sheet Id | rpt_shet_id | STRING | X |  |  |  | Mã trang/sheet trong biểu mẫu báo cáo. | FMS | RPTVALUES | SheetId | Định danh trang biểu mẫu — denormalized. |
| 17 | Report Target Id | rpt_trgt_id | STRING | X |  |  |  | Mã chỉ tiêu trong sheet báo cáo. | FMS | RPTVALUES | TgtId | Định danh chỉ tiêu — denormalized. |
| 18 | Report Id | rpt_id | STRING | X |  |  |  | Mã biểu mẫu báo cáo. | FMS | RPTVALUES | RptId | Định danh biểu mẫu — denormalized. |
...
| 25 | Created By | crt_by | STRING | X |  |  |  | Người tạo bản ghi. | FMS | RPTVALUES | CreatedBy | Mã người dùng hệ thống — denormalized. |
| 26 | Modified By | mod_by | STRING | X |  |  |  | Người cập nhật bản ghi lần cuối. | FMS | RPTVALUES | ModifyBy | Mã người dùng hệ thống — denormalized. |
