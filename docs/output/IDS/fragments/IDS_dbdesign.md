...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | af_profiles |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Audit Firm Business Code | audt_firm_bsn_code | STRING | X |  |  |  | Mã công ty kiểm toán (mã nghiệp vụ). | IDS | af_profiles | audit_firm_cd | Mã nghiệp vụ — khác BK kỹ thuật. Tương đồng SCMS.CT_KIEM_TOAN.MA_SO. |
...
| 8 | Charter Capital Amount | charter_cptl_amt | DECIMAL(18,2) | X |  |  |  | Vốn điều lệ thực góp. | IDS | af_profiles | paid_in_capital | Tương đồng SCMS.CT_KIEM_TOAN.VON_DIEU_LE. |
| 9 | Approval Decision Number | aprv_dcsn_nbr | STRING | X |  |  |  | Số quyết định chấp thuận của UBCKNN. | IDS | af_profiles | approval_decision_no | Tương đồng SCMS.CT_KIEM_TOAN.SO_QUYET_DINH. |
...
| 14 | Business Registration Number | bsn_rgst_nbr | STRING | X |  |  |  | Giấy chứng nhận đăng ký kinh doanh. | IDS | af_profiles | business_reg_no | Mã số ĐKKD của công ty kiểm toán — nguồn IDS có thông tin chi tiết hơn SCMS. |
...
| 19 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | af_profiles | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 20 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | af_profiles | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Audit Firm. | IDS | af_profiles | id | FK target: Audit Firm.Audit Firm Id. Shared entity — không có PK surrogate riêng. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty kiểm toán. | IDS | af_profiles | id | Lookup pair: Audit Firm.Audit Firm Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | af_profiles |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Audit Firm. | IDS | af_profiles | id | FK target: Audit Firm.Audit Firm Id. Shared entity — không có PK surrogate riêng. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty kiểm toán. | IDS | af_profiles | id | Lookup pair: Audit Firm.Audit Firm Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | af_profiles |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 11 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Audit Firm. | IDS | af_profiles | id | FK target: Audit Firm.Audit Firm Id. Shared entity — không có PK surrogate riêng. |
| 12 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty kiểm toán. | IDS | af_profiles | id | Lookup pair: Audit Firm.Audit Firm Code. Pair with Involved Party Id. |
| 13 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | af_profiles |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | IDS | af_profiles |  | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 7 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | IDS | af_profiles |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Province Id. // Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 8 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | IDS | af_profiles |  | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 9 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | IDS | af_profiles |  | Text denormalized. |
| 10 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | IDS | af_profiles |  | FK target: Geographic Area.Geographic Area Id. |
| 11 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | IDS | af_profiles |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | IDS | af_profiles |  | Text tự do — denormalized. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | report_catalog |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Financial Report Catalog Business Code | fnc_rpt_ctlg_bsn_code | STRING | X |  |  |  | Mã báo cáo (mã nghiệp vụ). | IDS | report_catalog | report_cd | Mã nghiệp vụ — khác BK kỹ thuật. |
...
| 13 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | report_catalog | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 14 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | report_catalog | created_date |  |
| 15 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | report_catalog | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | rrow |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Financial Report Catalog Id | fnc_rpt_ctlg_id | BIGINT |  |  | F |  | FK đến biểu mẫu BCTC. | IDS | rrow | report_catalog_id | FK target: Financial Report Catalog.Financial Report Catalog Id. |
| 5 | Financial Report Catalog Code | fnc_rpt_ctlg_code | STRING |  |  |  |  | Mã biểu mẫu BCTC. | IDS | rrow | report_catalog_id | Lookup pair: Financial Report Catalog.Financial Report Catalog Code. Pair with Financial Report Catalog Id. |
...
| 11 | Row Description Column Code | row_dsc_clmn_code | STRING | X |  |  |  | Mô tả nội dung của hàng (hiện đang lưu mã cột). | IDS | rrow | col_cd | Denormalized text — nguồn lưu mã cột làm mô tả. |
| 12 | Row Index | row_indx | INT | X |  |  |  | Thứ tự hàng. | IDS | rrow | row_index |  |
| 13 | Report Year | rpt_yr | INT | X |  |  |  | Năm tạo báo cáo (denormalized từ report_catalog). | IDS | rrow | report_year | Trường lưu dư thừa — đã có Financial Report Catalog Id. |
...
| 15 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | rrow | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 16 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | rrow | created_date |  |
| 17 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | rrow | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | rcol |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Financial Report Catalog Id | fnc_rpt_ctlg_id | BIGINT |  |  | F |  | FK đến biểu mẫu BCTC. | IDS | rcol | report_catalog_id | FK target: Financial Report Catalog.Financial Report Catalog Id. |
| 5 | Financial Report Catalog Code | fnc_rpt_ctlg_code | STRING |  |  |  |  | Mã biểu mẫu BCTC. | IDS | rcol | report_catalog_id | Lookup pair: Financial Report Catalog.Financial Report Catalog Code. Pair with Financial Report Catalog Id. |
...
| 9 | Column Type Code | clmn_tp_code | STRING | X |  |  |  | Loại giá trị của cột. | IDS | rcol | col_type_cd | Nguồn không tài liệu hóa rõ scheme — giữ làm Text denormalized. |
...
| 12 | Report Year | rpt_yr | INT | X |  |  |  | Năm tạo báo cáo (denormalized từ report_catalog). | IDS | rcol | report_year | Trường lưu dư thừa — đã có Financial Report Catalog Id. |
...
| 14 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | rcol | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 15 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | rcol | created_date |  |
| 16 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | rcol | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | rep_forms |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Periodic Report Form Business Code | prd_rpt_form_bsn_code | STRING | X |  |  |  | Mã form (mã nghiệp vụ). | IDS | rep_forms | report_cd | Mã nghiệp vụ — khác BK kỹ thuật. |
...
| 10 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | rep_forms | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 11 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | rep_forms | created_date |  |
| 12 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | rep_forms | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | rep_row |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Periodic Report Form Id | prd_rpt_form_id | BIGINT |  |  | F |  | FK đến biểu mẫu báo cáo định kỳ. | IDS | rep_row | rep_form_id | FK target: Periodic Report Form.Periodic Report Form Id. |
| 5 | Periodic Report Form Code | prd_rpt_form_code | STRING |  |  |  |  | Mã biểu mẫu báo cáo định kỳ. | IDS | rep_row | rep_form_id | Lookup pair: Periodic Report Form.Periodic Report Form Code. Pair with Periodic Report Form Id. |
...
| 12 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | rep_row | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 13 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | rep_row | created_date |  |
| 14 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | rep_row | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | rep_column |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Periodic Report Form Id | prd_rpt_form_id | BIGINT |  |  | F |  | FK đến biểu mẫu báo cáo định kỳ. | IDS | rep_column | rep_form_id | FK target: Periodic Report Form.Periodic Report Form Id. |
| 5 | Periodic Report Form Code | prd_rpt_form_code | STRING |  |  |  |  | Mã biểu mẫu báo cáo định kỳ. | IDS | rep_column | rep_form_id | Lookup pair: Periodic Report Form.Periodic Report Form Code. Pair with Periodic Report Form Id. |
...
| 13 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | rep_column | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 14 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | rep_column | created_date |  |
| 15 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | rep_column | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | notifications |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Notification Business Code | notf_bsn_code | STRING | X |  |  |  | Mã thông báo (mã nghiệp vụ). | IDS | notifications | noti_cd | Mã nghiệp vụ — khác BK kỹ thuật. |
| 5 | Disclosure Form Definition Id | dscl_form_defn_id | BIGINT | X |  | F |  | FK đến định nghĩa loại hồ sơ/tin CBTT. | IDS | notifications | form_id | FK target: Disclosure Form Definition.Disclosure Form Definition Id. |
| 6 | Disclosure Form Definition Code | dscl_form_defn_code | STRING | X |  |  |  | Mã định nghĩa loại hồ sơ/tin CBTT. | IDS | notifications | form_cd | Lookup pair: Disclosure Form Definition.Disclosure Form Definition Business Code. Pair with Disclosure Form Definition Id. Nguồn lưu denormalized form_cd cùng form_id. |
...
| 18 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | notifications | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 19 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | notifications | created_date |  |
| 20 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | notifications | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | forms |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Disclosure Form Definition Business Code | dscl_form_defn_bsn_code | STRING | X |  |  |  | Mã form (mã nghiệp vụ). | IDS | forms | form_cd | Mã nghiệp vụ — khác BK kỹ thuật. |
...
| 17 | Parent Disclosure Form Definition Id | prn_dscl_form_defn_id | BIGINT | X |  | F |  | FK đến form cha (self-join). | IDS | forms | parent_id | FK target: Disclosure Form Definition.Disclosure Form Definition Id. Self-join. |
| 18 | Parent Disclosure Form Definition Code | prn_dscl_form_defn_code | STRING | X |  |  |  | Mã form cha. | IDS | forms | parent_id | Lookup pair: Disclosure Form Definition.Disclosure Form Definition Code. Pair with Parent Disclosure Form Definition Id. Self-join. |
| 19 | Report Type | rpt_tp | STRING | X |  |  |  | Loại báo cáo (tháng, quý, năm, bán niên...). | IDS | forms | report_type | Text denormalized — không có scheme tài liệu hóa. |
| 20 | Control Unit Code | cntl_unit_code | STRING | X |  | F |  | Đơn vị kiểm soát (Dept_cd của bảng departments). | IDS | forms | control_unit_cd | Denormalized text — departments out-of-scope theo HLD; FK Regulatory Authority Organization Unit không có lookup trong IDS scope. |
| 21 | Operating Unit Codes | oprg_unit_codes | STRING | X |  |  |  | Đơn vị sử dụng (nhiều đơn vị cách nhau bằng ";" Dept_cd của bảng departments). | IDS | forms | operating_unit_cd | Denormalized text — multi-value chuỗi delimited; departments out-of-scope. |
| 22 | Created User | crt_usr | STRING | X |  |  |  | User khi tạo hồ sơ thuộc (ny/tv). | IDS | forms | created_user | Text tự do từ nguồn. |
| 23 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | forms | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 24 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | forms | created_at | Nguồn dùng tên cột created_at (khác các bảng khác dùng created_date). |
| 25 | Created Date | crt_dt | TIMESTAMP | X |  |  |  | Ngày tạo (legacy field). | IDS | forms | created_date | Nguồn có cả created_at lẫn created_date — giữ cả hai. |
| 26 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | forms | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_profiles |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Name | pblc_co_nm | STRING | X |  |  |  | Tên công ty đại chúng (tiếng Việt). | IDS | company_profiles | company_name_vn | company_detail.company_name_vn cùng giá trị (1-1) — map primary từ company_profiles. |
| 5 | Public Company English Name | pblc_co_english_nm | STRING | X |  |  |  | Tên công ty đại chúng (tiếng Anh). | IDS | company_profiles | company_name_en | company_detail.company_name_en cùng giá trị (1-1) — map primary từ company_profiles. |
...
| 12 | Business Registration Number | bsn_rgst_nbr | STRING | X |  |  |  | Mã số doanh nghiệp / số ĐKKD. | IDS | company_profiles | business_reg_no | company_detail.business_reg_no cùng giá trị (1-1) — map primary từ company_profiles. |
...
| 15 | Latest Registration Province Code | latest_rgst_prov_code | STRING | X |  |  |  | Tỉnh/thành nơi cấp gần nhất (mã tỉnh từ provinces). | IDS | company_profiles | latest_reg_prov | Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 16 | Industry Category Id | idy_cgy_id | BIGINT | X |  | F |  | Id ngành nghề (categories). | IDS | company_profiles | category_id | FK target: categories — Classification Value scheme IDS_INDUSTRY_CATEGORY (theo HLD). Giữ Id để truy lại categories khi cần. Cặp Id+Code theo pattern. |
...
| 22 | Company Login | co_login | STRING | X |  |  |  | User của công ty niêm yết (login_name). | IDS | company_profiles | company_login | Denormalized text — logins là bảng hệ thống out-of-scope. |
...
| 26 | Equity Listing Exchange Name | eqty_listing_exg_nm | STRING | X |  |  |  | Sàn niêm yết cổ phiếu (text từ company_detail). | IDS | company_profiles | equity_listing_exch | Denormalized text từ company_detail — không có scheme. |
| 27 | Bond Listing Exchange Name | bond_listing_exg_nm | STRING | X |  |  |  | Sàn niêm yết trái phiếu (text từ company_detail). | IDS | company_profiles | bond_listing_exch | Denormalized text từ company_detail — không có scheme. |
...
| 30 | Equity Ticker | eqty_ticker | STRING | X |  |  |  | Mã chứng khoán cổ phiếu. | IDS | company_profiles | equity_ticker | company_detail.equity_ticker cùng giá trị (1-1) — map primary từ company_profiles. |
...
| 59 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | company_profiles | created_by | Denormalized — logins là bảng hệ thống out-of-scope. Audit từ company_detail là 1-1 với company_profiles. |
| 60 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | company_profiles | created_date | Audit từ company_detail là 1-1 với company_profiles. |
| 61 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | company_profiles | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_detail |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Name | pblc_co_nm | STRING | X |  |  |  | Tên công ty đại chúng (tiếng Việt). | IDS | company_detail | company_name_vn | company_detail.company_name_vn cùng giá trị (1-1) — map primary từ company_profiles. |
| 5 | Public Company English Name | pblc_co_english_nm | STRING | X |  |  |  | Tên công ty đại chúng (tiếng Anh). | IDS | company_detail | company_name_en | company_detail.company_name_en cùng giá trị (1-1) — map primary từ company_profiles. |
...
| 12 | Business Registration Number | bsn_rgst_nbr | STRING | X |  |  |  | Mã số doanh nghiệp / số ĐKKD. | IDS | company_detail | business_reg_no | company_detail.business_reg_no cùng giá trị (1-1) — map primary từ company_profiles. |
...
| 15 | Latest Registration Province Code | latest_rgst_prov_code | STRING | X |  |  |  | Tỉnh/thành nơi cấp gần nhất (mã tỉnh từ provinces). | IDS | company_detail | latest_reg_prov | Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 16 | Industry Category Id | idy_cgy_id | BIGINT | X |  | F |  | Id ngành nghề (categories). | IDS | company_detail | category_id | FK target: categories — Classification Value scheme IDS_INDUSTRY_CATEGORY (theo HLD). Giữ Id để truy lại categories khi cần. Cặp Id+Code theo pattern. |
...
| 22 | Company Login | co_login | STRING | X |  |  |  | User của công ty niêm yết (login_name). | IDS | company_detail | company_login | Denormalized text — logins là bảng hệ thống out-of-scope. |
...
| 26 | Equity Listing Exchange Name | eqty_listing_exg_nm | STRING | X |  |  |  | Sàn niêm yết cổ phiếu (text từ company_detail). | IDS | company_detail | equity_listing_exch | Denormalized text từ company_detail — không có scheme. |
| 27 | Bond Listing Exchange Name | bond_listing_exg_nm | STRING | X |  |  |  | Sàn niêm yết trái phiếu (text từ company_detail). | IDS | company_detail | bond_listing_exch | Denormalized text từ company_detail — không có scheme. |
...
| 30 | Equity Ticker | eqty_ticker | STRING | X |  |  |  | Mã chứng khoán cổ phiếu. | IDS | company_detail | equity_ticker | company_detail.equity_ticker cùng giá trị (1-1) — map primary từ company_profiles. |
...
| 59 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | company_detail | created_by | Denormalized — logins là bảng hệ thống out-of-scope. Audit từ company_detail là 1-1 với company_profiles. |
| 60 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | company_detail | created_date | Audit từ company_detail là 1-1 với company_profiles. |
| 61 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | company_detail | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Public Company. | IDS | company_detail | company_profile_id | FK target: Public Company.Public Company Id. Shared entity — không có PK surrogate riêng. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | company_detail | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_detail |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 12 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | IDS | company_detail |  | Text tự do — denormalized. |
| 13 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Public Company. | IDS | company_detail | company_profile_id | FK target: Public Company.Public Company Id. Shared entity — không có PK surrogate riêng. |
| 14 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | company_detail | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Involved Party Id. |
| 15 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_detail |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 18 | Province Id | prov_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố trụ sở. | IDS | company_detail |  | FK target: Geographic Area.Geographic Area Id. Lookup: DM_TINH_THANH. |
| 19 | Province Code | prov_code | STRING | X |  |  |  | Mã tỉnh/thành (provinces). | IDS | company_detail | head_office_prov | Text denormalized — provinces là reference data set chưa map vào shared Geographic Area trong scope IDS. |
| 20 | District Name | dstc_nm | STRING | X |  |  |  | Quận/huyện trụ sở. | IDS | company_detail |  | Text denormalized — không có bảng lookup quận/huyện trong scope. |
| 21 | Ward Name | ward_nm | STRING | X |  |  |  | Phường/xã trụ sở. | IDS | company_detail |  | Text denormalized. |
| 22 | Geographic Area Id | geo_id | BIGINT | X |  | F |  | FK đến tỉnh/thành phố đặt trụ sở chi nhánh. | IDS | company_detail |  | FK target: Geographic Area.Geographic Area Id. |
| 23 | Geographic Area Code | geo_code | STRING | X |  |  |  | Mã tỉnh/thành phố đặt trụ sở chi nhánh. | IDS | company_detail |  | Lookup pair: Geographic Area.Geographic Area Code. Pair with Geographic Area Id. |
| 24 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | IDS | company_detail |  | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Public Company. | IDS | company_detail | company_profile_id | FK target: Public Company.Public Company Id. Shared entity — không có PK surrogate riêng. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | company_detail | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_detail |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 11 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Public Company. | IDS | company_detail | company_profile_id | FK target: Public Company.Public Company Id. Shared entity — không có PK surrogate riêng. |
| 12 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | company_detail | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Involved Party Id. |
| 13 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_detail |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | stock_holders |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng. | IDS | stock_holders | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | stock_holders | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
...
| 8 | Identity Type Codes | identity_tp_codes | STRING | X |  |  |  | Danh sách loại giấy tờ (chuỗi cách nhau dấu "," — ví dụ "1,2", FK đến identity.identity_type_cd). | IDS | stock_holders | identity_type_cd | Denormalized text — nguồn lưu chuỗi delimited; chi tiết giấy tờ tách sang IP Alt Identification (Tier 3). |
| 9 | Position Codes | pos_codes | STRING | X |  |  |  | Danh sách mã chức vụ (chuỗi cách nhau dấu "," — ví dụ "6,3", FK đến positions.position_cd). | IDS | stock_holders | position_cd | Denormalized text — nguồn lưu chuỗi delimited; positions là bảng danh mục chức vụ (out-of-scope Silver). |
| 10 | Shareholder Type Codes | shrhlr_tp_codes | STRING | X |  |  |  | Danh sách loại cổ đông (chuỗi cách nhau dấu ","). | IDS | stock_holders | shareholder_type | Denormalized text — nguồn lưu chuỗi delimited; nội dung trùng với các flag founder/major/insider/foreign/government/strategic/bank/related/other. |
...
| 14 | Nationality Code | nationality_code | STRING | X |  |  |  | Quốc tịch (text từ nguồn). | IDS | stock_holders | nationality | Text denormalized — nguồn không có lookup tường minh trong scope IDS; countries là reference data set chưa map vào shared Geographic Area. |
...
| 41 | Other Holder Active Date | othr_hldr_actv_dt | DATE | X |  |  |  | Ngày bắt đầu là cổ đông khác. | IDS | stock_holders | other_hld_active_date | Nguồn ghi chú: chưa code. |
| 42 | Other Holder Inactive Date | othr_hldr_inact_dt | DATE | X |  |  |  | Ngày kết thúc là cổ đông khác. | IDS | stock_holders | other_hld_inactive_date | Nguồn ghi chú: chưa code. |
...
| 55 | Reason | rsn | STRING | X |  |  |  | Lý do. | IDS | stock_holders | reason | Nguồn ghi chú: toàn giá trị NULL. |
| 56 | VSD Data Updated Timestamp | vsd_data_udt_tms | TIMESTAMP | X |  |  |  | Ngày cập nhật dữ liệu từ trung tâm lưu ký. | IDS | stock_holders | vsd_data_updated_date | Nguồn ghi chú: toàn giá trị NULL. |
| 57 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | stock_holders | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 58 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | stock_holders | created_date |  |
| 59 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | stock_holders | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Stock Holder. | IDS | stock_holders | id | FK target: Stock Holder.Stock Holder Id. Shared entity — không có PK surrogate riêng. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã cổ đông. | IDS | stock_holders | id | Lookup pair: Stock Holder.Stock Holder Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | stock_holders |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Address Detail | adr_dtl | STRING | X |  |  |  | Địa chỉ văn phòng đại diện. | IDS | stock_holders |  | Text tự do — denormalized. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Stock Holder. | IDS | stock_holders | id | FK target: Stock Holder.Stock Holder Id. Shared entity — không có PK surrogate riêng. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã cổ đông. | IDS | stock_holders | id | Lookup pair: Stock Holder.Stock Holder Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | stock_holders |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | af_legal_representative |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Audit Firm Id | audt_firm_id | BIGINT |  |  | F |  | FK đến công ty kiểm toán. | IDS | af_legal_representative | af_profile_id | FK target: Audit Firm.Audit Firm Id. |
| 5 | Audit Firm Code | audt_firm_code | STRING |  |  |  |  | Mã công ty kiểm toán. | IDS | af_legal_representative | af_profile_id | Lookup pair: Audit Firm.Audit Firm Code. Pair with Audit Firm Id. |
...
| 10 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | af_legal_representative | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 11 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | af_legal_representative | created_date |  |
| 12 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | af_legal_representative | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Audit Firm Legal Representative. | IDS | af_legal_representative | id | FK target: Audit Firm Legal Representative.Audit Firm Legal Representative Id. Shared entity — không có PK surrogate riêng. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã người đại diện pháp luật. | IDS | af_legal_representative | id | Lookup pair: Audit Firm Legal Representative.Audit Firm Legal Representative Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | af_legal_representative |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | af_approval |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Audit Firm Id | audt_firm_id | BIGINT |  |  | F |  | FK đến công ty kiểm toán. | IDS | af_approval | af_profile_id | FK target: Audit Firm.Audit Firm Id. |
| 5 | Audit Firm Code | audt_firm_code | STRING |  |  |  |  | Mã công ty kiểm toán. | IDS | af_approval | af_profile_id | Lookup pair: Audit Firm.Audit Firm Code. Pair with Audit Firm Id. |
...
| 26 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | af_approval | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 27 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | af_approval | created_date |  |
| 28 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | af_approval | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | af_auditor_approval |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Audit Firm Id | audt_firm_id | BIGINT |  |  | F |  | FK đến công ty kiểm toán. | IDS | af_auditor_approval | af_profile_id | FK target: Audit Firm.Audit Firm Id. |
| 5 | Audit Firm Code | audt_firm_code | STRING |  |  |  |  | Mã công ty kiểm toán. | IDS | af_auditor_approval | af_profile_id | Lookup pair: Audit Firm.Audit Firm Code. Pair with Audit Firm Id. |
| 6 | Auditor Full Name | auditor_full_nm | STRING | X |  |  |  | Họ tên kiểm toán viên. | IDS | af_auditor_approval | full_name | Denormalized — entity grain là hồ sơ chấp thuận; kiểm toán viên không có entity Involved Party riêng trong scope IDS. |
...
| 31 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | af_auditor_approval | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 32 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | af_auditor_approval | created_date |  |
| 33 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | af_auditor_approval | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | noti_config |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Disclosure Notification Id | dscl_notf_id | BIGINT |  |  | F |  | FK đến instance thông báo CBTT. | IDS | noti_config | notification_id | FK target: Disclosure Notification.Disclosure Notification Id. |
| 5 | Disclosure Notification Code | dscl_notf_code | STRING |  |  |  |  | Mã thông báo CBTT. | IDS | noti_config | notification_id | Lookup pair: Disclosure Notification.Disclosure Notification Code. Pair with Disclosure Notification Id. |
| 6 | Notification Business Code | notf_bsn_code | STRING | X |  |  |  | Mã thông báo (denormalized từ notifications). | IDS | noti_config | noti_cd | Denormalized — đã có Disclosure Notification Id. |
| 7 | Notification Title | notf_ttl | STRING | X |  |  |  | Tiêu đề thông báo (tiếng Việt — denormalized từ notifications). | IDS | noti_config | noti_title_vi | Denormalized — đã có Disclosure Notification Id. |
| 8 | Notification English Title | notf_english_ttl | STRING | X |  |  |  | Tiêu đề thông báo (tiếng Anh — denormalized từ notifications). | IDS | noti_config | noti_title_en | Denormalized — đã có Disclosure Notification Id. |
...
| 12 | Manager Login Id | mgr_login_id | BIGINT | X |  | F |  | Id người quản lý (logins). | IDS | noti_config | login_id | FK target: logins entity — out-of-scope (bảng hệ thống). Giữ Id để truy lại logins khi cần. |
| 13 | Manager Login Name | mgr_login_nm | STRING | X |  |  |  | Tên đăng nhập người quản lý. | IDS | noti_config | login_name | Denormalized text — logins là bảng hệ thống out-of-scope. |
| 14 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | noti_config | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 15 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | noti_config | created_date |  |
| 16 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | noti_config | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | legal_representative |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng. | IDS | legal_representative | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | legal_representative | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
| 6 | Full Name | full_nm | STRING | X |  |  |  | Họ tên người đại diện. | IDS | legal_representative | name |  |
| 7 | Position Title | pos_ttl | STRING | X |  |  |  | Chức vụ. | IDS | legal_representative | position_title | Text tự do từ nguồn — không có scheme tài liệu hóa. |
...
| 10 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | legal_representative | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 11 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | legal_representative | created_date |  |
| 12 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | legal_representative | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Public Company Legal Representative. | IDS | legal_representative | id | FK target: Public Company Legal Representative.Public Company Legal Representative Id. Shared entity — không có PK surrogate riêng. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã người đại diện. | IDS | legal_representative | id | Lookup pair: Public Company Legal Representative.Public Company Legal Representative Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | legal_representative |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 6 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Public Company Legal Representative. | IDS | legal_representative | id | FK target: Public Company Legal Representative.Public Company Legal Representative Id. Shared entity — không có PK surrogate riêng. |
| 7 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã người đại diện. | IDS | legal_representative | id | Lookup pair: Public Company Legal Representative.Public Company Legal Representative Code. Pair with Involved Party Id. |
| 8 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | legal_representative |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_relationship |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng. | IDS | company_relationship | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | company_relationship | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
...
| 15 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | company_relationship | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 16 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | company_relationship | created_date |  |
| 17 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | company_relationship | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | state_capital |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng. | IDS | state_capital | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | state_capital | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
...
| 10 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | state_capital | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 11 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | state_capital | created_date |  |
| 12 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | state_capital | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | foreign_owner_limit |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng. | IDS | foreign_owner_limit | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | foreign_owner_limit | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
...
| 9 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | foreign_owner_limit | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 10 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | foreign_owner_limit | created_date |  |
| 11 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | foreign_owner_limit | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| STT | Tên trường | Tên cột | Kiểu dữ liệu và độ dài | Nullable | Unique | P/F Key | Mặc định | Mô tả | Hệ thống nguồn | Schema.Table | Source Field Name | ETL Rules |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Involved Party Id | ip_id | BIGINT |  |  | F |  | FK đến Stock Holder. | IDS | identity | stock_holder_id | FK target: Stock Holder.Stock Holder Id. Shared entity — không có PK surrogate riêng. |
| 2 | Involved Party Code | ip_code | STRING |  |  |  |  | Mã cổ đông. | IDS | identity | stock_holder_id | Lookup pair: Stock Holder.Stock Holder Code. Pair with Involved Party Id. |
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | identity |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | account_numbers |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Stock Holder Id | stk_hldr_id | BIGINT |  |  | F |  | FK đến cổ đông. | IDS | account_numbers | stock_holder_id | FK target: Stock Holder.Stock Holder Id. |
| 5 | Stock Holder Code | stk_hldr_code | STRING |  |  |  |  | Mã cổ đông. | IDS | account_numbers | stock_holder_id | Lookup pair: Stock Holder.Stock Holder Code. Pair with Stock Holder Id. |
| 6 | Trading Account Number | tdg_ac_nbr | STRING | X |  |  |  | Số tài khoản giao dịch. | IDS | account_numbers | trading_account_no |  |
| 7 | Securities Company Code | scr_co_code | STRING | X |  | F |  | Mã công ty chứng khoán. | IDS | account_numbers | sec_company_cd | Denormalized text — nguồn IDS không có bảng lookup CTCK (CTCK được quản lý ở SCMS/FIMS out-of-scope IDS). Nếu cross-source có FK thực tế thì cập nhật sau. |
...
| 11 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | account_numbers | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 12 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | account_numbers | created_date |  |
| 13 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | account_numbers | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | holder_relationship |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Stock Holder Id | stk_hldr_id | BIGINT |  |  | F |  | FK đến cổ đông chính. | IDS | holder_relationship | stock_holder_id | FK target: Stock Holder.Stock Holder Id. |
| 5 | Stock Holder Code | stk_hldr_code | STRING |  |  |  |  | Mã cổ đông chính. | IDS | holder_relationship | stock_holder_id | Lookup pair: Stock Holder.Stock Holder Code. Pair with Stock Holder Id. |
| 6 | Related Stock Holder Id | rel_stk_hldr_id | BIGINT |  |  | F |  | FK đến cổ đông liên quan. | IDS | holder_relationship | related_holder_id | FK target: Stock Holder.Stock Holder Id. Cặp FK thứ 2. |
| 7 | Related Stock Holder Code | rel_stk_hldr_code | STRING |  |  |  |  | Mã cổ đông liên quan. | IDS | holder_relationship | related_holder_id | Lookup pair: Stock Holder.Stock Holder Code. Pair with Related Stock Holder Id. |
...
| 12 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | holder_relationship | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 13 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | holder_relationship | created_date |  |
| 14 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | holder_relationship | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | stock_controls |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Stock Holder Id | stk_hldr_id | BIGINT |  |  | F |  | FK đến cổ đông. | IDS | stock_controls | stock_holder_id | FK target: Stock Holder.Stock Holder Id. |
| 5 | Stock Holder Code | stk_hldr_code | STRING |  |  |  |  | Mã cổ đông. | IDS | stock_controls | stock_holder_id | Lookup pair: Stock Holder.Stock Holder Code. Pair with Stock Holder Id. |
...
| 11 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | stock_controls | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 12 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | stock_controls | created_date |  |
| 13 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | stock_controls | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | af_warning |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Audit Firm Approval Id | audt_firm_aprv_id | BIGINT | X |  | F |  | FK đến hồ sơ chấp thuận công ty kiểm toán (nullable khi đối tượng là KTV). | IDS | af_warning | af_approval_id | FK target: Audit Firm Approval.Audit Firm Approval Id. Nullable — NULL khi warning_target_type_code = kiểm toán viên. |
| 5 | Audit Firm Approval Code | audt_firm_aprv_code | STRING | X |  |  |  | Mã hồ sơ chấp thuận công ty kiểm toán. | IDS | af_warning | af_approval_id | Lookup pair: Audit Firm Approval.Audit Firm Approval Code. Pair with Audit Firm Approval Id. |
| 6 | Auditor Approval Id | auditor_aprv_id | BIGINT | X |  | F |  | FK đến hồ sơ chấp thuận kiểm toán viên (nullable khi đối tượng là công ty KT). | IDS | af_warning | af_auditor_approval_id | FK target: Auditor Approval.Auditor Approval Id. Nullable — NULL khi warning_target_type_code = công ty kiểm toán. |
| 7 | Auditor Approval Code | auditor_aprv_code | STRING | X |  |  |  | Mã hồ sơ chấp thuận kiểm toán viên. | IDS | af_warning | af_auditor_approval_id | Lookup pair: Auditor Approval.Auditor Approval Code. Pair with Auditor Approval Id. |
...
| 15 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | af_warning | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 16 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | af_warning | created_date |  |
| 17 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | af_warning | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | af_sanctions |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Audit Firm Approval Id | audt_firm_aprv_id | BIGINT | X |  | F |  | FK đến hồ sơ chấp thuận công ty kiểm toán (nullable khi đối tượng là KTV). | IDS | af_sanctions | af_approval_id | FK target: Audit Firm Approval.Audit Firm Approval Id. Nullable — NULL khi sanction_target_type_code = kiểm toán viên. |
| 5 | Audit Firm Approval Code | audt_firm_aprv_code | STRING | X |  |  |  | Mã hồ sơ chấp thuận công ty kiểm toán. | IDS | af_sanctions | af_approval_id | Lookup pair: Audit Firm Approval.Audit Firm Approval Code. Pair with Audit Firm Approval Id. |
| 6 | Auditor Approval Id | auditor_aprv_id | BIGINT | X |  | F |  | FK đến hồ sơ chấp thuận kiểm toán viên (nullable khi đối tượng là công ty KT). | IDS | af_sanctions | af_auditor_approval_id | FK target: Auditor Approval.Auditor Approval Id. Nullable — NULL khi sanction_target_type_code = công ty kiểm toán. |
| 7 | Auditor Approval Code | auditor_aprv_code | STRING | X |  |  |  | Mã hồ sơ chấp thuận kiểm toán viên. | IDS | af_sanctions | af_auditor_approval_id | Lookup pair: Auditor Approval.Auditor Approval Code. Pair with Auditor Approval Id. |
...
| 14 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | af_sanctions | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 15 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | af_sanctions | created_date |  |
| 16 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | af_sanctions | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | capital_mobilization |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng. | IDS | capital_mobilization | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | capital_mobilization | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
...
| 9 | Capital Increase Method | cptl_incr_mth | STRING | X |  |  |  | Hình thức tăng vốn. | IDS | capital_mobilization | capital_increase_method | Text tự do từ nguồn — không có scheme tài liệu hóa. |
| 10 | Audit Firm Name | audt_firm_nm | STRING | X |  | F |  | Tên công ty kiểm toán xác nhận (tiếng Việt). | IDS | capital_mobilization | audit_firm_name_vi | Text denormalized — nguồn chỉ lưu tên không có mã; không có FK trực tiếp đến Audit Firm entity. |
| 11 | Audit Firm English Name | audt_firm_english_nm | STRING | X |  |  |  | Tên công ty kiểm toán xác nhận (tiếng Anh). | IDS | capital_mobilization | audit_firm_name_en | Text denormalized — nguồn chỉ lưu tên không có mã. |
| 12 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | capital_mobilization | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 13 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | capital_mobilization | created_date |  |
| 14 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | capital_mobilization | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_add_capital |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng. | IDS | company_add_capital | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | company_add_capital | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
...
| 12 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | company_add_capital | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 13 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | company_add_capital | created_date |  |
| 14 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | company_add_capital | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_securities_issuance |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng. | IDS | company_securities_issuance | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | company_securities_issuance | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
...
| 68 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | company_securities_issuance | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 69 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | company_securities_issuance | created_date |  |
| 70 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | company_securities_issuance | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_tender_offer |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng (công ty mục tiêu). | IDS | company_tender_offer | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | company_tender_offer | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
| 6 | Tender Offeror Name | tender_offeror_nm | STRING | X |  |  |  | Tên tổ chức/cá nhân chào mua công khai (tiếng Việt). | IDS | company_tender_offer | tender_offeror_name_vi | Text denormalized — bên chào mua không có entity Involved Party riêng trong scope IDS. |
...
| 8 | Tender Offeror Identification Number | tender_offeror_identn_nbr | STRING | X |  |  |  | Số CMND/Hộ chiếu/GCN ĐKDN của bên chào mua. | IDS | company_tender_offer | offeror_id_no | Text denormalized — bên chào mua không có entity riêng. |
| 9 | Tender Offeror Relationship | tender_offeror_rltnp | STRING | X |  |  |  | Mối quan hệ giữa bên chào mua với công ty mục tiêu. | IDS | company_tender_offer | offeror_relationship | Text tự do từ nguồn. |
| 10 | Securities Agent Name | scr_agnt_nm | STRING | X |  |  |  | Tên công ty chứng khoán làm đại lý (tiếng Việt). | IDS | company_tender_offer | securities_agent_name_vi | Text denormalized — đại lý chứng khoán không có entity Involved Party trong scope IDS. |
...
| 23 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | company_tender_offer | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 24 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | company_tender_offer | created_date |  |
| 25 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | company_tender_offer | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_treasury_stocks |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng. | IDS | company_treasury_stocks | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | company_treasury_stocks | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
...
| 11 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | company_treasury_stocks | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 12 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | company_treasury_stocks | created_date |  |
| 13 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | company_treasury_stocks | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_inspection |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng. | IDS | company_inspection | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | company_inspection | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
...
| 9 | Inspection Period | inspection_prd | STRING | X |  |  |  | Thời kỳ thanh tra/kiểm tra. | IDS | company_inspection | inspection_period | Text tự do — nguồn mô tả dạng chuỗi (VD ""2020-2022""). |
...
| 13 | Lead Inspection Unit Name | lead_inspection_unit_nm | STRING | X |  | F |  | Đơn vị chủ trì kiểm tra/thanh tra (tiếng Việt). | IDS | company_inspection | lead_inspection_unit_vi | Text denormalized — đơn vị chủ trì không có FK đến shared Regulatory Authority Organization Unit trong scope IDS. |
| 14 | Lead Inspection Unit English Name | lead_inspection_unit_english_nm | STRING | X |  |  |  | Đơn vị chủ trì kiểm tra/thanh tra (tiếng Anh). | IDS | company_inspection | lead_inspection_unit_en | Text denormalized. |
...
| 17 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | company_inspection | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 18 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | company_inspection | created_date |  |
| 19 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | company_inspection | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'IDS' | Mã nguồn dữ liệu. | IDS | company_penalize |  | Scheme: SOURCE_SYSTEM. BK. Hardcode. |
| 4 | Public Company Id | pblc_co_id | BIGINT |  |  | F |  | FK đến công ty đại chúng. | IDS | company_penalize | company_profile_id | FK target: Public Company.Public Company Id. |
| 5 | Public Company Code | pblc_co_code | STRING |  |  |  |  | Mã công ty đại chúng. | IDS | company_penalize | company_profile_id | Lookup pair: Public Company.Public Company Code. Pair with Public Company Id. |
...
| 7 | Investor Name | ivsr_nm | STRING | X |  |  |  | Tên nhà đầu tư bị xử phạt (null khi đối tượng là công ty). | IDS | company_penalize | investor_name | Text denormalized — nhà đầu tư bị phạt không có entity Involved Party riêng trong scope IDS. |
| 8 | Investor Identification Number | ivsr_identn_nbr | STRING | X |  |  |  | Số CCCD/Hộ chiếu của nhà đầu tư. | IDS | company_penalize | investor_id_no | Text denormalized. |
| 9 | Investor Position Title | ivsr_pos_ttl | STRING | X |  |  |  | Chức vụ của nhà đầu tư. | IDS | company_penalize | investor_position_title | Text denormalized — chức vụ tại công ty đại chúng. |
...
| 13 | Penalty Form | pny_form | STRING | X |  |  |  | Hình thức phạt chính. | IDS | company_penalize | penalty_form | Text tự do từ nguồn — không có scheme tài liệu hóa. |
...
| 17 | Created By Login Name | crt_by_login_nm | STRING | X |  |  |  | Người tạo (login_name của logins). | IDS | company_penalize | created_by | Denormalized — logins là bảng hệ thống out-of-scope. |
| 18 | Created Timestamp | crt_tms | TIMESTAMP | X |  |  |  | Ngày tạo. | IDS | company_penalize | created_date |  |
| 19 | Last Updated By Login Name | last_udt_by_login_nm | STRING | X |  |  |  | Người sửa (login_name của logins). | IDS | company_penalize | last_updated_by | Denormalized — logins là bảng hệ thống out-of-scope. |
