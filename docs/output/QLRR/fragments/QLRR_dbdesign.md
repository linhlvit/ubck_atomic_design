...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_indicator_category |  |  |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_indicator |  |  |
...
| 7 | Business Key | bsn_key | STRING | X |  |  |  | Mã nghiệp vụ chỉ tiêu hệ thống (VD: GDP_VN, CPI_VN). Chỉ có ở chỉ tiêu hệ thống. | QLRR | risk_indicator | indicator_code | Nullable — chỉ tiêu tự tạo không có indicator_code. |
| 8 | Risk Indicator Category Id | rsk_ind_cgy_id | BIGINT | X |  | F |  | FK đến nhóm chỉ tiêu rủi ro. | QLRR | risk_indicator | category_id | FK target: Risk Indicator Category.Risk Indicator Category Id. Nullable — chỉ tiêu tự tạo không có category. |
| 9 | Risk Indicator Category Code | rsk_ind_cgy_code | STRING | X |  |  |  | Mã nhóm chỉ tiêu rủi ro. | QLRR | risk_indicator | category_id | Lookup pair: Risk Indicator Category.Risk Indicator Category Code. Pair with Risk Indicator Category Id. Nullable — chỉ tiêu tự tạo không có category. |
...
| 13 | Last Sync Time | last_sync_tm | TIMESTAMP | X |  |  |  | Thời điểm đồng bộ dữ liệu gần nhất. Chỉ áp dụng cho chỉ tiêu hệ thống. | QLRR | risk_indicator | last_sync_time | Nullable — chỉ tiêu tự tạo không có last_sync_time. |
| 14 | Display Order | dspl_ordr | INT | X |  |  |  | Thứ tự hiển thị của chỉ tiêu trên màn hình. | QLRR | risk_indicator | display_order | Nullable — chỉ tiêu tự tạo không có display_order. |
| 15 | Display Flag | dspl_f | BOOLEAN | X |  |  |  | Có hiển thị trên màn hình không: 0=Không, 1=Có. Chỉ áp dụng cho chỉ tiêu hệ thống. | QLRR | risk_indicator | is_display | Nullable — chỉ tiêu tự tạo không có is_display. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_indicator_custom |  |  |
...
| 7 | Business Key | bsn_key | STRING | X |  |  |  | Mã nghiệp vụ chỉ tiêu hệ thống (VD: GDP_VN, CPI_VN). Chỉ có ở chỉ tiêu hệ thống. | QLRR | risk_indicator_custom | indicator_code | Nullable — chỉ tiêu tự tạo không có indicator_code. |
| 8 | Risk Indicator Category Id | rsk_ind_cgy_id | BIGINT | X |  | F |  | FK đến nhóm chỉ tiêu rủi ro. | QLRR | risk_indicator_custom | category_id | FK target: Risk Indicator Category.Risk Indicator Category Id. Nullable — chỉ tiêu tự tạo không có category. |
| 9 | Risk Indicator Category Code | rsk_ind_cgy_code | STRING | X |  |  |  | Mã nhóm chỉ tiêu rủi ro. | QLRR | risk_indicator_custom | category_id | Lookup pair: Risk Indicator Category.Risk Indicator Category Code. Pair with Risk Indicator Category Id. Nullable — chỉ tiêu tự tạo không có category. |
...
| 13 | Last Sync Time | last_sync_tm | TIMESTAMP | X |  |  |  | Thời điểm đồng bộ dữ liệu gần nhất. Chỉ áp dụng cho chỉ tiêu hệ thống. | QLRR | risk_indicator_custom | last_sync_time | Nullable — chỉ tiêu tự tạo không có last_sync_time. |
| 14 | Display Order | dspl_ordr | INT | X |  |  |  | Thứ tự hiển thị của chỉ tiêu trên màn hình. | QLRR | risk_indicator_custom | display_order | Nullable — chỉ tiêu tự tạo không có display_order. |
| 15 | Display Flag | dspl_f | BOOLEAN | X |  |  |  | Có hiển thị trên màn hình không: 0=Không, 1=Có. Chỉ áp dụng cho chỉ tiêu hệ thống. | QLRR | risk_indicator_custom | is_display | Nullable — chỉ tiêu tự tạo không có is_display. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_report_type |  |  |
...
| 7 | Active Flag | actv_f | BOOLEAN |  |  |  |  | Trạng thái: 0=Không hoạt động, 1=Hoạt động. | QLRR | risk_report_type | is_active | Chốt T1-01: template_content không lưu trên Silver — config kỹ thuật. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_indicator_schedule |  |  |
| 4 | Risk Indicator Id | rsk_ind_id | BIGINT |  |  | F |  | FK đến chỉ tiêu rủi ro. | QLRR | risk_indicator_schedule | indicator_id | FK target: Risk Indicator.Risk Indicator Id. |
| 5 | Risk Indicator Code | rsk_ind_code | STRING |  |  |  |  | Mã chỉ tiêu rủi ro. | QLRR | risk_indicator_schedule | indicator_id | Lookup pair: Risk Indicator.Risk Indicator Code. Pair with Risk Indicator Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_alert_config |  |  |
| 4 | Risk Indicator Id | rsk_ind_id | BIGINT |  |  | F |  | FK đến chỉ tiêu rủi ro (hệ thống hoặc tự tạo) sau gộp. | QLRR | risk_alert_config | indicator_id | FK target: Risk Indicator.Risk Indicator Id. HLD T2-02: indicator_type=1 map indicator_id; indicator_type=2 map custom_indicator_id — cả 2 về ds_indicator_id. |
| 5 | Risk Indicator Code | rsk_ind_code | STRING |  |  |  |  | Mã chỉ tiêu rủi ro. | QLRR | risk_alert_config | indicator_id | Lookup pair: Risk Indicator.Risk Indicator Code. Pair with Risk Indicator Id. |
...
| 8 | Threshold Value | thrs_val | STRING |  |  |  |  | Giá trị ngưỡng kích hoạt cảnh báo. | QLRR | risk_alert_config | threshold_value | Lưu dạng Text — giá trị số thập phân, parse khi sử dụng. |
...
| 11 | Handler User Id | handler_usr_id | STRING | X |  |  |  | User ID người xử lý chính (denormalized — không có User entity trên Silver). | QLRR | risk_alert_config | handler_user_id | Denormalized. HLD T2-01: không có User entity trên Silver. |
| 12 | Handler User Name | handler_usr_nm | STRING | X |  |  |  | Tên người xử lý chính (denormalized). | QLRR | risk_alert_config | handler_user_name | Denormalized. Pair với Handler User Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_report_upload_batch |  |  |
| 4 | Risk Report Type Id | rsk_rpt_tp_id | BIGINT |  |  | F |  | FK đến loại báo cáo. | QLRR | risk_report_upload_batch | report_type_id | FK target: Risk Report Type.Risk Report Type Id. |
| 5 | Risk Report Type Code | rsk_rpt_tp_code | STRING |  |  |  |  | Mã loại báo cáo. | QLRR | risk_report_upload_batch | report_type_id | Lookup pair: Risk Report Type.Risk Report Type Code. Pair with Risk Report Type Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_indicator_value |  |  |
| 4 | Risk Indicator Id | rsk_ind_id | BIGINT |  |  | F |  | FK đến chỉ tiêu rủi ro (hệ thống lẫn tự tạo — QLRR-P01 confirmed). | QLRR | risk_indicator_value | indicator_id | FK target: Risk Indicator.Risk Indicator Id. QLRR-P01 confirmed: indicator_id lưu FK cho cả chỉ tiêu hệ thống lẫn tự tạo trên 1 trường. |
| 5 | Risk Indicator Code | rsk_ind_code | STRING |  |  |  |  | Mã chỉ tiêu rủi ro. | QLRR | risk_indicator_value | indicator_id | Lookup pair: Risk Indicator.Risk Indicator Code. Pair with Risk Indicator Id. |
...
| 7 | Period Value | prd_val | INT | X |  |  |  | Số thứ tự kỳ trong năm. VD: period_type=Tháng, period_date=12/03/2026 → period_value=3; period_type=Quý, period_date=12/03/2026 → period_value=1. | QLRR | risk_indicator_value | period_value | Nullable khi period_type=Ngày (không có số thứ tự kỳ). |
...
| 11 | Value | val | STRING |  |  |  |  | Giá trị chỉ tiêu tại kỳ này. | QLRR | risk_indicator_value | value | Lưu dạng Text — giá trị số thập phân; parse theo Unit Code khi sử dụng. |
...
| 15 | Cumulative Value | cmlv_val | STRING | X |  |  |  | Giá trị luỹ kế. [QLRR-P02 Open]: cơ sở luỹ kế chưa xác định (từ đầu năm hay từ đầu kỳ). | QLRR | risk_indicator_value | cumulative_value | QLRR-P02: chưa rõ cơ sở luỹ kế — giữ dạng Text, ghi note pending. Cần data profiling để xác định ngữ nghĩa chính xác. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_indicator_value_history |  |  |
| 4 | Risk Indicator Id | rsk_ind_id | BIGINT |  |  | F |  | FK đến chỉ tiêu rủi ro. | QLRR | risk_indicator_value_history | indicator_id | FK target: Risk Indicator.Risk Indicator Id. |
| 5 | Risk Indicator Code | rsk_ind_code | STRING |  |  |  |  | Mã chỉ tiêu rủi ro. | QLRR | risk_indicator_value_history | indicator_id | Lookup pair: Risk Indicator.Risk Indicator Code. Pair with Risk Indicator Id. |
| 6 | Old Value | old_val | STRING | X |  |  |  | Giá trị cũ trước thay đổi (null nếu là lần tạo mới). | QLRR | risk_indicator_value_history | old_value | Lưu dạng Text — giá trị số thập phân. |
| 7 | New Value | new_val | STRING | X |  |  |  | Giá trị mới sau thay đổi (null nếu là xóa). | QLRR | risk_indicator_value_history | new_value | Lưu dạng Text — giá trị số thập phân. |
...
| 12 | Change By Id | chg_by_id | STRING | X |  |  |  | User ID người thực hiện thay đổi (denormalized). | QLRR | risk_indicator_value_history | change_by_id | Denormalized — không có User entity trên Silver. |
| 13 | Change By Name | chg_by_nm | STRING | X |  |  |  | Tên người thực hiện thay đổi (denormalized). | QLRR | risk_indicator_value_history | change_by_name | Denormalized. Pair với Change By Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_alert |  |  |
| 4 | Risk Alert Config Id | rsk_alert_config_id | BIGINT |  |  | F |  | FK đến cấu hình ngưỡng cảnh báo. | QLRR | risk_alert | alert_config_id | FK target: Risk Alert Config.Risk Alert Config Id. |
| 5 | Risk Alert Config Code | rsk_alert_config_code | STRING |  |  |  |  | Mã cấu hình cảnh báo. | QLRR | risk_alert | alert_config_id | Lookup pair: Risk Alert Config.Risk Alert Config Code. Pair with Risk Alert Config Id. |
| 6 | Risk Indicator Id | rsk_ind_id | BIGINT |  |  | F |  | FK đến chỉ tiêu rủi ro (hệ thống lẫn tự tạo sau gộp). | QLRR | risk_alert | indicator_id | FK target: Risk Indicator.Risk Indicator Id. HLD T2-02: indicator_type=1 map indicator_id; indicator_type=2 map custom_indicator_id — cả 2 về ds_indicator_id. |
| 7 | Risk Indicator Code | rsk_ind_code | STRING |  |  |  |  | Mã chỉ tiêu rủi ro. | QLRR | risk_alert | indicator_id | Lookup pair: Risk Indicator.Risk Indicator Code. Pair with Risk Indicator Id. |
| 8 | Period Date | prd_dt | DATE |  |  |  |  | Kỳ dữ liệu bị cảnh báo. | QLRR | risk_alert | period_date |  |
| 9 | Current Value | crn_val | STRING |  |  |  |  | Giá trị chỉ tiêu tại kỳ bị cảnh báo. | QLRR | risk_alert | current_value | Lưu dạng Text — giá trị số thập phân. |
| 10 | Previous Value | prev_val | STRING | X |  |  |  | Giá trị kỳ trước (dùng để hiển thị, null nếu không xác định). | QLRR | risk_alert | previous_value | Lưu dạng Text — giá trị số thập phân. |
| 11 | Change Amount | chg_amt | STRING | X |  |  |  | Giá trị chênh lệch tuyệt đối. | QLRR | risk_alert | change_amount | Lưu dạng Text — giá trị số thập phân. |
| 12 | Change Percent | chg_pct | STRING | X |  |  |  | Chênh lệch phần trăm. | QLRR | risk_alert | change_percent | Lưu dạng Text — giá trị số thập phân. |
...
| 15 | Threshold Value | thrs_val | STRING |  |  |  |  | Giá trị ngưỡng tại thời điểm phát cảnh báo. | QLRR | risk_alert | threshold_value | Lưu dạng Text. Snapshot ngưỡng. |
| 16 | Compare Period Count | cmpr_prd_cnt | INT | X |  |  |  | Số kỳ so sánh tại thời điểm phát cảnh báo. | QLRR | risk_alert | compare_period_time | Snapshot. |
...
| 19 | Triggered By Schedule Id | triggered_by_shd_id | BIGINT | X |  | F |  | FK đến lịch đồng bộ đã kích hoạt cảnh báo. Nullable khi alert thủ công. | QLRR | risk_alert | triggered_by_job_id | FK target: Risk Indicator Schedule.Risk Indicator Schedule Id. Nullable — HLD T3-02: alert thủ công không có triggered_by_job_id. |
| 20 | Triggered By Schedule Code | triggered_by_shd_code | STRING | X |  |  |  | Mã lịch đồng bộ đã kích hoạt cảnh báo. | QLRR | risk_alert | triggered_by_job_id | Lookup pair: Risk Indicator Schedule.Risk Indicator Schedule Code. Pair with Triggered By Schedule Id. Nullable. |
| 21 | Handler User Id | handler_usr_id | STRING | X |  |  |  | User ID người được giao xử lý cảnh báo (denormalized). | QLRR | risk_alert | handler_user_id | Denormalized — không có User entity trên Silver. |
| 22 | Handler User Name | handler_usr_nm | STRING | X |  |  |  | Tên người được giao xử lý cảnh báo (denormalized). | QLRR | risk_alert | handler_user_name | Denormalized. Pair với Handler User Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_report_file |  |  |
| 4 | Risk Report Upload Batch Id | rsk_rpt_upload_btch_id | BIGINT |  |  | F |  | FK đến đợt upload báo cáo. | QLRR | risk_report_file | batch_id | FK target: Risk Report Upload Batch.Risk Report Upload Batch Id. |
| 5 | Risk Report Upload Batch Code | rsk_rpt_upload_btch_code | STRING |  |  |  |  | Mã đợt upload báo cáo. | QLRR | risk_report_file | batch_id | Lookup pair: Risk Report Upload Batch.Risk Report Upload Batch Code. Pair with Risk Report Upload Batch Id. |
...
| 11 | Uploaded By Id | uploaded_by_id | STRING | X |  |  |  | User ID người nộp file (denormalized). | QLRR | risk_report_file | uploaded_by_id | Denormalized — không có User entity trên Silver. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_alert_resolution |  |  |
| 4 | Risk Alert Id | rsk_alert_id | BIGINT |  |  | F |  | FK đến cảnh báo liên quan. | QLRR | risk_alert_resolution | alert_id | FK target: Risk Alert.Risk Alert Id. |
| 5 | Risk Alert Code | rsk_alert_code | STRING |  |  |  |  | Mã cảnh báo liên quan. | QLRR | risk_alert_resolution | alert_id | Lookup pair: Risk Alert.Risk Alert Code. Pair with Risk Alert Id. |
...
| 9 | Resolved By Id | rslv_by_id | STRING |  |  |  |  | User ID người xử lý cảnh báo (denormalized). | QLRR | risk_alert_resolution | resolved_by_id | Denormalized — không có User entity trên Silver. |
| 10 | Resolved By Name | rslv_by_nm | STRING |  |  |  |  | Tên người xử lý cảnh báo (denormalized). | QLRR | risk_alert_resolution | resolved_by_name | Denormalized. Pair với Resolved By Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_alert_resolution_file |  |  |
| 4 | Risk Alert Resolution Id | rsk_alert_rsl_id | BIGINT |  |  | F |  | FK đến bản ghi xử lý giải trình. | QLRR | risk_alert_resolution_file | resolution_id | FK target: Risk Alert Resolution.Risk Alert Resolution Id. |
| 5 | Risk Alert Resolution Code | rsk_alert_rsl_code | STRING |  |  |  |  | Mã bản ghi xử lý giải trình. | QLRR | risk_alert_resolution_file | resolution_id | Lookup pair: Risk Alert Resolution.Risk Alert Resolution Code. Pair with Risk Alert Resolution Id. |
...
| 11 | Uploaded By Id | uploaded_by_id | STRING | X |  |  |  | User ID người upload file giải trình (denormalized). | QLRR | risk_alert_resolution_file | uploaded_by_id | Denormalized — không có User entity trên Silver. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_alert_history |  |  |
| 4 | Risk Alert Id | rsk_alert_id | BIGINT |  |  | F |  | FK đến cảnh báo liên quan. | QLRR | risk_alert_history | alert_id | FK target: Risk Alert.Risk Alert Id. |
| 5 | Risk Alert Code | rsk_alert_code | STRING |  |  |  |  | Mã cảnh báo liên quan. | QLRR | risk_alert_history | alert_id | Lookup pair: Risk Alert.Risk Alert Code. Pair with Risk Alert Id. |
| 6 | Risk Alert Resolution Id | rsk_alert_rsl_id | BIGINT | X |  | F |  | FK đến bản ghi xử lý liên quan. Nullable — event_type=1 (phát sinh cảnh báo) chưa có resolution. | QLRR | risk_alert_history | resolution_id | FK target: Risk Alert Resolution.Risk Alert Resolution Id. Nullable — HLD T4-01: event_type=1 chưa có resolution_id. |
| 7 | Risk Alert Resolution Code | rsk_alert_rsl_code | STRING | X |  |  |  | Mã bản ghi xử lý liên quan. | QLRR | risk_alert_history | resolution_id | Lookup pair: Risk Alert Resolution.Risk Alert Resolution Code. Pair with Risk Alert Resolution Id. Nullable. |
...
| 12 | Event User Id | ev_usr_id | STRING | X |  |  |  | User ID người thực hiện sự kiện (denormalized). | QLRR | risk_alert_history | event_user_id | Denormalized — không có User entity trên Silver. |
| 13 | Event User Name | ev_usr_nm | STRING | X |  |  |  | Tên người thực hiện sự kiện (denormalized). | QLRR | risk_alert_history | event_user_name | Denormalized. Pair với Event User Id. |
...
| 3 | Source System Code | src_stm_code | STRING |  |  |  | 'QLRR' | Mã hệ thống nguồn. | QLRR | risk_notification |  |  |
| 4 | Risk Alert Id | rsk_alert_id | BIGINT |  |  | F |  | FK đến cảnh báo liên quan. | QLRR | risk_notification | alert_id | FK target: Risk Alert.Risk Alert Id. |
| 5 | Risk Alert Code | rsk_alert_code | STRING |  |  |  |  | Mã cảnh báo liên quan. | QLRR | risk_notification | alert_id | Lookup pair: Risk Alert.Risk Alert Code. Pair with Risk Alert Id. |
...
| 7 | Recipient User Id | rcpnt_usr_id | STRING | X |  |  |  | User ID người nhận thông báo (cho type=Toast/Bell, denormalized). | QLRR | risk_notification | recipient_user_id | Denormalized — không có User entity trên Silver. Nullable khi type=Email. |
| 8 | Recipient Email | rcpnt_email | STRING | X |  |  |  | Địa chỉ email người nhận (cho type=Email). | QLRR | risk_notification | recipient_email | Nullable khi type=Toast/Bell. |
