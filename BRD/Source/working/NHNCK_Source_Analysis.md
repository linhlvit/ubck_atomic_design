# NHNCK — Tài liệu khảo sát nguồn và ánh xạ Atomic

> **Phân hệ:** Quản lý giám sát người hành nghề chứng khoán (CSDL: `qlnhn`, MySQL Server)
>
> **Mục đích:** Tài liệu tham chiếu tổng hợp nghiệp vụ nguồn, quan hệ bảng, và ánh xạ Atomic entity theo từng nhóm chức năng (UID).
>
> **Nguồn tài liệu:**
...
**Nghiệp vụ:** Đọc dữ liệu từ các bảng nghiệp vụ đã lên Atomic. Không tạo dữ liệu mới.

| Bảng đọc dữ liệu | Ánh xạ Atomic |
|---|---|
