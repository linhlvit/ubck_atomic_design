# MRMS — Tài liệu khảo sát nguồn & ánh xạ Atomic

**Phân hệ:** MRMS — Quản lý rủi ro về thị trường chứng khoán
...
**Nguồn tài liệu:**
- Đặc tả yêu cầu: `New_UBCKNN_Dac_ta_yeu_cau_MRMS_09_03_2026.docx`
- Thiết kế CSDL: `New_UBCKNN_Thiet_ke_co_so_du_lieu_MRMS_02_04_2026.docx`
...
| 🟢 ↳ denormalize vào *Entity* | Junction table flatten vào entity chính (MRMS không có — xem HLD 7d) |
...
**Lưu ý riêng cho MRMS:** Phân hệ không có bảng `DM_*` dictionary riêng — các giá trị danh mục (bộ chỉ tiêu, tần suất, đơn vị, trạng thái, loại sự kiện, kênh thông báo…) lưu dưới dạng enum/code inline trong bảng nghiệp vụ. Các enum này được chuẩn hóa thành **17 Classification Value schemes** trong Atomic (xem Phụ lục).

---

## Mục lục

- [MRMS001 — Khai thác Dashboard](#mrms001--khai-thác-dashboard)
- [MRMS002 — Khai thác Báo cáo](#mrms002--khai-thác-báo-cáo)
- [MRMS003 — Khai thác Chỉ tiêu tài chính trong nước](#mrms003--khai-thác-chỉ-tiêu-tài-chính-trong-nước)
- [MRMS004 — Khai thác Chỉ tiêu tài chính quốc tế](#mrms004--khai-thác-chỉ-tiêu-tài-chính-quốc-tế)
- [MRMS005 — Quản lý Cảnh báo](#mrms005--quản-lý-cảnh-báo)
- [MRMS006 — Khai thác Phân quyền dữ liệu](#mrms006--khai-thác-phân-quyền-dữ-liệu)
- [MRMS007 — Quản lý tích hợp](#mrms007--quản-lý-tích-hợp)
- [Phụ lục — Danh mục dùng chung & Classification Values](#phụ-lục--danh-mục-dùng-chung--classification-values)

---

## MRMS001 — Khai thác Dashboard
...
## MRMS003 — Khai thác Chỉ tiêu tài chính trong nước
...
## MRMS004 — Khai thác Chỉ tiêu tài chính quốc tế
...
## MRMS006 — Khai thác Phân quyền dữ liệu
...
MRMS **không có bảng `DM_*` dictionary riêng**. Các bảng sau đóng vai trò master được tham chiếu xuyên UID:

| Bảng | Ý nghĩa | Sử dụng bởi | Ánh xạ Atomic |
|---|---|---|---|
| `risk_indicator_category` | Nhóm chỉ tiêu (vĩ mô, tiền tệ, cổ phiếu…) | MRMS001, MRMS003, MRMS004, MRMS007 | 🟢 **Risk Indicator Category** |
| `risk_indicator` | Master chỉ tiêu hệ thống | MRMS001, MRMS002, MRMS003, MRMS004, MRMS005, MRMS006, MRMS007 | 🟢 **Risk Indicator** |
| `risk_indicator_custom` | Chỉ tiêu tự tạo | MRMS003, MRMS004, MRMS005 | 🟢 **Risk Indicator** *(gộp)* |
| `risk_indicator_value` | Số liệu theo kỳ | MRMS001, MRMS002, MRMS003, MRMS004, MRMS005, MRMS007 | 🟢 **Risk Indicator Value** |
| `risk_indicator_value_history` | Lịch sử thay đổi số liệu | MRMS001, MRMS003, MRMS004, MRMS007 | 🟢 **Risk Indicator Value Change** |

### B. Classification Values (17 schemes — tra từ `ref_shared_entity_classifications.csv`)

Các giá trị danh mục trong MRMS được chuẩn hóa thành Classification Value thay vì bảng dictionary riêng.
...
- **Số junction table:** 0 *(MRMS không có pure junction)*
