...
> - HLD Overview: `FIMS_HLD_Overview.md` (7a Silver Entities, 7c CV, 7d Junction, 7f Out of scope)
> - Classification Value registry: `ref_shared_entity_classifications.csv` (ưu tiên hơn HLD 7c)
> - Silver mapping: `manifest.csv`
>
> **Tổng quan:** 10 nhóm chức năng (UID) · 85 bảng CSDL · 19 Silver entities · 14 Classification Values · 9 Junction tables
