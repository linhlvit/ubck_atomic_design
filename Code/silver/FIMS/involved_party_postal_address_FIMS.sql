/*
*--------------------------------------------------------------------*
* Program code: involved_party_postal_address_FIMS
* Program name: Involved Party Postal Address FIMS
* Created by: 
* Created date: 
*--------------------------------------------------------------------*
* Modified management
...
SELECT
    ...
    leg_de_ce.type_code :: string                       AS address_type_code,
    leg_de_ce.address_value :: string                   AS address_value
FROM leg_de_ce
UNION ALL
SELECT
    ...
    leg_fu_co.type_code :: string                  AS address_type_code,
    leg_fu_co.address_value :: string              AS address_value
FROM leg_fu_co
UNION ALL
SELECT
    ...
    leg_in_di_re.type_code :: string                     AS address_type_code,
    leg_in_di_re.address_value :: string                 AS address_value
FROM leg_in_di_re
UNION ALL
SELECT
    ...
    leg_in.type_code :: string               AS address_type_code,
    leg_in.address_value :: string           AS address_value
FROM leg_in
UNION ALL
SELECT
    ...
    leg_se_co.type_code :: string                        AS address_type_code,
    leg_se_co.address_value :: string                    AS address_value
FROM leg_se_co
UNION ALL
SELECT
    ...
    leg_st_ex.type_code :: string                    AS address_type_code,
    leg_st_ex.address_value :: string                AS address_value
FROM leg_st_ex
UNION ALL
SELECT
    ...
    leg_tl.type_code :: string                 AS address_type_code,
    leg_tl.address_value :: string             AS address_value
FROM leg_tl
;
