...
|---|---|---|---|---|---|---|---|
| {Core Object} | {[Concept] Term} | {Category} | {table_name} | {mô tả gốc từ CSDL nguồn} | {Atomic Entity Name} | {Fundamental/Relative/Fact Append/Snapshot} | {(1) term candidate + BCV mô tả gì; (2) đánh giá cấu trúc trường nguồn nói gì; (3) lý do chọn term cuối} |
...
erDiagram
    ...
    Tier_Truoc_Entity ||--o{ Atomic_Entity_A : "fk_col"
```

> Replace `Atomic_Entity_A`, `Tier_Truoc_Entity`, `attr_name` bằng tên thực tế. Entity từ Tier trước hiện dạng node tham chiếu (chỉ tên + PK).
