...
## post_check_silver.py — C1 đến C5
...
Script đọc `Source/{SOURCE}_Columns.csv`, so sánh với `silver_attributes.csv`, báo cáo cột chưa map. Bỏ qua group=pending trong manifest và bỏ qua cột kỹ thuật/audit tự động.
