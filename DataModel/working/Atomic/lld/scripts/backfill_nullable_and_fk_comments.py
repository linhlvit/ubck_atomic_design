"""Back-fill nullable + FK Code comment cho toàn bộ attr_*.csv trong Atomic/lld/.

Theo quy tắc mới (atomic-lld-design SKILL.md Bước 3.5 và Bước 5):
...
def main() -> None:
    ...
    if args.apply:
        ...
        print("Nhớ chạy aggregate_atomic.py + post_check_atomic.py sau khi back-fill.")
    else:
