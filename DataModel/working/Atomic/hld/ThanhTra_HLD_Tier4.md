...
| Tier | BCV Core Object | BCV Concept | Source Table | Mô tả bảng nguồn | Atomic Entity | table_type | Ghi chú |
|---|---|---|---|---|---|---|---|
...
| # | Câu hỏi | Ảnh hưởng |
|---|---|---|
| 1 | **PCRT_BAO_CAO** (báo cáo PCRT định kỳ) — có FK đến PCRT_HO_SO hay độc lập? | Nếu độc lập → Tier 1 Fact Append (thêm vào atomic_entities.csv cùng với `Anti-Corruption Report`). Nếu có FK → Tier 2. |
