...
**Source system:** ECAT
**Scope Tier 2:** 1 Atomic entity shared — `[Product] Security`. ECAT là source chuẩn cho danh mục chứng khoán (Code + Name). Các attribute khác (ISIN, issuer, listing date...) sẽ được bổ sung từ source khác trong các Tier HLD của source tương ứng.
...
graph TD
    ...
    SEC["**Security**\n[Product] Security Instrument\nECAT_14_Security (source chuẩn)"]:::atomic
...
> Security ở Tier 2 vì phụ thuộc 2 Classification Value scheme (SECURITY_TYPE, MARKET) được load từ Tier 1 của ECAT. Không FK đến Atomic entity nghiệp vụ khác trong scope ECAT.
