...
| T2 | Documentation | [Documentation] Form Document | Documentation | `REP_ROW` | Update | Định nghĩa hàng của template báo cáo định kỳ. | Financial Report Sub Row Template | Fundamental | (1) [Documentation] Form Document (BCV id 9348) — thành phần cấu trúc (detail) của bản mẫu Financial Report Sub Template. (2) FK → REP_FORMS (nay cũng Documentation — không lệch BCO cha/con). (3) Chọn [Documentation] Form Document, thay `[Condition] Form Definition` (term không tồn tại trong knowledge/terms.csv). Đổi theo yêu cầu tường minh Data Modeler (2026-08-13) — xem 7e #21. Đổi tên từ `Periodic Report Form Row Template` (2026-08-05) — xem 7e. |
| T2 | Documentation | [Documentation] Form Document | Documentation | `REP_COLUMN` | Update | Định nghĩa cột của template báo cáo định kỳ. | Financial Report Sub Column Template | Fundamental | (1) [Documentation] Form Document (BCV id 9348) — thành phần cấu trúc (detail) của bản mẫu Financial Report Sub Template. (2) FK → REP_FORMS (nay cũng Documentation — không lệch BCO cha/con). (3) Chọn [Documentation] Form Document, thay `[Condition] Form Definition` (term không tồn tại trong knowledge/terms.csv). Đổi theo yêu cầu tường minh Data Modeler (2026-08-13) — xem 7e #21. Đổi tên từ `Periodic Report Form Column Template` (2026-08-05) — xem 7e. |
