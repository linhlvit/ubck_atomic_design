...
- [IDS_HLD_Tier2.md](IDS_HLD_Tier2.md) — Con của Public Company (Legal Representative, State Capital, FOL, Inspection, Penalty, Capital actions, Share Statistics, Listing History, Registration, Report Extension), con của Audit Firm (Approval, Legal Rep, Auditor Profile, Status History, Inspection), con của Form templates (RROW/RCOL/REP_ROW/REP_COLUMN), Violation Template, Evaluation Criterion, Disclosure Notification, Financial Report Data; Shared Entities (IP Postal/Electronic Address, IP Alt Identification)
- [IDS_HLD_Tier3.md](IDS_HLD_Tier3.md) — Legal Entity sub-entities (Alt ID, Position, Trading Account, Relationship, Stock Control), Company Shareholding, Company Entity Role, Audit Firm enforcement (Warning, Sanction, Suspension, Technical Audit, Auditor Status History), Public Company Report Submission, Securities Offering, Public Company Evaluation, Violation Reports, Disclosure Notification Recipient
