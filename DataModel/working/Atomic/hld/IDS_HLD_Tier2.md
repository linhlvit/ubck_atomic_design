...
- Con của **Public Company**: Legal Representative, State Capital, Foreign Ownership Limit, Company Relationship, Company Inspection, Company Penalties, Capital Mobilization, Company Add Capital, Company Tender Offer, Company Treasury Stocks, Company Share Statistics, Stock Listing History, Bond Listing History, Pub Company Registration/Cancellation, Report Extensions
- Con của **Audit Firm**: AF Approval (gộp target_type — cho cả công ty KT và KTV), AF Legal Representative, Auditor Profile, AF Status History
- Con của **Disclosure Form Definition**: Violation Template
- Con của **Financial Report Catalog**: Financial Report Row/Column Template
- Con của **Periodic Report Form**: Periodic Report Form Row/Column Template
- Con của **Evaluation Group**: Evaluation Criteria
