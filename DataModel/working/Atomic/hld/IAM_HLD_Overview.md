...
|---|---|---|---|---|---|---|
| T1 | IAM System User | Involved Party | [Involved Party] Individual | Fundamental | IAM.USERS | Entity chính — người dùng hệ thống |
...
| D-03 | `REPRESENTATIVE_*` giữ denormalized trên IAM System User | Chưa xác nhận được người đại diện có phải Involved Party độc lập trong hệ thống không — xem T1-03 |
...
| 3 | T1 | `REPRESENTATIVE_*` — người đại diện pháp lý khi USER_TYPE là tổ chức, hay là người giám sát nội bộ? Nếu là Involved Party thực sự → cần tách entity Tier 2 `IAM System User Representative`. | Phát sinh entity Tier 2 mới |
