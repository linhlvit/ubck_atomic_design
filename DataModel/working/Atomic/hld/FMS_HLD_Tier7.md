...
| Involved Party | [Involved Party] Individual Employment Status | Employment Status | DISTRIBUTOR_PERSONNEL | Update | Nhân sự tại địa điểm giao dịch của Securities Distribution Agent | Securities Distribution Agent Personnel | Fundamental | (1) Term candidate: `Individual Employment Status` — giống pattern Fund Management Company Employee / Foreign FM Org Unit Staff. (2) Cấu trúc trường: FK DISTRIBUTOR_LOCATION_ID, FULL_NAME, CERT_NO (CCHN), POSITION, PHONE → nhân sự giữ vị trí tại địa điểm giao dịch. Tách IP Electronic Address. (3) Chọn `Individual Employment Status`. **[CẬP NHẬT REVIEW 2026-07-03]** DISTRIBUTOR_LOCATION không còn là Atomic entity riêng (xem Tier 6) — FK của Securities Distribution Agent Personnel trỏ trực tiếp đến **Securities Distribution Agent** (Tier 5); DISTRIBUTOR_LOCATION_ID resolve qua bảng nguồn ở LLD. |
