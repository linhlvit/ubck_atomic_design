...
| 4 | **PCRT_BAO_CAO** (báo cáo PCRT định kỳ) — bảng này có FK đến PCRT_HO_SO không, hay là báo cáo độc lập? | Nếu có FK → Tier 2. Nếu không → Tier 1, thêm vào atomic_entities.csv. |
